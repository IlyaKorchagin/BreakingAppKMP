...
data class UserEntry(
    ...
    */
    ...
    var superman: Int,
    var superman_record: Int,
    var swipes: Int,
    var tombstone: Int,
    var tombstone_record: Int,
    var turtle: Int,
    var ufo: Int,
    var ufo_record: Int,
    var web: Int,
    ...
    var windmillToHandstand_record: Int,
    var wolf: Int,
    var wolf_record: Int,
