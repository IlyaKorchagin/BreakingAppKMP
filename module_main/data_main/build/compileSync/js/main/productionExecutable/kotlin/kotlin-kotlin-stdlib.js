...
(function (factory) {
  ...
  initMetadataForInterface(KtList, 'List');
  initMetadataForCompanion(Companion);
  initMetadataForClass(Long, 'Long', VOID, Number_0);
  initMetadataForClass(AbstractCollection, 'AbstractCollection');
  initMetadataForClass(AbstractMutableCollection, 'AbstractMutableCollection', VOID, AbstractCollection);
  initMetadataForClass(IteratorImpl, 'IteratorImpl');
  initMetadataForClass(AbstractMutableList, 'AbstractMutableList', VOID, AbstractMutableCollection, [AbstractMutableCollection, KtList]);
  initMetadataForCompanion(Companion_0);
  initMetadataForClass(ArrayList, 'ArrayList', ArrayList_init_$Create$, AbstractMutableList, [AbstractMutableList, KtList]);
  ...
  function Companion() {
    ...
    this.h_1 = new Long(0, -2147483648);
    this.i_1 = new Long(-1, 2147483647);
    this.j_1 = 8;
    this.k_1 = 64;
  }
  ...
  protoOf(Long).p = function () {
    return this.q().n(new Long(1, 0));
  };
  protoOf(Long).q = function () {
  ...
  function divide(_this__u8e3s4, other) {
    ...
    if (equalsLong(_this__u8e3s4, get_MIN_VALUE())) {
      if (equalsLong(other, get_ONE()) || equalsLong(other, get_NEG_ONE())) {
        ...
        var approx = shiftLeft(halfThis.o(other), 1);
        if (equalsLong(approx, get_ZERO())) {
          return isNegative(other) ? get_ONE() : get_NEG_ONE();
        } else {
          var rem = subtract(_this__u8e3s4, multiply(other, approx));
          return add(approx, rem.o(other));
        }
      }
    } else if (equalsLong(other, get_MIN_VALUE())) {
      return get_ZERO();
    ...
    if (isNegative(_this__u8e3s4)) {
      var tmp;
      if (isNegative(other)) {
        tmp = negate(_this__u8e3s4).o(negate(other));
      } else {
        tmp = negate(negate(_this__u8e3s4).o(other));
      }
      return tmp;
    } else if (isNegative(other)) {
      return negate(_this__u8e3s4.o(negate(other)));
    }
    var res = get_ZERO();
  ...
  function toStringImpl(_this__u8e3s4, radix) {
    ...
    if (isNegative(_this__u8e3s4)) {
      if (equalsLong(_this__u8e3s4, get_MIN_VALUE())) {
        ...
        var div = _this__u8e3s4.o(radixLong);
        var rem = subtract(multiply(div, radixLong), _this__u8e3s4).r();
    ...
    var result = '';
    while (true) {
      var remDiv = rem_0.o(radixToPower);
      var intval = subtract(rem_0, multiply(remDiv, radixToPower)).r();
      // Inline function 'kotlin.js.unsafeCast' call
      // Inline function 'kotlin.js.asDynamic' call
  ...
  protoOf(AbstractMutableList).equals = function (other) {
    ...
    if (!(!(other == null) ? isInterface(other, KtList) : false))
      return false;
    return Companion_instance_1.b1(this, other);
  };
  ...
  function rangeCheck($this, index) {
    ...
    Companion_instance_1.g1(index, $this.e());
    return index;
  }
  function insertionRangeCheck($this, index) {
    ...
    Companion_instance_1.h1(index, $this.e());
    return index;
  }
  ...
  function StringBuilder(content) {
    this.l1_1 = !(content === undefined) ? content : '';
  }
  protoOf(StringBuilder).m1 = function (value) {
  ...
  protoOf(Companion_1).g1 = function (index, size) {
    if (index < 0 || index >= size) {
      throw IndexOutOfBoundsException_init_$Create$_0('index: ' + index + ', size: ' + size);
    }
  };
  protoOf(Companion_1).h1 = function (index, size) {
    if (index < 0 || index > size) {
      throw IndexOutOfBoundsException_init_$Create$_0('index: ' + index + ', size: ' + size);
    }
  };
  protoOf(Companion_1).b1 = function (c, other) {
    if (!(c.e() === other.e()))
      return false;
