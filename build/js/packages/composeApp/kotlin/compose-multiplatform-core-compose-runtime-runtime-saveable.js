(function (factory) {
  ...
  var toString_0 = kotlin_kotlin.$_$.ij;
  ...
  var neverEqualPolicy = kotlin_org_jetbrains_compose_runtime_runtime.$_$.s1;
  ...
  function rememberSaveable(inputs, saver, key, init, $composer, $changed, $default) {
    ...
    var tmp0 = $composer_1.n33(this_1);
    ...
    if (false || it === Companion_getInstance().l2u_1) {
      ...
      var tmp1_safe_receiver = registry == null ? null : registry.u5e(finalKey);
      var tmp_2;
      if (tmp1_safe_receiver == null) {
        ...
        tmp_2 = saver_0._v.v5e(tmp1_safe_receiver);
      }
      var restored = tmp_2;
    ...
    var tmp0_elvis_lhs = holder.d5f(inputs);
    ...
    // Inline function 'androidx.compose.runtime.cache' call
    var invalid = !!(!!(!!(!!(!!($composer_0.f32(holder) | (($changed & 112 ^ 48) > 32 && $composer_0.f32(saver_0._v) || ($changed & 48) === 32)) | $composer_0.f32(registry)) | $composer_0.f2r(finalKey)) | $composer_0.f32(value_0)) | $composer_0.f32(inputs));
    // Inline function 'kotlin.let' call
    // Inline function 'kotlin.contracts.contract' call
    // Inline function 'androidx.compose.runtime.cache.<anonymous>' call
  ...
  function register($this) {
    var registry = $this.x5e_1;
    // Inline function 'kotlin.require' call
    // Inline function 'kotlin.contracts.contract' call
    if (!($this.b5f_1 == null)) {
      // Inline function 'androidx.compose.runtime.saveable.SaveableHolder.register.<anonymous>' call
      var message = 'entry(' + toString_1($this.b5f_1) + ') is not null';
      throw IllegalArgumentException_init_$Create$(toString(message));
    }
    if (!(registry == null)) {
      requireCanBeSaved(registry, $this.c5f_1());
      $this.b5f_1 = registry.e5f($this.y5e_1, $this.c5f_1);
    }
  }
  function SaveableHolder$valueProvider$lambda(this$0) {
    return function () {
      ...
      var $this$with = this$0.w5e_1;
      var tmp$ret$1;
      $l$block: {
        // Inline function 'kotlin.requireNotNull' call
        var value = this$0.z5e_1;
        // Inline function 'kotlin.contracts.contract' call
        if (value == null) {
      ...
      return $this$with.f5f(this$0, tmp$ret$1);
    };
  }
  function SaveableHolder(saver, registry, key, value, inputs) {
    ...
    this.b5f_1 = null;
    var tmp = this;
    tmp.c5f_1 = SaveableHolder$valueProvider$lambda(this);
  }
  protoOf(SaveableHolder).g5f = function (saver, registry, key, value, inputs) {
    var entryIsOutdated = false;
    if (!(this.x5e_1 === registry)) {
      this.x5e_1 = registry;
    ...
    this.z5e_1 = value;
    this.a5f_1 = inputs;
    if (!(this.b5f_1 == null) && entryIsOutdated) {
      var tmp0_safe_receiver = this.b5f_1;
      if (tmp0_safe_receiver == null)
        null;
      else {
        tmp0_safe_receiver.h5f();
      }
      this.b5f_1 = null;
      register(this);
    }
  };
  protoOf(SaveableHolder).t5e = function (value) {
    var registry = this.x5e_1;
    return registry == null || registry.t5e(value);
  };
  protoOf(SaveableHolder).v2z = function () {
    register(this);
  };
  protoOf(SaveableHolder).x2z = function () {
    var tmp0_safe_receiver = this.b5f_1;
    if (tmp0_safe_receiver == null)
      null;
    else {
  ...
  protoOf(SaveableHolder).w2z = function () {
    var tmp0_safe_receiver = this.b5f_1;
    if (tmp0_safe_receiver == null)
      null;
    else {
  ...
  protoOf(SaveableHolder).d5f = function (inputs) {
    var tmp;
    if (contentEquals(inputs, this.a5f_1)) {
      tmp = this.z5e_1;
    } else {
      tmp = null;
    }
  ...
  function requireCanBeSaved(_this__u8e3s4, value) {
    if (!(value == null) && !_this__u8e3s4.t5e(value)) {
      var tmp;
      if (!(value == null) ? isInterface(value, SnapshotMutableState) : false) {
        var tmp_0;
        if (!(value.x38() === neverEqualPolicy()) && !(value.x38() === structuralEqualityPolicy()) && !(value.x38() === referentialEqualityPolicy())) {
          tmp_0 = 'If you use a custom SnapshotMutationPolicy for your MutableState you have to write a custom Saver';
        } else {
          tmp_0 = 'MutableState containing ' + toString_1(value.c1()) + ' cannot be saved using the current ' + 'SaveableStateRegistry. The default implementation only supports types ' + 'which can be stored inside the Bundle. Please consider implementing a ' + 'custom Saver for this class and pass it as a stateSaver parameter to ' + 'rememberSaveable().';
        }
        tmp = tmp_0;
      } else {
  ...
  function rememberSaveable$lambda($holder, $saver, $registry, $finalKey, $value, $inputs) {
    return function () {
      $holder.g5f($saver._v, $registry, $finalKey, $value, $inputs);
  ...
  function SaveableStateHolderImpl$RegistryHolder$registry$lambda(this$0) {
    return function (it) {
      var tmp0_safe_receiver = this$0.l5f_1;
      var tmp1_elvis_lhs = tmp0_safe_receiver == null ? null : tmp0_safe_receiver.t5e(it);
  ...
  function saveAll($this) {
    var map = toMutableMap($this.j5f_1);
    // Inline function 'kotlin.collections.forEach' call
    var tmp0_iterator = $this.k5f_1.p2().m();
  ...
  function RegistryHolder($outer, key) {
    ...
    this.n5f_1 = true;
    var tmp = this;
    var tmp_0 = this.p5f_1.j5f_1.s2(this.m5f_1);
    tmp.o5f_1 = SaveableStateRegistry(tmp_0, SaveableStateHolderImpl$RegistryHolder$registry$lambda(this.p5f_1));
  }
  protoOf(RegistryHolder).q5f = function (map) {
    if (this.n5f_1) {
      var savedData = this.o5f_1.r5f();
      if (savedData.j()) {
        ...
        var key_0 = this.m5f_1;
        map.k2(key_0, savedData);
      }
    }
  };
  function Companion() {
    ...
    tmp.i5f_1 = Saver_0(tmp_0, SaveableStateHolderImpl$Companion$Saver$lambda_0);
  }
  ...
  protoOf(_no_name_provided__qut3iv).v18 = function () {
    ...
    this.s5f_1.q5f(this.t5f_1.j5f_1);
    // Inline function 'kotlin.collections.minusAssign' call
    var this_0 = this.t5f_1.k5f_1;
    var key = this.u5f_1;
    this_0.l2(key);
  };
  function SaveableStateHolderImpl$SaveableStateProvider$lambda(this$0, $key, $registryHolder) {
    return function ($this$DisposableEffect) {
      ...
      var this_0 = this$0.k5f_1;
      // Inline function 'kotlin.collections.containsKey' call
      var key = $key;
      // Inline function 'kotlin.contracts.contract' call
      var tmp;
      if (!!(isInterface(this_0, KtMap) ? this_0 : THROW_CCE()).q2(key)) {
        // Inline function 'androidx.compose.runtime.saveable.SaveableStateHolderImpl.SaveableStateProvider.<anonymous>.<anonymous>.<anonymous>.<anonymous>' call
        var message = 'Key ' + toString($key) + ' was used multiple times ';
        throw IllegalArgumentException_init_$Create$(toString(message));
      }
      var this_1 = this$0.j5f_1;
      var key_0 = $key;
      this_1.l2(key_0);
      var this_2 = this$0.k5f_1;
      var key_1 = $key;
      var value = $registryHolder;
      this_2.k2(key_1, value);
  ...
  function SaveableStateHolderImpl$SaveableStateProvider$lambda_0($tmp0_rcvr, $key, $content, $$changed) {
    return function ($composer, $force) {
      $tmp0_rcvr.v5f($key, $content, $composer, updateChangedFlags($$changed | 1));
      return Unit_instance;
    };
  }
  function SaveableStateHolderImpl(savedStates) {
    ...
    savedStates = tmp;
    this.j5f_1 = savedStates;
    var tmp_0 = this;
    // Inline function 'kotlin.collections.mutableMapOf' call
    tmp_0.k5f_1 = LinkedHashMap_init_$Create$();
    this.l5f_1 = null;
  }
  protoOf(SaveableStateHolderImpl).v5f = function (key, content, $composer, $changed) {
    var $composer_0 = $composer;
    $composer_0 = $composer_0.v33(-1198538093);
    sourceInformation($composer_0, 'C(SaveableStateProvider)P(1)76@3032L923:SaveableStateHolder.kt#r2ddri');
    var $dirty = $changed;
    if (($changed & 6) === 0)
      $dirty = $dirty | ($composer_0.f32(key) ? 4 : 2);
    if (($changed & 48) === 0)
    ...
    if (!(($dirty & 147) === 146) || !$composer_0.u30()) {
      ...
      if (false || it === Companion_getInstance().l2u_1) {
        ...
        // Inline function 'kotlin.require' call
        var tmp0_safe_receiver = this.l5f_1;
        var tmp1_elvis_lhs = tmp0_safe_receiver == null ? null : tmp0_safe_receiver.t5e(key);
        // Inline function 'kotlin.contracts.contract' call
      ...
      CompositionLocalProvider(get_LocalSaveableStateRegistry().g38(registryHolder.o5f_1), content, $composer_2, 8 | 112 & $dirty);
      sourceInformationMarkerStart($composer_2, -233266573, 'CC(remember):SaveableStateHolder.kt#9igjgp');
      // Inline function 'androidx.compose.runtime.cache' call
      var invalid = !!(!!($composer_0.f32(this) | $composer_0.f32(key)) | $composer_0.f32(registryHolder));
      // Inline function 'kotlin.let' call
      // Inline function 'kotlin.contracts.contract' call
      // Inline function 'androidx.compose.runtime.cache.<anonymous>' call
    ...
    if (tmp1_safe_receiver == null)
      ...
      tmp1_safe_receiver.n38(SaveableStateHolderImpl$SaveableStateProvider$lambda_0(this, key, content, $changed));
    }
  };
  protoOf(SaveableStateHolderImpl).w5f = function (key) {
    var registryHolder = this.k5f_1.s2(key);
    if (!(registryHolder == null)) {
      registryHolder.n5f_1 = false;
    } else {
      // Inline function 'kotlin.collections.minusAssign' call
      this.j5f_1.l2(key);
    }
  ...
  function SaveableStateRegistryImpl$registerProvider$1(this$0, $key, $valueProvider) {
    this.x5f_1 = this$0;
    this.y5f_1 = $key;
    this.z5f_1 = $valueProvider;
  }
  protoOf(SaveableStateRegistryImpl$registerProvider$1).h5f = function () {
    var list = this.x5f_1.c5g_1.l2(this.y5f_1);
    if (list == null)
      null;
    else
      list.t2(this.z5f_1);
  ...
  function SaveableStateRegistryImpl(restored, canBeSaved) {
    ...
    var tmp_1 = this;
    // Inline function 'kotlin.collections.mutableMapOf' call
    tmp_1.c5g_1 = LinkedHashMap_init_$Create$();
  }
  protoOf(SaveableStateRegistryImpl).t5e = function (value) {
    return this.a5g_1(value);
  };
  protoOf(SaveableStateRegistryImpl).u5e = function (key) {
    var list = this.b5g_1.l2(key);
    var tmp;
    var tmp_0;
    if (!(list == null)) {
      // Inline function 'kotlin.collections.isNotEmpty' call
  ...
  protoOf(SaveableStateRegistryImpl).e5f = function (key, valueProvider) {
    // Inline function 'kotlin.require' call
    // Inline function 'kotlin.contracts.contract' call
    if (!!fastIsBlank(key)) {
  ...
  protoOf(SaveableStateRegistryImpl).r5f = function () {
    var map = toMutableMap(this.b5g_1);
    // Inline function 'kotlin.collections.forEach' call
    // Inline function 'kotlin.collections.iterator' call
    var tmp0_iterator = this.c5g_1.a1().m();
    while (tmp0_iterator.n()) {
      var element = tmp0_iterator.o();
  ...
  protoOf(Saver$1).f5f = function (_this__u8e3s4, value) {
    return this.d5g_1(_this__u8e3s4, value);
  };
  protoOf(Saver$1).v5e = function (value) {
    return this.e5g_1(value);
  };
