(function (factory) {
  ...
  function warnNoContext(_this__u8e3s4) {
    _init_properties_KoinApplication_kt__lzwtrf();
    _this__u8e3s4.rq_1.us('[Warning] - No Koin context defined in Compose, fallback to default Koin context.Use KoinContext(), KoinAndroidContext() or KoinApplication() to setup or create Koin context with Compose and avoid such message.');
  }
  function getDefaultKoinContext() {
    _init_properties_KoinApplication_kt__lzwtrf();
    return KoinPlatformTools_instance.or().dq();
  }
