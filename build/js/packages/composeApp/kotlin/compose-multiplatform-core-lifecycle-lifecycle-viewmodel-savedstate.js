(function (factory) {
  ...
  var Companion_instance = kotlin_org_jetbrains_androidx_lifecycle_lifecycle_viewmodel.$_$.j;
  ...
  function createSavedStateHandle(_this__u8e3s4) {
    _init_properties_SavedStateHandleSupport_kt__nxqisr();
    var tmp0_elvis_lhs = _this__u8e3s4.k4f(get_SAVED_STATE_REGISTRY_OWNER_KEY());
    var tmp;
    ...
    var tmp1_elvis_lhs = _this__u8e3s4.k4f(get_VIEW_MODEL_STORE_OWNER_KEY());
    var tmp_0;
    ...
    var defaultArgs = _this__u8e3s4.k4f(get_DEFAULT_ARGS_KEY());
    var tmp2_elvis_lhs = _this__u8e3s4.k4f(Companion_getInstance().d4g_1);
    var tmp_1;
  ...
  function enableSavedStateHandles(_this__u8e3s4) {
    _init_properties_SavedStateHandleSupport_kt__nxqisr();
    var currentState = _this__u8e3s4.j4e().w4b();
    ...
    if (_this__u8e3s4.x4g().z4e('androidx.lifecycle.internal.SavedStateHandlesProvider') == null) {
      var provider = new SavedStateHandlesProvider(_this__u8e3s4.x4g(), _this__u8e3s4);
      _this__u8e3s4.x4g().y4e('androidx.lifecycle.internal.SavedStateHandlesProvider', provider);
      _this__u8e3s4.j4e().u4b(new SavedStateHandleAttacher(provider));
    }
  }
  function createSavedStateHandle_0(savedStateRegistryOwner, viewModelStoreOwner, key, defaultArgs) {
    ...
    var tmp0_elvis_lhs = viewModel.z4g_1.s2(key);
    var tmp;
    if (tmp0_elvis_lhs == null) {
      // Inline function 'kotlin.also' call
      var this_0 = Companion_instance_0.e4h(provider.x4e(key), defaultArgs);
      // Inline function 'kotlin.contracts.contract' call
      // Inline function 'androidx.lifecycle.createSavedStateHandle.<anonymous>' call
      // Inline function 'kotlin.collections.set' call
      viewModel.z4g_1.k2(key, this_0);
      tmp = this_0;
    } else {
      tmp = tmp0_elvis_lhs;
    }
  ...
  function SavedStateHandlesProvider(savedStateRegistry, viewModelStoreOwner) {
    this.a4h_1 = savedStateRegistry;
    this.b4h_1 = false;
    this.c4h_1 = null;
    var tmp = this;
    tmp.d4h_1 = lazy(SavedStateHandlesProvider$viewModel$delegate$lambda(viewModelStoreOwner));
  }
  protoOf(SavedStateHandlesProvider).u4e = function () {
    // Inline function 'kotlin.also' call
    ...
    var tmp0_safe_receiver = this.c4h_1;
    if (tmp0_safe_receiver == null)
      null;
    else {
      // Inline function 'kotlin.let' call
      // Inline function 'kotlin.contracts.contract' call
      this_0.u4c(tmp0_safe_receiver);
    }
    // Inline function 'kotlin.collections.forEach' call
    // Inline function 'kotlin.collections.iterator' call
    var tmp0_iterator = _get_viewModel__fokd3h(this).z4g_1.a1().m();
    while (tmp0_iterator.n()) {
      ...
      var handle = element.c1();
      var savedState = handle.j4h().u4e();
      if (!savedState.j()) {
        this_0.f4d(key, savedState);
      }
    }
    // Inline function 'kotlin.contracts.contract' call
    // Inline function 'androidx.lifecycle.SavedStateHandlesProvider.saveState.<anonymous>' call
  ...
  protoOf(SavedStateHandlesProvider).k4h = function () {
    if (!this.b4h_1) {
      var newState = this.a4h_1.x4e('androidx.lifecycle.internal.SavedStateHandlesProvider');
      var tmp = this;
      // Inline function 'kotlin.apply' call
      var this_0 = Bundle_init_$Create$();
      // Inline function 'kotlin.contracts.contract' call
  ...
  protoOf(SavedStateHandlesProvider).x4e = function (key) {
    this.k4h();
    // Inline function 'kotlin.also' call
    var tmp0_safe_receiver = this.c4h_1;
    var this_0 = tmp0_safe_receiver == null ? null : tmp0_safe_receiver.y4d(key);
    // Inline function 'kotlin.contracts.contract' call
    // Inline function 'androidx.lifecycle.SavedStateHandlesProvider.consumeRestoredStateForKey.<anonymous>' call
    var tmp0_safe_receiver_0 = this.c4h_1;
    if (tmp0_safe_receiver_0 == null)
      null;
    else {
      tmp0_safe_receiver_0.s4c(key);
    }
    var tmp1_safe_receiver = this.c4h_1;
    if ((tmp1_safe_receiver == null ? null : tmp1_safe_receiver.j()) === true) {
      this.c4h_1 = null;
    }
    return this_0;
  };
  ...
  protoOf(SavedStateHandleAttacher).k4b = function (source, event) {
  ...
  function get_savedStateHandlesProvider(_this__u8e3s4) {
    _init_properties_SavedStateHandleSupport_kt__nxqisr();
    var tmp = _this__u8e3s4.x4g().z4e('androidx.lifecycle.internal.SavedStateHandlesProvider');
  ...
  function SavedStateHandlesVM() {
    ...
    tmp.z4g_1 = LinkedHashMap_init_$Create$();
  }
  function get_savedStateHandlesVM(_this__u8e3s4) {
    _init_properties_SavedStateHandleSupport_kt__nxqisr();
    var tmp = Companion_getInstance();
    return tmp.q4g(_this__u8e3s4, new savedStateHandlesVM$1()).v4g('androidx.lifecycle.internal.SavedStateHandlesVM', getKClass(SavedStateHandlesVM));
  }
  ...
  protoOf(savedStateHandlesVM$1).n4g = function (modelClass, extras) {
  ...
  function AbstractSavedStateViewModelFactory_init_$Init$(owner, defaultArgs, $this) {
    ...
    $this.m4h_1 = owner.j4e();
    $this.n4h_1 = defaultArgs;
    return $this;
  }
  protoOf(AbstractSavedStateViewModelFactory).n4g = function (modelClass, extras) {
    var tmp0_elvis_lhs = extras.k4f(Companion_getInstance().d4g_1);
    var tmp;
    if (tmp0_elvis_lhs == null) {
    ...
    var key = tmp;
    return this.o4h(key, modelClass, createSavedStateHandle(extras));
  };
  protoOf(AbstractSavedStateViewModelFactory).o4h = function (key, modelClass, handle) {
  ...
  protoOf(Companion).e4h = function (restoredState, defaultState) {
    if (restoredState == null) {
      ...
      if (defaultState == null) {
        ...
        var tmp0_iterator = defaultState.t4c().m();
        while (tmp0_iterator.n()) {
          var key = tmp0_iterator.o();
          // Inline function 'kotlin.collections.set' call
          var key_0 = (!(key == null) ? typeof key === 'string' : false) ? key : THROW_CCE();
          var value = defaultState.d4e(key);
          state.k2(key_0, value);
        }
    ...
    var tmp1_iterator = restoredState.t4c().m();
    while (tmp1_iterator.n()) {
      var key_1 = tmp1_iterator.o();
      // Inline function 'kotlin.collections.set' call
      var key_2 = (!(key_1 == null) ? typeof key_1 === 'string' : false) ? key_1 : THROW_CCE();
      var value_0 = restoredState.d4e(key_1);
      state_0.k2(key_2, value_0);
    }
    return SavedStateHandle_init_$Create$(state_0);
  };
  protoOf(Companion).p4h = function (value) {
    var tmp;
    if (value == null) {
      tmp = true;
    } else {
  ...
  function sam$androidx_savedstate_SavedStateRegistry_SavedStateProvider$0(function_0) {
    this.q4h_1 = function_0;
  }
  protoOf(sam$androidx_savedstate_SavedStateRegistry_SavedStateProvider$0).u4e = function () {
    return this.q4h_1();
  };
  protoOf(sam$androidx_savedstate_SavedStateRegistry_SavedStateProvider$0).x3 = function () {
    return this.q4h_1;
  };
  ...
  function SavedStateHandle$savedStateProvider$lambda(this$0) {
    return function () {
      var map = toMap(this$0.g4h_1);
      // Inline function 'kotlin.collections.iterator' call
      var tmp0_iterator = map.a1().m();
      while (tmp0_iterator.n()) {
        ...
        var savedState = value.u4e();
        this$0.r4h(key, savedState);
      }
      // Inline function 'kotlin.collections.toTypedArray' call
      var this_0 = toList(this$0.f4h_1);
      var tmp$ret$3 = copyToArray(this_0);
      return bundleOf(tmp$ret$3.slice());
    };
  }
  protoOf(SavedStateHandle).j4h = function () {
    return this.i4h_1;
  };
  protoOf(SavedStateHandle).s4h = function (key) {
    var tmp;
    try {
      var tmp_0 = this.f4h_1.s2(key);
  ...
  protoOf(SavedStateHandle).r4h = function (key, value) {
    if (!Companion_instance_0.p4h(value)) {
    ...
    // Inline function 'kotlin.collections.set' call
    this.f4h_1.k2(key, value);
    var tmp0_safe_receiver = this.h4h_1.s2(key);
    if (tmp0_safe_receiver != null) {
      tmp0_safe_receiver.a1y(value);
    }
  };
  protoOf(SavedStateHandle).t4h = function (key) {
    var tmp = this.f4h_1.l2(key);
  ...
  function SavedStateHandle() {
    var tmp = this;
    // Inline function 'kotlin.collections.mutableMapOf' call
    tmp.f4h_1 = LinkedHashMap_init_$Create$();
    var tmp_0 = this;
    // Inline function 'kotlin.collections.mutableMapOf' call
    tmp_0.g4h_1 = LinkedHashMap_init_$Create$();
    var tmp_1 = this;
    // Inline function 'kotlin.collections.mutableMapOf' call
    tmp_1.h4h_1 = LinkedHashMap_init_$Create$();
    var tmp_2 = this;
    var tmp_3 = SavedStateHandle$savedStateProvider$lambda(this);
    tmp_2.i4h_1 = new sam$androidx_savedstate_SavedStateRegistry_SavedStateProvider$0(tmp_3);
  }
  //region block: init
