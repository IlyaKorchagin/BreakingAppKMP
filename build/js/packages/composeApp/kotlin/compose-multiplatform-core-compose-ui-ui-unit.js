(function (factory) {
  ...
  function toDp(_this__u8e3s4) {
    ...
    if (!equals(_TextUnit___get_type__impl__uc2olt(_this__u8e3s4), Companion_getInstance_8().l5b_1)) {
    ...
    return _Dp___init__impl__ms3zkb(_TextUnit___get_value__impl__hpbx0k(_this__u8e3s4) * this.r5b());
  }
  initMetadataForInterface(FontScalingLinear, 'FontScalingLinear');
  function toPx(_this__u8e3s4) {
    return _Dp___get_value__impl__geb1vb(_this__u8e3s4) * this.g5b();
  }
  function roundToPx(_this__u8e3s4) {
    var px = this.h5b(_this__u8e3s4);
    var tmp;
    if (isInfinite(px)) {
      tmp = 2147483647;
    } else {
  ...
  function toPx_0(_this__u8e3s4) {
    ...
    return this.h5b(this.n5b(_this__u8e3s4));
  }
  function toDp_0(_this__u8e3s4) {
    // Inline function 'androidx.compose.ui.unit.dp' call
    var this_0 = _this__u8e3s4 / this.g5b();
  ...
  function toSize(_this__u8e3s4) {
    ...
    if (!_DpSize___get_packedValue__impl__jx4au8(_this__u8e3s4).equals(new Long(2143289344, 2143289344))) {
      tmp = Size(this.h5b(_DpSize___get_width__impl__o3d5gt(_this__u8e3s4)), this.h5b(_DpSize___get_height__impl__5xueo2(_this__u8e3s4)));
    } else {
      tmp = Companion_getInstance().y5a_1;
    }
    return tmp;
  }
  ...
  function _Constraints___get_minWidth__impl__hi9lfi($this) {
    ...
    var index = _Constraints___get_value__impl__3ah2ax($this).m3(new Long(3, 0)).g1();
    var mask = (1 << (13 + (((index & 1) << 1) + imul((index & 2) >> 1, 3) | 0) | 0)) - 1 | 0;
    return _Constraints___get_value__impl__3ah2ax($this).k3(2).g1() & mask;
  }
  function _Constraints___get_maxWidth__impl__uuyqc($this) {
    ...
    var index = _Constraints___get_value__impl__3ah2ax($this).m3(new Long(3, 0)).g1();
    var mask = (1 << (13 + (((index & 1) << 1) + imul((index & 2) >> 1, 3) | 0) | 0)) - 1 | 0;
    var width = _Constraints___get_value__impl__3ah2ax($this).k3(33).g1() & mask;
  ...
  function _Constraints___get_minHeight__impl__ev4bgx($this) {
    ...
    return _Constraints___get_value__impl__3ah2ax($this).k3(offset).g1() & mask;
  }
  function _Constraints___get_maxHeight__impl__dt3e8z($this) {
    ...
    var height = _Constraints___get_value__impl__3ah2ax($this).k3(offset).g1() & mask;
  ...
  function _Constraints___get_hasBoundedWidth__impl__7hd0wr($this) {
    ...
    var index = _Constraints___get_value__impl__3ah2ax($this).m3(new Long(3, 0)).g1();
    var mask = (1 << (13 + (((index & 1) << 1) + imul((index & 2) >> 1, 3) | 0) | 0)) - 1 | 0;
    return !((_Constraints___get_value__impl__3ah2ax($this).k3(33).g1() & mask) === 0);
  }
  function _Constraints___get_hasBoundedHeight__impl__bsh4rw($this) {
    ...
    // Inline function 'androidx.compose.ui.unit.minHeightOffsets' call
    var offset = (15 + bitOffset | 0) + 31 | 0;
    return !((_Constraints___get_value__impl__3ah2ax($this).k3(offset).g1() & mask) === 0);
  }
  function _Constraints___get_hasFixedWidth__impl__4p17wc($this) {
    ...
    var index = _Constraints___get_value__impl__3ah2ax($this).m3(new Long(3, 0)).g1();
    var mask = (1 << (13 + (((index & 1) << 1) + imul((index & 2) >> 1, 3) | 0) | 0)) - 1 | 0;
    var minWidth = _Constraints___get_value__impl__3ah2ax($this).k3(2).g1() & mask;
    // Inline function 'kotlin.let' call
    // Inline function 'kotlin.contracts.contract' call
    // Inline function 'androidx.compose.ui.unit.Constraints.<get-hasFixedWidth>.<anonymous>' call
    var it = _Constraints___get_value__impl__3ah2ax($this).k3(33).g1() & mask;
  ...
  function _Constraints___get_hasFixedHeight__impl__y56fxx($this) {
    ...
    // Inline function 'androidx.compose.ui.unit.minHeightOffsets' call
    var offset = 15 + bitOffset | 0;
    var minHeight = _Constraints___get_value__impl__3ah2ax($this).k3(offset).g1() & mask;
    // Inline function 'kotlin.let' call
    // Inline function 'kotlin.contracts.contract' call
    // Inline function 'androidx.compose.ui.unit.Constraints.<get-hasFixedHeight>.<anonymous>' call
    var it = _Constraints___get_value__impl__3ah2ax($this).k3(offset + 31 | 0).g1() & mask;
  ...
  function _Constraints___get_isZero__impl__fm0efw($this) {
    ...
    var index = _Constraints___get_value__impl__3ah2ax($this).m3(new Long(3, 0)).g1();
    var bitOffset = ((index & 1) << 1) + imul((index & 2) >> 1, 3) | 0;
    var tmp = _Constraints___get_value__impl__3ah2ax($this).k3(33).g1();
    // Inline function 'androidx.compose.ui.unit.widthMask' call
    ...
    // Inline function 'androidx.compose.ui.unit.minHeightOffsets' call
    var offset = (15 + bitOffset | 0) + 31 | 0;
    var tmp_0 = _Constraints___get_value__impl__3ah2ax($this).k3(offset).g1();
    // Inline function 'androidx.compose.ui.unit.heightMask' call
  ...
  function Constraints__copy$default_impl_f452rp($this, minWidth, maxWidth, minHeight, maxHeight, $super) {
    ...
    if ($super === VOID) {
      ...
      var tmp_0 = $super;
      tmp = (tmp_0 == null ? null : new Constraints(tmp_0)).b5b.call(new Constraints($this), minWidth, maxWidth, minHeight, maxHeight).a5b_1;
    }
    return tmp;
  }
  ...
  function Companion() {
    this.c5b_1 = 2147483647;
  }
  protoOf(Companion).d5b = function (width, height) {
    // Inline function 'androidx.compose.ui.unit.requirePrecondition' call
    // Inline function 'kotlin.contracts.contract' call
    if (!(width >= 0 && height >= 0)) {
  ...
  protoOf(Companion).e5b = function (minWidth, maxWidth, minHeight, maxHeight) {
  ...
  protoOf(Companion).f5b = function (minWidth, maxWidth, minHeight, maxHeight) {
    // Inline function 'kotlin.math.min' call
  ...
  function Constraints__equals_impl_33vs20($this, other) {
    if (!(other instanceof Constraints))
      return false;
    var tmp0_other_with_cast = other instanceof Constraints ? other.a5b_1 : THROW_CCE();
  ...
  protoOf(Constraints).toString = function () {
    return Constraints__toString_impl_37yskr(this.a5b_1);
  };
  protoOf(Constraints).hashCode = function () {
    return Constraints__hashCode_impl_ij7484(this.a5b_1);
  };
  protoOf(Constraints).equals = function (other) {
    return Constraints__equals_impl_33vs20(this.a5b_1, other);
  };
  ...
  function createConstraints(minWidth, maxWidth, minHeight, maxHeight) {
    ...
    var value = toLong(focus).n3(toLong(minWidth).j3(2)).n3(toLong(maxWidthValue).j3(33)).n3(toLong(minHeight).j3(minHeightOffset)).n3(toLong(maxHeightValue).j3(maxHeightOffset));
  ...
  function DensityImpl(density, fontScale) {
    this.s5b_1 = density;
    this.t5b_1 = fontScale;
  }
  protoOf(DensityImpl).g5b = function () {
    return this.s5b_1;
  };
  protoOf(DensityImpl).r5b = function () {
    return this.t5b_1;
  };
  protoOf(DensityImpl).toString = function () {
    return 'DensityImpl(density=' + this.s5b_1 + ', fontScale=' + this.t5b_1 + ')';
  };
  protoOf(DensityImpl).hashCode = function () {
    var result = getNumberHashCode(this.s5b_1);
    result = imul(result, 31) + getNumberHashCode(this.t5b_1) | 0;
    return result;
  };
  protoOf(DensityImpl).equals = function (other) {
    ...
    if (!equals(this.s5b_1, tmp0_other_with_cast.s5b_1))
      return false;
    if (!equals(this.t5b_1, tmp0_other_with_cast.t5b_1))
      return false;
    return true;
  };
  ...
  function _DpSize___get_width__impl__o3d5gt($this) {
    ...
    var bits = _DpSize___get_packedValue__impl__jx4au8($this).k3(32).g1();
  ...
  function _DpSize___get_height__impl__5xueo2($this) {
    ...
    // Inline function 'androidx.compose.ui.util.floatFromBits' call
    // Inline function 'kotlin.fromBits' call
    var bits = _DpSize___get_packedValue__impl__jx4au8($this).m3(new Long(-1, 0)).g1();
    var this_0 = floatFromBits(bits);
    return _Dp___init__impl__ms3zkb(this_0);
  }
  function Companion_0() {
    Companion_instance_0 = this;
    this.u5b_1 = _DpSize___init__impl__t4mur0(new Long(0, 0));
    this.v5b_1 = _DpSize___init__impl__t4mur0(new Long(2143289344, 2143289344));
  }
  ...
  function Dp__compareTo_impl_tlg3dl_0($this, other) {
    return Dp__compareTo_impl_tlg3dl($this.w5b_1, other instanceof Dp ? other.w5b_1 : THROW_CCE());
  }
  ...
  function Companion_1() {
    ...
    this.x5b_1 = _Dp___init__impl__ms3zkb(0.0);
    var tmp = this;
    tmp.y5b_1 = _Dp___init__impl__ms3zkb(Infinity);
    var tmp_0 = this;
    tmp_0.z5b_1 = _Dp___init__impl__ms3zkb(NaN);
  }
  ...
  function Dp__equals_impl_bc4gpq($this, other) {
    if (!(other instanceof Dp))
      return false;
    var tmp0_other_with_cast = other instanceof Dp ? other.w5b_1 : THROW_CCE();
  ...
  protoOf(Dp).a5c = function (other) {
    return Dp__compareTo_impl_tlg3dl(this.w5b_1, other);
  };
  protoOf(Dp).d = function (other) {
    return Dp__compareTo_impl_tlg3dl_0(this, other);
  };
  protoOf(Dp).toString = function () {
    return Dp__toString_impl_kcddez(this.w5b_1);
  };
  protoOf(Dp).hashCode = function () {
    return Dp__hashCode_impl_sxkrra(this.w5b_1);
  };
  protoOf(Dp).equals = function (other) {
    return Dp__equals_impl_bc4gpq(this.w5b_1, other);
  };
  ...
  function _DpOffset___get_x__impl__uauqb5($this) {
    ...
    // Inline function 'androidx.compose.ui.util.floatFromBits' call
    // Inline function 'kotlin.fromBits' call
    var bits = _DpOffset___get_packedValue__impl__7zqn8y($this).k3(32).g1();
    var this_0 = floatFromBits(bits);
    return _Dp___init__impl__ms3zkb(this_0);
  }
  function _DpOffset___get_y__impl__1h898y($this) {
    ...
    // Inline function 'androidx.compose.ui.util.floatFromBits' call
    // Inline function 'kotlin.fromBits' call
    var bits = _DpOffset___get_packedValue__impl__7zqn8y($this).m3(new Long(-1, 0)).g1();
    var this_0 = floatFromBits(bits);
    return _Dp___init__impl__ms3zkb(this_0);
  }
  ...
  function Companion_2() {
    ...
    this.b5c_1 = _DpOffset___init__impl__yq36wy(new Long(0, 0));
    this.c5c_1 = _DpOffset___init__impl__yq36wy(new Long(2143289344, 2143289344));
  }
  ...
  function DpOffset__equals_impl_7fc41d($this, other) {
    if (!(other instanceof DpOffset))
      return false;
    var tmp0_other_with_cast = other instanceof DpOffset ? other.d5c_1 : THROW_CCE();
    if (!$this.equals(tmp0_other_with_cast))
      return false;
    return true;
  }
  function DpOffset(packedValue) {
    ...
    this.d5c_1 = packedValue;
  }
  protoOf(DpOffset).toString = function () {
    return DpOffset__toString_impl_qqhvsu(this.d5c_1);
  };
  protoOf(DpOffset).hashCode = function () {
    return DpOffset__hashCode_impl_mjg9df(this.d5c_1);
  };
  protoOf(DpOffset).equals = function (other) {
    return DpOffset__equals_impl_7fc41d(this.d5c_1, other);
  };
  ...
  function _IntOffset___get_x__impl__qiqr5o($this) {
    ...
    return _IntOffset___get_packedValue__impl__982pbx($this).k3(32).g1();
  }
  function _IntOffset___get_y__impl__2avpwj($this) {
    // Inline function 'androidx.compose.ui.util.unpackInt2' call
    return _IntOffset___get_packedValue__impl__982pbx($this).m3(new Long(-1, 0)).g1();
  }
  function IntOffset__copy_impl_pmdgk6($this, x, y) {
    // Inline function 'androidx.compose.ui.util.packInts' call
    var tmp$ret$2 = toLong(x).j3(32).n3(toLong(y).m3(new Long(-1, 0)));
  ...
  function IntOffset__copy$default_impl_1y5pbb($this, x, y, $super) {
    ...
    if (x === VOID) {
      // Inline function 'androidx.compose.ui.util.unpackInt1' call
      tmp = _IntOffset___get_packedValue__impl__982pbx($this).k3(32).g1();
    } else {
      tmp = x;
    }
    x = tmp;
    ...
    if (y === VOID) {
      // Inline function 'androidx.compose.ui.util.unpackInt2' call
      tmp_0 = _IntOffset___get_packedValue__impl__982pbx($this).m3(new Long(-1, 0)).g1();
    } else {
      tmp_0 = y;
    }
    y = tmp_0;
    ...
    if ($super === VOID) {
      ...
      var tmp_2 = $super;
      tmp_1 = (tmp_2 == null ? null : new IntOffset(tmp_2)).f5c.call(new IntOffset($this), x, y).e5c_1;
    }
    return tmp_1;
  }
  function IntOffset__minus_impl_4m69hb($this, other) {
    // Inline function 'androidx.compose.ui.util.packInts' call
    // Inline function 'androidx.compose.ui.util.unpackInt1' call
    var tmp = _IntOffset___get_packedValue__impl__982pbx($this).k3(32).g1();
    // Inline function 'androidx.compose.ui.util.unpackInt1' call
    var val1 = tmp - _IntOffset___get_packedValue__impl__982pbx(other).k3(32).g1() | 0;
    // Inline function 'androidx.compose.ui.util.unpackInt2' call
    var tmp_0 = _IntOffset___get_packedValue__impl__982pbx($this).m3(new Long(-1, 0)).g1();
    // Inline function 'androidx.compose.ui.util.unpackInt2' call
    var val2 = tmp_0 - _IntOffset___get_packedValue__impl__982pbx(other).m3(new Long(-1, 0)).g1() | 0;
    var tmp$ret$4 = toLong(val1).j3(32).n3(toLong(val2).m3(new Long(-1, 0)));
  ...
  function Companion_3() {
    ...
    this.g5c_1 = _IntOffset___init__impl__rq8h7b(new Long(0, 0));
  }
  ...
  function IntOffset__equals_impl_45wak4($this, other) {
    if (!(other instanceof IntOffset))
      return false;
    var tmp0_other_with_cast = other instanceof IntOffset ? other.e5c_1 : THROW_CCE();
    if (!$this.equals(tmp0_other_with_cast))
      return false;
    return true;
  }
  function IntOffset(packedValue) {
    ...
    this.e5c_1 = packedValue;
  }
  protoOf(IntOffset).toString = function () {
    return IntOffset__toString_impl_h46d8h(this.e5c_1);
  };
  protoOf(IntOffset).hashCode = function () {
    return IntOffset__hashCode_impl_w5rrxs(this.e5c_1);
  };
  protoOf(IntOffset).equals = function (other) {
    return IntOffset__equals_impl_45wak4(this.e5c_1, other);
  };
  function IntOffset_0(x, y) {
    // Inline function 'androidx.compose.ui.util.packInts' call
    var tmp$ret$0 = toLong(x).j3(32).n3(toLong(y).m3(new Long(-1, 0)));
  ...
  function Companion_4() {
    ...
    this.h5c_1 = new IntRect(0, 0, 0, 0);
  }
  ...
  protoOf(IntRect).m5c = function (offset) {
    return _IntOffset___get_x__impl__qiqr5o(offset) >= this.i5c_1 && _IntOffset___get_x__impl__qiqr5o(offset) < this.k5c_1 && _IntOffset___get_y__impl__2avpwj(offset) >= this.j5c_1 && _IntOffset___get_y__impl__2avpwj(offset) < this.l5c_1;
  };
  protoOf(IntRect).toString = function () {
    return 'IntRect.fromLTRB(' + ('' + this.i5c_1 + ', ') + ('' + this.j5c_1 + ', ') + ('' + this.k5c_1 + ', ') + ('' + this.l5c_1 + ')');
  };
  protoOf(IntRect).hashCode = function () {
    var result = this.i5c_1;
    result = imul(result, 31) + this.j5c_1 | 0;
    result = imul(result, 31) + this.k5c_1 | 0;
    result = imul(result, 31) + this.l5c_1 | 0;
    return result;
  };
  protoOf(IntRect).equals = function (other) {
    ...
    if (!(this.i5c_1 === tmp0_other_with_cast.i5c_1))
      return false;
    if (!(this.j5c_1 === tmp0_other_with_cast.j5c_1))
      return false;
    if (!(this.k5c_1 === tmp0_other_with_cast.k5c_1))
      return false;
    if (!(this.l5c_1 === tmp0_other_with_cast.l5c_1))
      return false;
    return true;
  };
  function toRect(_this__u8e3s4) {
    return new Rect(_this__u8e3s4.i5c_1, _this__u8e3s4.j5c_1, _this__u8e3s4.k5c_1, _this__u8e3s4.l5c_1);
  }
  ...
  function _IntSize___get_width__impl__d9yl4o($this) {
    // Inline function 'androidx.compose.ui.util.unpackInt1' call
    return _IntSize___get_packedValue__impl__uho7jf($this).k3(32).g1();
  }
  function _IntSize___get_height__impl__prv63b($this) {
    // Inline function 'androidx.compose.ui.util.unpackInt2' call
    return _IntSize___get_packedValue__impl__uho7jf($this).m3(new Long(-1, 0)).g1();
  }
  ...
  function Companion_5() {
    ...
    this.n5c_1 = _IntSize___init__impl__emcjft(new Long(0, 0));
  }
  ...
  function IntSize__equals_impl_i3v38e($this, other) {
    if (!(other instanceof IntSize))
      return false;
    var tmp0_other_with_cast = other instanceof IntSize ? other.o5c_1 : THROW_CCE();
    if (!$this.equals(tmp0_other_with_cast))
      return false;
    return true;
  }
  function IntSize(packedValue) {
    ...
    this.o5c_1 = packedValue;
  }
  protoOf(IntSize).toString = function () {
    return IntSize__toString_impl_54w9zl(this.o5c_1);
  };
  protoOf(IntSize).hashCode = function () {
    return IntSize__hashCode_impl_gm9mta(this.o5c_1);
  };
  protoOf(IntSize).equals = function (other) {
    return IntSize__equals_impl_i3v38e(this.o5c_1, other);
  };
  function IntSize_0(width, height) {
    // Inline function 'androidx.compose.ui.util.packInts' call
    var tmp$ret$0 = toLong(width).j3(32).n3(toLong(height).m3(new Long(-1, 0)));
  ...
  function toIntRect(_this__u8e3s4) {
    return IntRect_0(Companion_getInstance_4().g5c_1, _this__u8e3s4);
  }
  function get_center(_this__u8e3s4) {
    return _IntOffset___init__impl__rq8h7b(_IntSize___get_packedValue__impl__uho7jf(_this__u8e3s4).k3(33).j3(32).n3(_IntSize___get_packedValue__impl__uho7jf(_this__u8e3s4).j3(32).k3(33).m3(new Long(-1, 0))));
  }
  ...
  function TextUnit__toString_impl_51ghw0($this) {
    ...
    return equals(tmp0_subject, Companion_getInstance_8().k5b_1) ? 'Unspecified' : equals(tmp0_subject, Companion_getInstance_8().l5b_1) ? '' + _TextUnit___get_value__impl__hpbx0k($this) + '.sp' : equals(tmp0_subject, Companion_getInstance_8().m5b_1) ? '' + _TextUnit___get_value__impl__hpbx0k($this) + '.em' : 'Invalid';
  }
  function Companion_6() {
    ...
    tmp.p5c_1 = [new TextUnitType(Companion_getInstance_8().k5b_1), new TextUnitType(Companion_getInstance_8().l5b_1), new TextUnitType(Companion_getInstance_8().m5b_1)];
    var tmp_0 = this;
    var tmp_1 = new Long(0, 0);
    tmp_0.q5c_1 = pack(tmp_1, NaN);
  }
  ...
  function _TextUnit___get_rawType__impl__tu8yq5($this) {
    return _TextUnit___get_packedValue__impl__it60w4($this).m3(new Long(0, 255));
  }
  function _TextUnit___get_type__impl__uc2olt($this) {
    return Companion_getInstance_7().p5c_1[_TextUnit___get_rawType__impl__tu8yq5($this).l3(32).g1()].r5c_1;
  }
  ...
  function _TextUnit___get_value__impl__hpbx0k($this) {
    // Inline function 'androidx.compose.ui.util.floatFromBits' call
    // Inline function 'kotlin.fromBits' call
    var bits = _TextUnit___get_packedValue__impl__it60w4($this).m3(new Long(-1, 0)).g1();
  ...
  function TextUnit__equals_impl_49w9tp($this, other) {
    if (!(other instanceof TextUnit))
      return false;
    var tmp0_other_with_cast = other instanceof TextUnit ? other.s5c_1 : THROW_CCE();
    if (!$this.equals(tmp0_other_with_cast))
      return false;
    return true;
  }
  function TextUnit(packedValue) {
    ...
    this.s5c_1 = packedValue;
  }
  protoOf(TextUnit).toString = function () {
    return TextUnit__toString_impl_51ghw0(this.s5c_1);
  };
  protoOf(TextUnit).hashCode = function () {
    return TextUnit__hashCode_impl_qsmeov(this.s5c_1);
  };
  protoOf(TextUnit).equals = function (other) {
    return TextUnit__equals_impl_49w9tp(this.s5c_1, other);
  };
  ...
  function TextUnitType__toString_impl_x93gyy($this) {
    return equals($this, Companion_getInstance_8().k5b_1) ? 'Unspecified' : equals($this, Companion_getInstance_8().l5b_1) ? 'Sp' : equals($this, Companion_getInstance_8().m5b_1) ? 'Em' : 'Invalid';
  }
  function Companion_7() {
    Companion_instance_7 = this;
    this.k5b_1 = _TextUnitType___init__impl__br87qi(new Long(0, 0));
    this.l5b_1 = _TextUnitType___init__impl__br87qi(new Long(0, 1));
    this.m5b_1 = _TextUnitType___init__impl__br87qi(new Long(0, 2));
  }
  ...
  function TextUnitType__equals_impl_nrbaqr($this, other) {
    if (!(other instanceof TextUnitType))
      return false;
    var tmp0_other_with_cast = other instanceof TextUnitType ? other.r5c_1 : THROW_CCE();
    if (!$this.equals(tmp0_other_with_cast))
      return false;
    return true;
  }
  ...
  protoOf(TextUnitType).toString = function () {
    return TextUnitType__toString_impl_x93gyy(this.r5c_1);
  };
  protoOf(TextUnitType).hashCode = function () {
    return TextUnitType__hashCode_impl_g0uo7b(this.r5c_1);
  };
  protoOf(TextUnitType).equals = function (other) {
    return TextUnitType__equals_impl_nrbaqr(this.r5c_1, other);
  };
  ...
  function pack(unitType, v) {
    return _TextUnit___init__impl__r5fj1s(unitType.n3(toLong(toBits(v)).m3(new Long(-1, 0))));
  }
  ...
  function _Velocity___get_x__impl__qqcikv($this) {
    ...
    // Inline function 'androidx.compose.ui.util.floatFromBits' call
    // Inline function 'kotlin.fromBits' call
    var bits = _get_packedValue__aj623s($this).k3(32).g1();
    return floatFromBits(bits);
  }
  function _Velocity___get_y__impl__239yhc($this) {
    ...
    // Inline function 'androidx.compose.ui.util.floatFromBits' call
    // Inline function 'kotlin.fromBits' call
    var bits = _get_packedValue__aj623s($this).m3(new Long(-1, 0)).g1();
    return floatFromBits(bits);
  }
  ...
  function Velocity__copy$default_impl_eql69u($this, x, y, $super) {
    ...
    if (y === VOID) {
      ...
      // Inline function 'androidx.compose.ui.util.floatFromBits' call
      // Inline function 'kotlin.fromBits' call
      var bits_0 = _get_packedValue__aj623s($this).m3(new Long(-1, 0)).g1();
    ...
    if ($super === VOID) {
      ...
      var tmp_2 = $super;
      tmp_1 = (tmp_2 == null ? null : new Velocity(tmp_2)).u5c.call(new Velocity($this), x, y).t5c_1;
    }
    return tmp_1;
  }
  function Companion_8() {
    Companion_instance_8 = this;
    this.v5c_1 = _Velocity___init__impl__tjpg0s(new Long(0, 0));
  }
  ...
  function Velocity__minus_impl_w0cg92($this, other) {
    ...
    // Inline function 'androidx.compose.ui.util.floatFromBits' call
    // Inline function 'kotlin.fromBits' call
    var bits_0 = _get_packedValue__aj623s(other).k3(32).g1();
    var val1 = tmp - floatFromBits(bits_0);
    // Inline function 'androidx.compose.ui.util.unpackFloat2' call
    // Inline function 'androidx.compose.ui.util.floatFromBits' call
    // Inline function 'kotlin.fromBits' call
    var bits_1 = _get_packedValue__aj623s($this).m3(new Long(-1, 0)).g1();
    var tmp_0 = floatFromBits(bits_1);
    // Inline function 'androidx.compose.ui.util.unpackFloat2' call
    // Inline function 'androidx.compose.ui.util.floatFromBits' call
    // Inline function 'kotlin.fromBits' call
    var bits_2 = _get_packedValue__aj623s(other).m3(new Long(-1, 0)).g1();
  ...
  function Velocity__equals_impl_327knj($this, other) {
    if (!(other instanceof Velocity))
      return false;
    var tmp0_other_with_cast = other instanceof Velocity ? other.t5c_1 : THROW_CCE();
    if (!$this.equals(tmp0_other_with_cast))
      return false;
    return true;
  }
  function Velocity(packedValue) {
    ...
    this.t5c_1 = packedValue;
  }
  protoOf(Velocity).toString = function () {
    return Velocity__toString_impl_n5zo2k(this.t5c_1);
  };
  protoOf(Velocity).hashCode = function () {
    return Velocity__hashCode_impl_q3yh3p(this.t5c_1);
  };
  protoOf(Velocity).equals = function (other) {
    return Velocity__equals_impl_327knj(this.t5c_1, other);
  };
  ...
  protoOf(DensityImpl).h5b = toPx;
  protoOf(DensityImpl).j5b = toPx_0;
  protoOf(DensityImpl).i5b = roundToPx;
  protoOf(DensityImpl).o5b = toDp_0;
  protoOf(DensityImpl).p5b = toDp_1;
  protoOf(DensityImpl).n5b = toDp;
  protoOf(DensityImpl).q5b = toSize;
  //endregion
  //region block: init
  ...
  _.$_$.y1 = _Constraints___get_isZero__impl__fm0efw;
  ...
  _.$_$.d2 = Constraints__toString_impl_37yskr;
  _.$_$.e2 = _Dp___init__impl__ms3zkb;
  _.$_$.f2 = Dp__compareTo_impl_tlg3dl;
  _.$_$.g2 = Dp__hashCode_impl_sxkrra;
  _.$_$.h2 = Dp__toString_impl_kcddez;
  _.$_$.i2 = _Dp___get_value__impl__geb1vb;
  _.$_$.j2 = _DpOffset___get_x__impl__uauqb5;
  _.$_$.k2 = _DpOffset___get_y__impl__1h898y;
  _.$_$.l2 = IntOffset__hashCode_impl_w5rrxs;
  _.$_$.m2 = IntOffset__minus_impl_4m69hb;
  _.$_$.n2 = IntOffset__plus_impl_nqoa9b;
  _.$_$.o2 = IntOffset__toString_impl_h46d8h;
  ...
  _.$_$.t2 = _IntSize___get_packedValue__impl__uho7jf;
  _.$_$.u2 = IntSize__toString_impl_54w9zl;
  ...
  _.$_$.c3 = TextUnit__toString_impl_51ghw0;
  ...
  _.$_$.i3 = Velocity__toString_impl_n5zo2k;
  ...
  _.$_$.o3 = Companion_instance;
  _.$_$.p3 = Companion_getInstance_2;
  _.$_$.q3 = Companion_getInstance_3;
  _.$_$.r3 = Companion_getInstance_1;
  _.$_$.s3 = Companion_getInstance_4;
  _.$_$.t3 = Companion_getInstance_5;
  _.$_$.u3 = Companion_getInstance_6;
