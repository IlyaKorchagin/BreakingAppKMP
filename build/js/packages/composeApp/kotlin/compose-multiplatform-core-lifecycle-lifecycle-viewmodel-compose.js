(function (factory) {
  ...
  var findComposeDefaultViewModelStoreOwner = kotlin_org_jetbrains_compose_ui_ui.$_$.i6;
  //endregion
  ...
  function LocalViewModelStoreOwner() {
    ...
    var tmp = this;
    tmp.mb1_1 = compositionLocalOf(VOID, LocalViewModelStoreOwner$LocalViewModelStoreOwner$lambda);
  }
  protoOf(LocalViewModelStoreOwner).nb1 = function ($composer, $changed) {
    var $composer_0 = $composer;
    $composer_0.y30(-584162872);
  ...
  protoOf(LocalViewModelStoreOwner).ob1 = function (viewModelStoreOwner) {
    return this.mb1_1.g38(viewModelStoreOwner);
  };
  ...
  function viewModel(modelClass, viewModelStoreOwner, key, factory, extras, $composer, $changed, $default) {
    ...
    var extras_0 = extras;
    var $composer_0 = $composer;
    $composer_0.y30(1673618944);
    sourceInformation($composer_0, 'C(viewModel)P(3,4,2,1)*94@4345L7:ViewModel.kt#3tja67');
    if (!(($default & 2) === 0)) {
      var tmp$ret$1;
      $l$block: {
        // Inline function 'kotlin.checkNotNull' call
        var value = LocalViewModelStoreOwner_getInstance().nb1($composer_0, 6);
  ...
  function get(_this__u8e3s4, modelClass, key, factory, extras) {
    ...
    var tmp_1;
    if (!(factory == null)) {
      tmp_1 = Companion_getInstance().r4g(_this__u8e3s4.p4g(), factory, extras);
    } else {
      if (isInterface(_this__u8e3s4, HasDefaultViewModelProviderFactory)) {
        tmp_1 = Companion_getInstance().r4g(_this__u8e3s4.p4g(), _this__u8e3s4.a4f(), extras);
      } else {
        tmp_1 = Companion_getInstance().q4g(_this__u8e3s4);
      }
    }
    var provider = tmp_1;
    var tmp_2;
    if (!(key == null)) {
      tmp_2 = provider.v4g(key, modelClass);
    } else {
      tmp_2 = provider.u4g(modelClass);
    }
    return tmp_2;
  }
  function findViewTreeViewModelStoreOwner($composer, $changed) {
    var $composer_0 = $composer;
    $composer_0.y30(-1455378108);
