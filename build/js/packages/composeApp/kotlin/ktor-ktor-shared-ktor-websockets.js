(function (factory) {
  ...
  function Companion() {
    ...
    while (tmp0_iterator.n()) {
      ...
      var tmp$ret$0 = element.jj2_1;
      destination.k2(tmp$ret$0, element);
    }
    tmp.kj2_1 = destination;
    this.lj2_1 = Codes_INTERNAL_ERROR_getInstance();
  }
  protoOf(Companion).mj2 = function (code) {
    return this.kj2_1.s2(code);
  };
  ...
  protoOf(CloseReason).pj2 = function () {
    return Companion_getInstance().mj2(this.nj2_1);
  };
  protoOf(CloseReason).toString = function () {
    var tmp0_elvis_lhs = this.pj2();
    return 'CloseReason(reason=' + toString(tmp0_elvis_lhs == null ? this.nj2_1 : tmp0_elvis_lhs) + ', message=' + this.oj2_1 + ')';
  };
  protoOf(CloseReason).hashCode = function () {
    var result = this.nj2_1;
    result = imul(result, 31) + getStringHashCode(this.oj2_1) | 0;
    return result;
  };
  protoOf(CloseReason).equals = function (other) {
    ...
    if (!(this.nj2_1 === tmp0_other_with_cast.nj2_1))
      return false;
    if (!(this.oj2_1 === tmp0_other_with_cast.oj2_1))
      return false;
    return true;
  };
  ...
  function Companion_0() {
    ...
    tmp.uj2_1 = ensureNotNull(tmp$ret$0).tj2_1;
    var tmp_0 = this;
    var tmp_1 = 0;
    var tmp_2 = this.uj2_1 + 1 | 0;
  ...
  function Close_init_$Init$(reason, $this) {
    ...
    builder.hib(reason.nj2_1);
    writeText(builder, reason.oj2_1);
  ...
  function Close_init_$Init$_1($this) {
    Close.call($this, Companion_getInstance_1().wj2_1);
    return $this;
  }
  ...
  function Frame(fin, frameType, data, disposableHandle, rsv1, rsv2, rsv3) {
    ...
    rsv3 = rsv3 === VOID ? false : rsv3;
    this.xj2_1 = fin;
    this.yj2_1 = frameType;
    this.zj2_1 = data;
    this.aj3_1 = disposableHandle;
    this.bj3_1 = rsv1;
    this.cj3_1 = rsv2;
    this.dj3_1 = rsv3;
  }
  protoOf(Frame).toString = function () {
    return 'Frame ' + this.yj2_1.toString() + ' (fin=' + this.xj2_1 + ', buffer len = ' + this.zj2_1.length + ')';
  };
  //region block: init
