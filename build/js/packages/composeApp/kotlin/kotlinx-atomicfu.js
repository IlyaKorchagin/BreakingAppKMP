(function (factory) {
  ...
  protoOf(atomicfu$AtomicRefArray$ref).gu = function () {
    return this.fu_1.length;
  };
  protoOf(atomicfu$AtomicRefArray$ref).atomicfu$get = function (index) {
    return this.fu_1[index];
  };
  ...
  protoOf(AtomicRef).hu = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicRef).iu = function () {
  ...
  protoOf(AtomicBoolean).ju = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicBoolean).iu = function () {
    return this.kotlinx$atomicfu$value;
  };
  ...
  protoOf(AtomicLong).ku = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicLong).iu = function () {
    return this.kotlinx$atomicfu$value;
  };
  ...
  protoOf(AtomicInt).lu = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicInt).iu = function () {
    return this.kotlinx$atomicfu$value;
  };
  ...
  defineProp(protoOf(atomicfu$AtomicRefArray$ref), 'atomicfu$size', protoOf(atomicfu$AtomicRefArray$ref).gu);
  //endregion
