(function (factory) {
  ...
  protoOf(atomicfu$AtomicRefArray$ref).lu = function () {
    return this.ku_1.length;
  };
  protoOf(atomicfu$AtomicRefArray$ref).atomicfu$get = function (index) {
    return this.ku_1[index];
  };
  ...
  protoOf(AtomicRef).mu = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicRef).nu = function () {
  ...
  protoOf(AtomicBoolean).ou = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicBoolean).nu = function () {
    return this.kotlinx$atomicfu$value;
  };
  ...
  protoOf(AtomicLong).pu = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicLong).nu = function () {
    return this.kotlinx$atomicfu$value;
  };
  ...
  protoOf(AtomicLong).atomicfu$getAndIncrement$long = function () {
    ...
    this.kotlinx$atomicfu$value = _unary__edvuaz.k3();
    return _unary__edvuaz;
  };
  protoOf(AtomicLong).atomicfu$getAndDecrement$long = function () {
    var _unary__edvuaz = this.kotlinx$atomicfu$value;
    this.kotlinx$atomicfu$value = _unary__edvuaz.l3();
    return _unary__edvuaz;
  };
  protoOf(AtomicLong).atomicfu$getAndAdd$long = function (delta) {
    var oldValue = this.kotlinx$atomicfu$value;
    this.kotlinx$atomicfu$value = this.kotlinx$atomicfu$value.f3(delta);
    return oldValue;
  };
  ...
  protoOf(AtomicLong).atomicfu$incrementAndGet$long = function () {
    this.kotlinx$atomicfu$value = this.kotlinx$atomicfu$value.k3();
    return this.kotlinx$atomicfu$value;
  };
  protoOf(AtomicLong).atomicfu$decrementAndGet$long = function () {
    this.kotlinx$atomicfu$value = this.kotlinx$atomicfu$value.l3();
    return this.kotlinx$atomicfu$value;
  };
  ...
  protoOf(AtomicInt).qu = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicInt).nu = function () {
    return this.kotlinx$atomicfu$value;
  };
  ...
  defineProp(protoOf(atomicfu$AtomicRefArray$ref), 'atomicfu$size', protoOf(atomicfu$AtomicRefArray$ref).lu);
  //endregion
