(function (factory) {
  ...
  var getOrNull = kotlin_kotlin.$_$.rg;
  ...
  function InternalUri() {
    ...
    this.g4b_1 = toCharArray('0123456789ABCDEF');
  }
  protoOf(InternalUri).h4b = function (s, allow) {
    var encoded = null;
    ...
    while (current < oldLength) {
      ...
      if (nextToEncode === oldLength) {
        if (current === 0) {
          ...
          ensureNotNull(encoded).bd(s, current, oldLength);
      ...
      if (nextToEncode > current) {
        encoded.bd(s, current, nextToEncode);
      }
      ...
      if (inductionVariable < bytesLength)
        do {
          ...
          encoded.q8(_Char___init__impl__6a9atx(37));
          encoded.q8(this.g4b_1[(bytes[i] & 240) >> 4]);
          encoded.q8(this.g4b_1[bytes[i] & 15]);
        }
  ...
  protoOf(InternalUri).i4b = function (s, allow, $super) {
    allow = allow === VOID ? null : allow;
    return $super === VOID ? this.h4b(s, allow) : $super.h4b.call(this, s, allow);
  };
  protoOf(InternalUri).j4b = function (s) {
    return UriCodec_getInstance().l4b(s, false, false);
  };
  protoOf(InternalUri).m4b = function (uriString, ssi) {
  ...
  protoOf(Uri).p4b = function (key) {
    var message = 'Abstract implementation';
    throw IllegalStateException_init_$Create$(toString(message));
  };
  protoOf(Uri).q4b = function () {
    var message = 'Abstract implementation';
    throw IllegalStateException_init_$Create$(toString(message));
  };
  function UriUtils() {
  }
  protoOf(UriUtils).j4b = function (s) {
    return InternalUri_getInstance().j4b(s);
  };
  protoOf(UriUtils).yn = function (uriString) {
  ...
  function Companion() {
    ...
    this.r4b_1 = Regex_init_$Create$('^[^?#]+\\?([^#]*).*');
    this.s4b_1 = Regex_init_$Create$('#(.+)');
  }
  ...
  function isHierarchical($this) {
    if (_get_schemeSeparatorIndex__ogocx3($this) === -1)
      return true;
    if ($this.t4b_1.length === (_get_schemeSeparatorIndex__ogocx3($this) + 1 | 0))
      return false;
    return charSequenceGet($this.t4b_1, _get_schemeSeparatorIndex__ogocx3($this) + 1 | 0) === _Char___init__impl__6a9atx(47);
  }
  function ActualUri$_query$delegate$lambda(this$0) {
    return function () {
      var tmp0_safe_receiver = Companion_getInstance().r4b_1.xd(this$0.t4b_1);
  ...
  function ActualUri$_fragment$delegate$lambda(this$0) {
    return function () {
      var tmp0_safe_receiver = Companion_getInstance().s4b_1.xd(this$0.t4b_1);
      var tmp1_safe_receiver = tmp0_safe_receiver == null ? null : tmp0_safe_receiver.ve();
      var tmp2_safe_receiver = tmp1_safe_receiver == null ? null : tmp1_safe_receiver.o(1);
      return tmp2_safe_receiver == null ? null : tmp2_safe_receiver.ie_1;
    };
  ...
  function ActualUri$schemeSeparatorIndex$delegate$lambda(this$0) {
    return function () {
      return indexOf(this$0.t4b_1, _Char___init__impl__6a9atx(58));
    };
  }
  function ActualUri$_pathSegments$delegate$lambda(this$0) {
    return function () {
      ...
      var tmp;
      if (ssi > -1) {
        if ((ssi + 1 | 0) === this$0.t4b_1.length)
          return emptyList();
        var tmp_0;
        var tmp_1 = getOrNull(this$0.t4b_1, ssi + 1 | 0);
        if (!equals(tmp_1 == null ? null : new Char(tmp_1), new Char(_Char___init__impl__6a9atx(47)))) {
          return emptyList();
        }
        tmp = tmp_0;
      }
      var path = InternalUri_getInstance().m4b(this$0.t4b_1, ssi);
      ...
      while (tmp0_iterator.h()) {
        ...
        var tmp$ret$0 = ensureNotNull(InternalUri_getInstance().j4b(item));
  ...
  function ActualUri(uriString) {
    ...
    Uri.call(this);
    this.t4b_1 = uriString;
    var tmp = this;
    tmp.u4b_1 = lazy(ActualUri$_query$delegate$lambda(this));
    var tmp_0 = this;
    tmp_0.v4b_1 = lazy(ActualUri$_fragment$delegate$lambda(this));
    var tmp_1 = this;
    tmp_1.w4b_1 = lazy(ActualUri$schemeSeparatorIndex$delegate$lambda(this));
    var tmp_2 = this;
    tmp_2.x4b_1 = lazy(ActualUri$_pathSegments$delegate$lambda(this));
  }
  protoOf(ActualUri).n4b = function () {
    return _get__fragment__v30tj6(this);
  };
  protoOf(ActualUri).o4b = function () {
    return _get__query__44rau6(this);
  };
  protoOf(ActualUri).p4b = function (key) {
    ...
    var query = tmp;
    var encodedKey = InternalUri_getInstance().i4b(key);
  ...
  protoOf(ActualUri).q4b = function () {
    // Inline function 'kotlin.require' call
    // Inline function 'kotlin.contracts.contract' call
    // Inline function 'kotlin.require' call
    // Inline function 'kotlin.contracts.contract' call
    ...
    while (tmp0_iterator.h()) {
      ...
      $l$block: {
        ...
        if (index === -1) {
          ...
          tmp_0 = ensureNotNull(tmp_1.j4b(tmp$ret$3));
        }
        tmp$ret$1 = tmp_0;
      }
  ...
  function appendDecoded($this, builder, s, convertPlus, throwOnFailure) {
    ...
    while (i < s.length) {
      ...
      if (tmp1_subject === _Char___init__impl__6a9atx(43)) {
        ...
        builder.q8(convertPlus ? _Char___init__impl__6a9atx(32) : _Char___init__impl__6a9atx(43));
          ...
          try {
            ...
            if ($p instanceof URISyntaxException) {
              ...
              if (throwOnFailure) {
                ...
                appendDecoded$flush(byteBufferPosition, builder, byteBuffer, throwOnFailure);
                builder.q8(_Char___init__impl__6a9atx(65533));
  ...
  function appendDecoded$flush(byteBufferPosition, $builder, byteBuffer, $throwOnFailure) {
    ...
    $builder.p8(decodeToString(byteBuffer, VOID, byteBufferPosition._v, $throwOnFailure));
    byteBufferPosition._v = 0;
  }
  function UriCodec() {
    UriCodec_instance = this;
    this.k4b_1 = _Char___init__impl__6a9atx(65533);
  }
  protoOf(UriCodec).l4b = function (s, convertPlus, throwOnFailure) {
