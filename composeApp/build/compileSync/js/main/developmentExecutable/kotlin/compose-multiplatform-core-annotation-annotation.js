(function (factory) {
  ...
  var contentEquals = kotlin_kotlin.$_$.g9;
  ...
  var contentEquals_0 = kotlin_kotlin.$_$.e9;
  //endregion
  //region block: pre-declaration
  initMetadataForClass(CallSuper, 'CallSuper', VOID, VOID, [Annotation]);
  ...
  protoOf(CallSuper).equals = function (other) {
    if (!(other instanceof CallSuper))
      return false;
    other instanceof CallSuper || THROW_CCE();
    return true;
  };
  protoOf(CallSuper).hashCode = function () {
    return 0;
  };
  protoOf(CallSuper).toString = function () {
