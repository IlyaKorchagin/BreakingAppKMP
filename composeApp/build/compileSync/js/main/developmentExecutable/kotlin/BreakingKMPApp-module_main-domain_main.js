(function (factory) {
  ...
  initMetadataForLambda(GetBboysList$getBboysList$o$collect$slambda, CoroutineImpl, [CoroutineImpl], [1]);
  ...
  initMetadataForLambda(GetFreezeElements$getFreezeElements$o$collect$slambda, CoroutineImpl, [CoroutineImpl], [1]);
  ...
  initMetadataForLambda(GetOfpElements$getOfpElements$o$collect$slambda, CoroutineImpl, [CoroutineImpl], [1]);
  ...
  initMetadataForLambda(GetPowerElements$getPowerElements$o$collect$slambda, CoroutineImpl, [CoroutineImpl], [1]);
  ...
  initMetadataForLambda(GetStretchElements$getStretchElements$o$collect$slambda, CoroutineImpl, [CoroutineImpl], [1]);
  ...
  function MainUseCase(getAllPupils, getPupilById, getFreezeElements, getPowerElements, getOfpElements, getStretchElements, getBboysList, createNewPupil, uploadAvatar) {
    ...
    this.getFreezeElements_1 = getFreezeElements;
    this.getPowerElements_1 = getPowerElements;
    this.getOfpElements_1 = getOfpElements;
    this.getStretchElements_1 = getStretchElements;
    this.getBboysList_1 = getBboysList;
    this.createNewPupil_1 = createNewPupil;
    this.uploadAvatar_1 = uploadAvatar;
  }
  ...
  protoOf(MainUseCase).get_getFreezeElements_uzuvaz_k$ = function () {
    return this.getFreezeElements_1;
  };
  protoOf(MainUseCase).get_getPowerElements_s3zpkf_k$ = function () {
    return this.getPowerElements_1;
  };
  protoOf(MainUseCase).get_getOfpElements_6lmjc3_k$ = function () {
    return this.getOfpElements_1;
  };
  protoOf(MainUseCase).get_getStretchElements_t2lunj_k$ = function () {
    return this.getStretchElements_1;
  };
  protoOf(MainUseCase).get_getBboysList_p8qf6i_k$ = function () {
    return this.getBboysList_1;
  };
  protoOf(MainUseCase).get_createNewPupil_4xjgz_k$ = function () {
    return this.createNewPupil_1;
  };
  protoOf(MainUseCase).get_uploadAvatar_vvh5vh_k$ = function () {
    return this.uploadAvatar_1;
  };
  ...
  protoOf(MainUseCase).component3_7eebsa_k$ = function () {
    return this.getFreezeElements_1;
  };
  protoOf(MainUseCase).component4_7eebs9_k$ = function () {
    return this.getPowerElements_1;
  };
  protoOf(MainUseCase).component5_7eebs8_k$ = function () {
    return this.getOfpElements_1;
  };
  protoOf(MainUseCase).component6_7eebs7_k$ = function () {
    return this.getStretchElements_1;
  };
  protoOf(MainUseCase).component7_7eebs6_k$ = function () {
    return this.getBboysList_1;
  };
  protoOf(MainUseCase).component8_7eebs5_k$ = function () {
    return this.createNewPupil_1;
  };
  protoOf(MainUseCase).component9_7eebs4_k$ = function () {
    return this.uploadAvatar_1;
  };
  protoOf(MainUseCase).copy_4n2s76_k$ = function (getAllPupils, getPupilById, getFreezeElements, getPowerElements, getOfpElements, getStretchElements, getBboysList, createNewPupil, uploadAvatar) {
    return new MainUseCase(getAllPupils, getPupilById, getFreezeElements, getPowerElements, getOfpElements, getStretchElements, getBboysList, createNewPupil, uploadAvatar);
  };
  protoOf(MainUseCase).copy$default_wr431p_k$ = function (getAllPupils, getPupilById, getFreezeElements, getPowerElements, getOfpElements, getStretchElements, getBboysList, createNewPupil, uploadAvatar, $super) {
    ...
    getFreezeElements = getFreezeElements === VOID ? this.getFreezeElements_1 : getFreezeElements;
    getPowerElements = getPowerElements === VOID ? this.getPowerElements_1 : getPowerElements;
    getOfpElements = getOfpElements === VOID ? this.getOfpElements_1 : getOfpElements;
    getStretchElements = getStretchElements === VOID ? this.getStretchElements_1 : getStretchElements;
    getBboysList = getBboysList === VOID ? this.getBboysList_1 : getBboysList;
    createNewPupil = createNewPupil === VOID ? this.createNewPupil_1 : createNewPupil;
    uploadAvatar = uploadAvatar === VOID ? this.uploadAvatar_1 : uploadAvatar;
    return $super === VOID ? this.copy_4n2s76_k$(getAllPupils, getPupilById, getFreezeElements, getPowerElements, getOfpElements, getStretchElements, getBboysList, createNewPupil, uploadAvatar) : $super.copy_4n2s76_k$.call(this, getAllPupils, getPupilById, getFreezeElements, getPowerElements, getOfpElements, getStretchElements, getBboysList, createNewPupil, uploadAvatar);
  };
  protoOf(MainUseCase).toString = function () {
    return 'MainUseCase(getAllPupils=' + toString(this.getAllPupils_1) + ', getPupilById=' + toString(this.getPupilById_1) + ', getFreezeElements=' + toString(this.getFreezeElements_1) + ', getPowerElements=' + toString(this.getPowerElements_1) + ', getOfpElements=' + toString(this.getOfpElements_1) + ', getStretchElements=' + toString(this.getStretchElements_1) + ', getBboysList=' + toString(this.getBboysList_1) + ', createNewPupil=' + toString(this.createNewPupil_1) + ', uploadAvatar=' + toString(this.uploadAvatar_1) + ')';
  };
  protoOf(MainUseCase).hashCode = function () {
    ...
    result = imul(result, 31) + hashCode(this.getFreezeElements_1) | 0;
    result = imul(result, 31) + hashCode(this.getPowerElements_1) | 0;
    result = imul(result, 31) + hashCode(this.getOfpElements_1) | 0;
    result = imul(result, 31) + hashCode(this.getStretchElements_1) | 0;
    result = imul(result, 31) + hashCode(this.getBboysList_1) | 0;
    result = imul(result, 31) + hashCode(this.createNewPupil_1) | 0;
    result = imul(result, 31) + hashCode(this.uploadAvatar_1) | 0;
    return result;
  };
  protoOf(MainUseCase).equals = function (other) {
    ...
    if (!equals(this.getPupilById_1, tmp0_other_with_cast.getPupilById_1))
      return false;
    if (!equals(this.getFreezeElements_1, tmp0_other_with_cast.getFreezeElements_1))
      return false;
    if (!equals(this.getPowerElements_1, tmp0_other_with_cast.getPowerElements_1))
      return false;
    if (!equals(this.getOfpElements_1, tmp0_other_with_cast.getOfpElements_1))
      return false;
    if (!equals(this.getStretchElements_1, tmp0_other_with_cast.getStretchElements_1))
      return false;
    if (!equals(this.getBboysList_1, tmp0_other_with_cast.getBboysList_1))
      return false;
    if (!equals(this.createNewPupil_1, tmp0_other_with_cast.createNewPupil_1))
      return false;
    if (!equals(this.uploadAvatar_1, tmp0_other_with_cast.uploadAvatar_1))
      return false;
    return true;
  };
  ...
  function mainDomainModule$lambda$lambda($this$single, it) {
    ...
    // Inline function 'org.koin.core.scope.Scope.get' call
    var tmp$ret$2 = $this$single.get_80ko8d_k$(getKClass(UserRepository), null, null);
    var tmp_1 = new GetFreezeElements(tmp$ret$2);
    // Inline function 'org.koin.core.scope.Scope.get' call
    var tmp$ret$3 = $this$single.get_80ko8d_k$(getKClass(UserRepository), null, null);
    var tmp_2 = new GetPowerElements(tmp$ret$3);
    // Inline function 'org.koin.core.scope.Scope.get' call
    var tmp$ret$4 = $this$single.get_80ko8d_k$(getKClass(UserRepository), null, null);
    var tmp_3 = new GetOfpElements(tmp$ret$4);
    // Inline function 'org.koin.core.scope.Scope.get' call
    var tmp$ret$5 = $this$single.get_80ko8d_k$(getKClass(UserRepository), null, null);
    var tmp_4 = new GetStretchElements(tmp$ret$5);
    // Inline function 'org.koin.core.scope.Scope.get' call
    var tmp$ret$6 = $this$single.get_80ko8d_k$(getKClass(UserRepository), null, null);
    var tmp_5 = new GetBboysList(tmp$ret$6);
    // Inline function 'org.koin.core.scope.Scope.get' call
    var tmp$ret$7 = $this$single.get_80ko8d_k$(getKClass(UserRepository), null, null);
    var tmp_6 = new CreateNewPupil(tmp$ret$7);
    // Inline function 'org.koin.core.scope.Scope.get' call
    var tmp$ret$8 = $this$single.get_80ko8d_k$(getKClass(UserRepository), null, null);
  ...
  protoOf(BboyDomainModel).get_name_woqyms_k$ = function () {
    return this.name_1;
  };
  protoOf(BboyDomainModel).get_born_wojlaq_k$ = function () {
    return this.born_1;
  };
  protoOf(BboyDomainModel).get_rating_iw9d46_k$ = function () {
    return this.rating_1;
  };
  protoOf(BboyDomainModel).get_avatar_b5pjz6_k$ = function () {
    return this.avatar_1;
  };
  protoOf(BboyDomainModel).get_country_h3tl7x_k$ = function () {
    return this.country_1;
  };
  protoOf(BboyDomainModel).get_video_j06c0i_k$ = function () {
    return this.video_1;
  };
  protoOf(BboyDomainModel).get_description_emjre5_k$ = function () {
    return this.description_1;
  };
  protoOf(BboyDomainModel).get_shortDescription_ehpvfb_k$ = function () {
    return this.shortDescription_1;
  };
  protoOf(BboyDomainModel).component1_7eebsc_k$ = function () {
    return this.name_1;
  };
  protoOf(BboyDomainModel).component2_7eebsb_k$ = function () {
    return this.born_1;
  };
  protoOf(BboyDomainModel).component3_7eebsa_k$ = function () {
    return this.rating_1;
  };
  protoOf(BboyDomainModel).component4_7eebs9_k$ = function () {
    return this.avatar_1;
  };
  protoOf(BboyDomainModel).component5_7eebs8_k$ = function () {
    return this.country_1;
  };
  protoOf(BboyDomainModel).component6_7eebs7_k$ = function () {
    return this.video_1;
  };
  protoOf(BboyDomainModel).component7_7eebs6_k$ = function () {
    return this.description_1;
  };
  protoOf(BboyDomainModel).component8_7eebs5_k$ = function () {
    return this.shortDescription_1;
  };
  protoOf(BboyDomainModel).copy_akmpvv_k$ = function (name, born, rating, avatar, country, video, description, shortDescription) {
    return new BboyDomainModel(name, born, rating, avatar, country, video, description, shortDescription);
  };
  protoOf(BboyDomainModel).copy$default_2qadpj_k$ = function (name, born, rating, avatar, country, video, description, shortDescription, $super) {
  ...
  protoOf(BboyDomainModel).toString = function () {
    return 'BboyDomainModel(name=' + this.name_1 + ', born=' + this.born_1 + ', rating=' + this.rating_1 + ', avatar=' + this.avatar_1 + ', country=' + this.country_1 + ', video=' + this.video_1 + ', description=' + this.description_1 + ', shortDescription=' + this.shortDescription_1 + ')';
  };
  ...
  function toBboyDomainModel(_this__u8e3s4) {
    return new BboyDomainModel(_this__u8e3s4.get_name_woqyms_k$(), _this__u8e3s4.get_born_wojlaq_k$(), _this__u8e3s4.get_rating_iw9d46_k$(), _this__u8e3s4.get_avatar_b5pjz6_k$(), _this__u8e3s4.get_country_h3tl7x_k$(), _this__u8e3s4.get_video_j06c0i_k$(), _this__u8e3s4.get_description_emjre5_k$(), _this__u8e3s4.get_shortDescription_ehpvfb_k$());
  }
  ...
  protoOf(ElementDomainModel).set_title_apz2j3_k$ = function (_set____db54di) {
    this.title_1 = _set____db54di;
  };
  protoOf(ElementDomainModel).get_title_iz32un_k$ = function () {
    return this.title_1;
  };
  protoOf(ElementDomainModel).set_image_7p6b84_k$ = function (_set____db54di) {
    this.image_1 = _set____db54di;
  };
  protoOf(ElementDomainModel).get_image_it3i2a_k$ = function () {
    return this.image_1;
  };
  protoOf(ElementDomainModel).set_description_5tkket_k$ = function (_set____db54di) {
    this.description_1 = _set____db54di;
  };
  protoOf(ElementDomainModel).get_description_emjre5_k$ = function () {
    return this.description_1;
  };
  protoOf(ElementDomainModel).set_blockDescription_j8haym_k$ = function (_set____db54di) {
    this.blockDescription_1 = _set____db54di;
  };
  protoOf(ElementDomainModel).get_blockDescription_1s1jig_k$ = function () {
    return this.blockDescription_1;
  };
  protoOf(ElementDomainModel).set_progress10_c89pfl_k$ = function (_set____db54di) {
    this.progress10__1 = _set____db54di;
  };
  protoOf(ElementDomainModel).get_progress10_jkir8r_k$ = function () {
    return this.progress10__1;
  };
  protoOf(ElementDomainModel).set_progress20_7rojum_k$ = function (_set____db54di) {
    this.progress20__1 = _set____db54di;
  };
  protoOf(ElementDomainModel).get_progress20_jkir7w_k$ = function () {
    return this.progress20__1;
  };
  protoOf(ElementDomainModel).set_progress30_rrmt4t_k$ = function (_set____db54di) {
    this.progress30__1 = _set____db54di;
  };
  protoOf(ElementDomainModel).get_progress30_jkir71_k$ = function () {
    return this.progress30__1;
  };
  protoOf(ElementDomainModel).set_progress40_n9izk4_k$ = function (_set____db54di) {
    this.progress40__1 = _set____db54di;
  };
  protoOf(ElementDomainModel).get_progress40_jkir66_k$ = function () {
    return this.progress40__1;
  };
  protoOf(ElementDomainModel).set_progress50_39kq9x_k$ = function (_set____db54di) {
    this.progress50__1 = _set____db54di;
  };
  protoOf(ElementDomainModel).get_progress50_jkir5b_k$ = function () {
    return this.progress50__1;
  };
  protoOf(ElementDomainModel).set_progress60_gqdj0a_k$ = function (_set____db54di) {
    this.progress60__1 = _set____db54di;
  };
  protoOf(ElementDomainModel).get_progress60_jkir4g_k$ = function () {
    return this.progress60__1;
  };
  protoOf(ElementDomainModel).set_progress70_yas9on_k$ = function (_set____db54di) {
    this.progress70__1 = _set____db54di;
  };
  protoOf(ElementDomainModel).get_progress70_jkir3l_k$ = function () {
    return this.progress70__1;
  };
  protoOf(ElementDomainModel).set_progress80_eau0eg_k$ = function (_set____db54di) {
    this.progress80__1 = _set____db54di;
  };
  protoOf(ElementDomainModel).get_progress80_jkir2q_k$ = function () {
    return this.progress80__1;
  };
  protoOf(ElementDomainModel).set_progress90_5p48vr_k$ = function (_set____db54di) {
    this.progress90__1 = _set____db54di;
  };
  protoOf(ElementDomainModel).get_progress90_jkir1v_k$ = function () {
    return this.progress90__1;
  };
  protoOf(ElementDomainModel).set_progress100_tzqbct_k$ = function (_set____db54di) {
    this.progress100__1 = _set____db54di;
  };
  protoOf(ElementDomainModel).get_progress100_wlv1a3_k$ = function () {
    return this.progress100__1;
  };
  protoOf(ElementDomainModel).set_videoUrl_n280k9_k$ = function (_set____db54di) {
    this.videoUrl_1 = _set____db54di;
  };
  protoOf(ElementDomainModel).get_videoUrl_crfpkz_k$ = function () {
    return this.videoUrl_1;
  };
  protoOf(ElementDomainModel).component1_7eebsc_k$ = function () {
    return this.title_1;
  };
  protoOf(ElementDomainModel).component2_7eebsb_k$ = function () {
    return this.image_1;
  };
  protoOf(ElementDomainModel).component3_7eebsa_k$ = function () {
    return this.description_1;
  };
  protoOf(ElementDomainModel).component4_7eebs9_k$ = function () {
    return this.blockDescription_1;
  };
  protoOf(ElementDomainModel).component5_7eebs8_k$ = function () {
    return this.progress10__1;
  };
  protoOf(ElementDomainModel).component6_7eebs7_k$ = function () {
    return this.progress20__1;
  };
  protoOf(ElementDomainModel).component7_7eebs6_k$ = function () {
    return this.progress30__1;
  };
  protoOf(ElementDomainModel).component8_7eebs5_k$ = function () {
    return this.progress40__1;
  };
  protoOf(ElementDomainModel).component9_7eebs4_k$ = function () {
    return this.progress50__1;
  };
  protoOf(ElementDomainModel).component10_gazzfo_k$ = function () {
    return this.progress60__1;
  };
  protoOf(ElementDomainModel).component11_gazzfn_k$ = function () {
    return this.progress70__1;
  };
  protoOf(ElementDomainModel).component12_gazzfm_k$ = function () {
    return this.progress80__1;
  };
  protoOf(ElementDomainModel).component13_gazzfl_k$ = function () {
    return this.progress90__1;
  };
  protoOf(ElementDomainModel).component14_gazzfk_k$ = function () {
    return this.progress100__1;
  };
  protoOf(ElementDomainModel).component15_gazzfj_k$ = function () {
    return this.videoUrl_1;
  };
  protoOf(ElementDomainModel).copy_fexonv_k$ = function (title, image, description, blockDescription, progress10, progress20, progress30, progress40, progress50, progress60, progress70, progress80, progress90, progress100, videoUrl) {
    return new ElementDomainModel(title, image, description, blockDescription, progress10, progress20, progress30, progress40, progress50, progress60, progress70, progress80, progress90, progress100, videoUrl);
  };
  protoOf(ElementDomainModel).copy$default_p0qwei_k$ = function (title, image, description, blockDescription, progress10, progress20, progress30, progress40, progress50, progress60, progress70, progress80, progress90, progress100, videoUrl, $super) {
  ...
  protoOf(CreateNewPupil).createNewPupil_w26sp9_k$ = function (email, name, $completion) {
    return this.repository_1.createNewPupil_w26sp9_k$(email, name, $completion);
  };
  ...
  protoOf(GetBboysList$getBboysList$o$collect$slambda).invoke_e0ttvm_k$ = function (value, $completion) {
    var tmp = this.create_wyq9v6_k$(value, $completion);
    tmp.set_result_xj64lm_k$(Unit_getInstance());
    tmp.set_exception_px07aa_k$(null);
    return tmp.doResume_5yljmg_k$();
  };
  protoOf(GetBboysList$getBboysList$o$collect$slambda).invoke_qns8j1_k$ = function (p1, $completion) {
    return this.invoke_e0ttvm_k$((p1 == null ? true : !(p1 == null)) ? p1 : THROW_CCE(), $completion);
  };
  protoOf(GetBboysList$getBboysList$o$collect$slambda).doResume_5yljmg_k$ = function () {
    var suspendResult = this.get_result_iyg5d2_k$();
    $sm: do
      try {
        var tmp = this.get_state_iypx7s_k$();
        switch (tmp) {
          case 0:
            ...
            while (tmp0_iterator.hasNext_bitz1p_k$()) {
              var item = tmp0_iterator.next_20eer_k$();
              destination.add_utx5q5_k$(toBboyDomainModel(item));
            }
  ...
  protoOf(GetBboysList$getBboysList$o$collect$slambda).create_wyq9v6_k$ = function (value, completion) {
    var i = new GetBboysList$getBboysList$o$collect$slambda(this.$$this$unsafeFlow_1, completion);
    i.value_1 = value;
    return i;
  };
      ...
      try {
        ...
        switch (tmp) {
          case 0:
            ...
            tmp_0.$this$unsafeFlow0__1 = this.collector_1;
            this.set_state_rjd8d0_k$(1);
            var tmp_1 = GetBboysList$getBboysList$o$collect$slambda_0(this.$this$unsafeFlow0__1, null);
  ...
  protoOf(GetBboysList).getBboysList_kp64gh_k$ = function () {
    // Inline function 'kotlinx.coroutines.flow.map' call
    // Inline function 'kotlinx.coroutines.flow.unsafeTransform' call
    var this_0 = this.repository_1.getBboysList_kp64gh_k$();
    // Inline function 'kotlinx.coroutines.flow.internal.unsafeFlow' call
  ...
  protoOf(GetFreezeElements$getFreezeElements$o$collect$slambda).invoke_e0ttvm_k$ = function (value, $completion) {
    var tmp = this.create_wyq9v6_k$(value, $completion);
    tmp.set_result_xj64lm_k$(Unit_getInstance());
    tmp.set_exception_px07aa_k$(null);
    return tmp.doResume_5yljmg_k$();
  };
  protoOf(GetFreezeElements$getFreezeElements$o$collect$slambda).invoke_qns8j1_k$ = function (p1, $completion) {
    return this.invoke_e0ttvm_k$((p1 == null ? true : !(p1 == null)) ? p1 : THROW_CCE(), $completion);
  };
  protoOf(GetFreezeElements$getFreezeElements$o$collect$slambda).doResume_5yljmg_k$ = function () {
    var suspendResult = this.get_result_iyg5d2_k$();
    $sm: do
      try {
        var tmp = this.get_state_iypx7s_k$();
        switch (tmp) {
          case 0:
            ...
            while (tmp0_iterator.hasNext_bitz1p_k$()) {
              var item = tmp0_iterator.next_20eer_k$();
              destination.add_utx5q5_k$(toElementDomainModel(item));
            }
  ...
  protoOf(GetFreezeElements$getFreezeElements$o$collect$slambda).create_wyq9v6_k$ = function (value, completion) {
    var i = new GetFreezeElements$getFreezeElements$o$collect$slambda(this.$$this$unsafeFlow_1, completion);
    i.value_1 = value;
    return i;
  };
      ...
      try {
        ...
        switch (tmp) {
          case 0:
            ...
            tmp_0.$this$unsafeFlow0__1 = this.collector_1;
            this.set_state_rjd8d0_k$(1);
            var tmp_1 = GetFreezeElements$getFreezeElements$o$collect$slambda_0(this.$this$unsafeFlow0__1, null);
  ...
  protoOf(GetFreezeElements).getFreezeElements_b3r9zw_k$ = function () {
    // Inline function 'kotlinx.coroutines.flow.map' call
    // Inline function 'kotlinx.coroutines.flow.unsafeTransform' call
    var this_0 = this.repository_1.getFreezeElements_b3r9zw_k$();
    // Inline function 'kotlinx.coroutines.flow.internal.unsafeFlow' call
  ...
  protoOf(GetOfpElements$getOfpElements$o$collect$slambda).invoke_e0ttvm_k$ = function (value, $completion) {
    var tmp = this.create_wyq9v6_k$(value, $completion);
    tmp.set_result_xj64lm_k$(Unit_getInstance());
    tmp.set_exception_px07aa_k$(null);
    return tmp.doResume_5yljmg_k$();
  };
  protoOf(GetOfpElements$getOfpElements$o$collect$slambda).invoke_qns8j1_k$ = function (p1, $completion) {
    return this.invoke_e0ttvm_k$((p1 == null ? true : !(p1 == null)) ? p1 : THROW_CCE(), $completion);
  };
  protoOf(GetOfpElements$getOfpElements$o$collect$slambda).doResume_5yljmg_k$ = function () {
    var suspendResult = this.get_result_iyg5d2_k$();
    $sm: do
      try {
        var tmp = this.get_state_iypx7s_k$();
  ...
  protoOf(GetOfpElements$getOfpElements$o$collect$slambda).create_wyq9v6_k$ = function (value, completion) {
    var i = new GetOfpElements$getOfpElements$o$collect$slambda(this.$$this$unsafeFlow_1, completion);
    i.value_1 = value;
    return i;
  };
      ...
      try {
        ...
        switch (tmp) {
          case 0:
            ...
            tmp_0.$this$unsafeFlow0__1 = this.collector_1;
            this.set_state_rjd8d0_k$(1);
            var tmp_1 = GetOfpElements$getOfpElements$o$collect$slambda_0(this.$this$unsafeFlow0__1, null);
  ...
  function _get_repository__phhg8v_3($this) {
    return $this.repository_1;
  }
  ...
  protoOf(_no_name_provided__qut3iv_2).collect_ooju95_k$ = function (collector, $completion) {
  ...
  protoOf(GetOfpElements).getOfpElements_qrccyu_k$ = function () {
    // Inline function 'kotlinx.coroutines.flow.map' call
    // Inline function 'kotlinx.coroutines.flow.unsafeTransform' call
    var this_0 = this.repository_1.getOfpElements_qrccyu_k$();
    // Inline function 'kotlinx.coroutines.flow.internal.unsafeFlow' call
  ...
  protoOf(GetPowerElements$getPowerElements$o$collect$slambda).invoke_e0ttvm_k$ = function (value, $completion) {
    var tmp = this.create_wyq9v6_k$(value, $completion);
    tmp.set_result_xj64lm_k$(Unit_getInstance());
    tmp.set_exception_px07aa_k$(null);
    return tmp.doResume_5yljmg_k$();
  };
  protoOf(GetPowerElements$getPowerElements$o$collect$slambda).invoke_qns8j1_k$ = function (p1, $completion) {
    return this.invoke_e0ttvm_k$((p1 == null ? true : !(p1 == null)) ? p1 : THROW_CCE(), $completion);
  };
  protoOf(GetPowerElements$getPowerElements$o$collect$slambda).doResume_5yljmg_k$ = function () {
    var suspendResult = this.get_result_iyg5d2_k$();
    $sm: do
      try {
        var tmp = this.get_state_iypx7s_k$();
  ...
  protoOf(GetPowerElements$getPowerElements$o$collect$slambda).create_wyq9v6_k$ = function (value, completion) {
    var i = new GetPowerElements$getPowerElements$o$collect$slambda(this.$$this$unsafeFlow_1, completion);
    i.value_1 = value;
    return i;
  };
      ...
      try {
        ...
        switch (tmp) {
          case 0:
            ...
            tmp_0.$this$unsafeFlow0__1 = this.collector_1;
            this.set_state_rjd8d0_k$(1);
            var tmp_1 = GetPowerElements$getPowerElements$o$collect$slambda_0(this.$this$unsafeFlow0__1, null);
            suspendResult = this._this__u8e3s4__1.$this_1.collect_aksokr_k$(new sam$kotlinx_coroutines_flow_FlowCollector$0_3(tmp_1), this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
  ...
  function _get_repository__phhg8v_4($this) {
    return $this.repository_1;
  }
  ...
  protoOf(_no_name_provided__qut3iv_3).collect_ooju95_k$ = function (collector, $completion) {
  ...
  protoOf(GetPowerElements).getPowerElements_3u850m_k$ = function () {
    // Inline function 'kotlinx.coroutines.flow.map' call
    // Inline function 'kotlinx.coroutines.flow.unsafeTransform' call
    var this_0 = this.repository_1.getPowerElements_3u850m_k$();
    // Inline function 'kotlinx.coroutines.flow.internal.unsafeFlow' call
  ...
  function _get_repository__phhg8v_5($this) {
    return $this.repository_1;
  }
  ...
  protoOf(_no_name_provided__qut3iv_4).collect_ooju95_k$ = function (collector, $completion) {
  ...
  protoOf(GetStretchElements$getStretchElements$o$collect$slambda).invoke_e0ttvm_k$ = function (value, $completion) {
    var tmp = this.create_wyq9v6_k$(value, $completion);
    tmp.set_result_xj64lm_k$(Unit_getInstance());
    tmp.set_exception_px07aa_k$(null);
    return tmp.doResume_5yljmg_k$();
  };
  protoOf(GetStretchElements$getStretchElements$o$collect$slambda).invoke_qns8j1_k$ = function (p1, $completion) {
    return this.invoke_e0ttvm_k$((p1 == null ? true : !(p1 == null)) ? p1 : THROW_CCE(), $completion);
  };
  protoOf(GetStretchElements$getStretchElements$o$collect$slambda).doResume_5yljmg_k$ = function () {
    var suspendResult = this.get_result_iyg5d2_k$();
    $sm: do
      try {
        var tmp = this.get_state_iypx7s_k$();
  ...
  protoOf(GetStretchElements$getStretchElements$o$collect$slambda).create_wyq9v6_k$ = function (value, completion) {
    var i = new GetStretchElements$getStretchElements$o$collect$slambda(this.$$this$unsafeFlow_1, completion);
    i.value_1 = value;
    return i;
  };
      ...
      try {
        ...
        switch (tmp) {
          case 0:
            ...
            tmp_0.$this$unsafeFlow0__1 = this.collector_1;
            this.set_state_rjd8d0_k$(1);
            var tmp_1 = GetStretchElements$getStretchElements$o$collect$slambda_0(this.$this$unsafeFlow0__1, null);
  ...
  function _get_repository__phhg8v_6($this) {
    return $this.repository_1;
  }
  ...
  protoOf(_no_name_provided__qut3iv_5).collect_ooju95_k$ = function (collector, $completion) {
  ...
  protoOf(GetStretchElements).getStretchElements_2ik9uu_k$ = function () {
    // Inline function 'kotlinx.coroutines.flow.map' call
    // Inline function 'kotlinx.coroutines.flow.unsafeTransform' call
    var this_0 = this.repository_1.getStretchElements_2ik9uu_k$();
    // Inline function 'kotlinx.coroutines.flow.internal.unsafeFlow' call
    return new _no_name_provided__qut3iv_5(this_0);
  };
  function _get_repository__phhg8v_7($this) {
    return $this.repository_1;
  }
  function UploadAvatar(repository) {
    this.repository_1 = repository;
  }
  protoOf(UploadAvatar).uploadAvatar_4hue9j_k$ = function (email, avatar, $completion) {
    return this.repository_1.updateAvatar_ruqkcf_k$(email, avatar, $completion);
  };
