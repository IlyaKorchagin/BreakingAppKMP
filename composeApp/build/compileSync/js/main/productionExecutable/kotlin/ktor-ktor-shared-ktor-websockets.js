(function (factory) {
  if (typeof define === 'function' && define.amd)
    define(['exports', './kotlin-kotlin-stdlib.js', './kotlinx-coroutines-core.js', './ktor-ktor-io.js', './kotlinx-io-kotlinx-io-core.js'], factory);
  else if (typeof exports === 'object')
    factory(module.exports, require('./kotlin-kotlin-stdlib.js'), require('./kotlinx-coroutines-core.js'), require('./ktor-ktor-io.js'), require('./kotlinx-io-kotlinx-io-core.js'));
  else {
    ...
    globalThis['ktor-ktor-shared-ktor-websockets'] = factory(typeof globalThis['ktor-ktor-shared-ktor-websockets'] === 'undefined' ? {} : globalThis['ktor-ktor-shared-ktor-websockets'], globalThis['kotlin-kotlin-stdlib'], globalThis['kotlinx-coroutines-core'], globalThis['ktor-ktor-io'], globalThis['kotlinx-io-kotlinx-io-core']);
  }
  ...
  function Companion() {
    ...
    while (tmp0_iterator.h()) {
      ...
      var tmp$ret$0 = element.ifw_1;
      destination.f2(tmp$ret$0, element);
    }
    tmp.jfw_1 = destination;
    this.kfw_1 = Codes_INTERNAL_ERROR_getInstance();
  }
  protoOf(Companion).lfw = function (code) {
    return this.jfw_1.n2(code);
  };
  ...
  protoOf(CloseReason).ofw = function () {
    return Companion_getInstance().lfw(this.mfw_1);
  };
  protoOf(CloseReason).toString = function () {
    var tmp0_elvis_lhs = this.ofw();
    return 'CloseReason(reason=' + toString(tmp0_elvis_lhs == null ? this.mfw_1 : tmp0_elvis_lhs) + ', message=' + this.nfw_1 + ')';
  };
  protoOf(CloseReason).hashCode = function () {
    var result = this.mfw_1;
    result = imul(result, 31) + getStringHashCode(this.nfw_1) | 0;
    return result;
  };
  protoOf(CloseReason).equals = function (other) {
    ...
    if (!(this.mfw_1 === tmp0_other_with_cast.mfw_1))
      return false;
    if (!(this.nfw_1 === tmp0_other_with_cast.nfw_1))
      return false;
    return true;
  };
  ...
  function Companion_0() {
    ...
    tmp.tfw_1 = ensureNotNull(tmp$ret$0).sfw_1;
    var tmp_0 = this;
    var tmp_1 = 0;
    var tmp_2 = this.tfw_1 + 1 | 0;
  ...
  function Close_init_$Init$(reason, $this) {
    ...
    builder.gf5(reason.mfw_1);
    writeText(builder, reason.nfw_1);
  ...
  function Close_init_$Init$_1($this) {
    Close.call($this, Companion_getInstance_1().vfw_1);
    return $this;
  }
  ...
  function Frame(fin, frameType, data, disposableHandle, rsv1, rsv2, rsv3) {
    ...
    rsv3 = rsv3 === VOID ? false : rsv3;
    this.wfw_1 = fin;
    this.xfw_1 = frameType;
    this.yfw_1 = data;
    this.zfw_1 = disposableHandle;
    this.afx_1 = rsv1;
    this.bfx_1 = rsv2;
    this.cfx_1 = rsv3;
  }
  protoOf(Frame).toString = function () {
    return 'Frame ' + this.xfw_1.toString() + ' (fin=' + this.wfw_1 + ', buffer len = ' + this.yfw_1.length + ')';
  };
  //region block: init
