(function (factory) {
  ...
  function DefaultLifecycleObserverAdapter(defaultLifecycleObserver, lifecycleEventObserver) {
    this.y44_1 = defaultLifecycleObserver;
    this.z44_1 = lifecycleEventObserver;
  }
  protoOf(DefaultLifecycleObserverAdapter).a45 = function (source, event) {
    switch (event.u2_1) {
      case 0:
        this.y44_1.s44(source);
        break;
      case 1:
        this.y44_1.t44(source);
        break;
      case 2:
        this.y44_1.u44(source);
        break;
      case 3:
        this.y44_1.v44(source);
        break;
      case 4:
        this.y44_1.w44(source);
        break;
      case 5:
        this.y44_1.x44(source);
        break;
      case 6:
        throw IllegalArgumentException_init_$Create$('ON_ANY must not been send by anybody');
    }
    var tmp1_safe_receiver = this.z44_1;
    if (tmp1_safe_receiver == null)
      null;
    else {
      tmp1_safe_receiver.a45(source, event);
    }
  };
  ...
  protoOf(Companion).b45 = function (state) {
    switch (state.u2_1) {
      case 2:
  ...
  protoOf(Companion).c45 = function (state) {
    switch (state.u2_1) {
      case 1:
  ...
  protoOf(State).i45 = function (state) {
    return this.v2(state) >= 0;
  };
  ...
  function Lifecycle() {
    this.j45_1 = new AtomicReference(null);
  }
  function LifecycleEventObserver() {
  }
  function AtomicReference(value) {
    this.n45_1 = atomic$ref$1(value);
  }
  function Lifecycling() {
  }
  protoOf(Lifecycling).o45 = function (object) {
