(function (factory) {
  ...
  var Exception_init_$Init$_0 = kotlin_kotlin.$_$.h2;
  ...
  var addAll_0 = kotlin_kotlin.$_$.e8;
  var listOf_0 = kotlin_kotlin.$_$.yb;
  ...
  var _Duration___get_inWholeNanoseconds__impl__r5x4mr = kotlin_kotlin.$_$.q3;
  var Exception_init_$Create$ = kotlin_kotlin.$_$.e2;
  ...
  initMetadataForClass(KoinExperimentalAPI, 'KoinExperimentalAPI', VOID, VOID, [Annotation]);
  function getKoin() {
  ...
  initMetadataForClass(OptionDslMarker, 'OptionDslMarker', VOID, VOID, [Annotation]);
  ...
  protoOf(Koin).createEagerInstances_b5l376_k$ = function () {
    ...
    var duration = (new Pair(value, tmp$ret$0)).get_second_jf7fjx_k$();
  ...
  protoOf(KoinExperimentalAPI).equals = function (other) {
    if (!(other instanceof KoinExperimentalAPI))
      return false;
    other instanceof KoinExperimentalAPI || THROW_CCE();
    return true;
  };
  protoOf(KoinExperimentalAPI).hashCode = function () {
    return 0;
  };
  protoOf(KoinExperimentalAPI).toString = function () {
    return '@org.koin.core.annotation.KoinExperimentalAPI(' + ')';
  };
  ...
  protoOf(BeanDefinition).toString = function () {
    ...
    if (this.qualifier_1 == null) {
      ...
      tmp = ',qualifier:' + toString(this.qualifier_1);
    }
    ...
    var defScope = equals(it, Companion_getInstance_2().get_rootScopeQualifier_ohxkho_k$()) ? '' : ',scope:' + toString_0(this.scopeQualifier_1);
    var tmp_0;
  ...
  protoOf(BeanDefinition).is_cbzrid_k$ = function (clazz, qualifier, scopeDefinition) {
    return this.hasType_kftgse_k$(clazz) && equals(this.qualifier_1, qualifier) && equals(this.scopeQualifier_1, scopeDefinition);
  };
  ...
  protoOf(ScopedInstanceFactory).isCreated_2qx692_k$ = function (context) {
    ...
    return !((isInterface(this_0, KtMap) ? this_0 : THROW_CCE()).get_wei43m_k$(key) == null);
  };
  ...
  protoOf(Module).set_eagerInstances_7g4hhl_k$ = function (_set____db54di) {
  ...
  function flatten(modules) {
    ...
    $l$loop_0: while (true) {
      ...
      var tmp0_iterator = current.includedModules_1.iterator_jk1svi_k$();
      while (tmp0_iterator.hasNext_bitz1p_k$()) {
        var module_0 = tmp0_iterator.next_20eer_k$();
  ...
  function onOptions(_this__u8e3s4, options) {
    ...
    if (!(options == null)) {
      ...
      var tmp;
      if (def.get__createdAtStart_5di9ug_k$()) {
  ...
  protoOf(InstanceRegistry).resolveInstance_rt8t5m_k$ = function (qualifier, clazz, scopeQualifier, instanceContext) {
  ...
  protoOf(InstanceRegistry).getAll_5touh5_k$ = function (clazz, instanceContext) {
    ...
    while (tmp0_iterator_0.hasNext_bitz1p_k$()) {
      var element_0 = tmp0_iterator_0.next_20eer_k$();
      // Inline function 'org.koin.core.registry.InstanceRegistry.getAll.<anonymous>' call
      if (element_0.get_beanDefinition_b177zg_k$().get_primaryType_gbcb1_k$().equals(clazz) || element_0.get_beanDefinition_b177zg_k$().get_secondaryTypes_du752m_k$().contains_aljjnj_k$(clazz)) {
  ...
  function closeAllScopes($this) {
    // Inline function 'kotlin.collections.forEach' call
    var tmp0_iterator = toList_0($this._scopes_1.get_values_ksazhn_k$()).iterator_jk1svi_k$();
    while (tmp0_iterator.hasNext_bitz1p_k$()) {
      var element = tmp0_iterator.next_20eer_k$();
  ...
  function resolveValue($this, qualifier, clazz, instanceContext, parameterDef) {
    var tmp0_elvis_lhs = $this._koin_1.get_instanceRegistry_jmeu6d_k$().resolveInstance_rt8t5m_k$(qualifier, clazz, $this.scopeQualifier_1, instanceContext);
    var tmp;
    if (tmp0_elvis_lhs == null) {
      // Inline function 'kotlin.run' call
      // Inline function 'kotlin.contracts.contract' call
      // Inline function 'org.koin.core.scope.Scope.resolveValue.<anonymous>' call
      $this._koin_1.get_logger_g9gejd_k$().debug_fck32h_k$("|- ? t:'" + getFullName(clazz) + "' - q:'" + toString(qualifier) + "' look in injected parameters");
    ...
    if (tmp1_elvis_lhs == null) {
      ...
      var tmp_1;
      if (!$this.isRoot_1) {
        $this._koin_1.get_logger_g9gejd_k$().debug_fck32h_k$("|- ? t:'" + getFullName(clazz) + "' - q:'" + toString(qualifier) + "' look at scope source");
        ...
        if (tmp0_safe_receiver_0 == null) {
          ...
          var tmp_3;
          if (clazz.isInstance_6tn68w_k$(tmp0_safe_receiver_0) && qualifier == null) {
    ...
    if (tmp2_elvis_lhs == null) {
      ...
      // Inline function 'kotlin.contracts.contract' call
      // Inline function 'org.koin.core.scope.Scope.resolveValue.<anonymous>' call
      $this._koin_1.get_logger_g9gejd_k$().debug_fck32h_k$("|- ? t:'" + getFullName(clazz) + "' - q:'" + toString(qualifier) + "' look in other scopes");
  ...
  protoOf(Scope).getAll_ad5k2r_k$ = function (clazz) {
    ...
    var tmp = this._koin_1.get_instanceRegistry_jmeu6d_k$().getAll_5touh5_k$(clazz, context);
  ...
  function measureDuration(code) {
    ...
    var other = Companion_getInstance_3().get_NANO_TO_MILLI_vas3xn_k$();
    var tmp$ret$0 = this_0.toDouble_ygsx0s_k$() / other;
    return (new Pair(value, tmp$ret$0)).get_second_jf7fjx_k$();
  }
  ...
  function bind(_this__u8e3s4, clazz) {
    _this__u8e3s4.get_factory_gsiw2n_k$().get_beanDefinition_b177zg_k$().set_secondaryTypes_oxpj23_k$(plus_0(_this__u8e3s4.get_factory_gsiw2n_k$().get_beanDefinition_b177zg_k$().get_secondaryTypes_du752m_k$(), clazz));
    var mapping = indexKey(clazz, _this__u8e3s4.get_factory_gsiw2n_k$().get_beanDefinition_b177zg_k$().get_qualifier_c4gvsv_k$(), _this__u8e3s4.get_factory_gsiw2n_k$().get_beanDefinition_b177zg_k$().get_scopeQualifier_eby6kf_k$());
    _this__u8e3s4.get_module_gqgeid_k$().saveMapping_wguhpg_k$(mapping, _this__u8e3s4.get_factory_gsiw2n_k$());
    return _this__u8e3s4;
  }
  ...
  protoOf(KoinPlatformTimeTools).getTimeInNanoSeconds_rsnqv1_k$ = function () {
    return _Duration___get_inWholeNanoseconds__impl__r5x4mr(ValueTimeMark__elapsedNow_impl_eonqvs(Monotonic_getInstance().markNow_ns2ype_k$()));
  };
  ...
  _.$_$.d = KoinPlatformTools_getInstance;
  _.$_$.e = startKoin;
