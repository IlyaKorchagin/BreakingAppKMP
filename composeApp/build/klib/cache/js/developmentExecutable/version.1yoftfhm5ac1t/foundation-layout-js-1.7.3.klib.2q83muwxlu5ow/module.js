(function (factory) {
  ...
  var Companion_getInstance = kotlin_org_jetbrains_compose_ui_ui.$_$.va;
  var roundToInt = kotlin_kotlin.$_$.ii;
  var get_lastIndex = kotlin_kotlin.$_$.eb;
  ...
  var Companion_getInstance_0 = kotlin_org_jetbrains_compose_ui_ui_unit.$_$.k4;
  var _Constraints___get_maxWidth__impl__uuyqc = kotlin_org_jetbrains_compose_ui_ui_unit.$_$.m2;
  var IntSize_0 = kotlin_org_jetbrains_compose_ui_ui_unit.$_$.z;
  var isSatisfiedBy = kotlin_org_jetbrains_compose_ui_ui_unit.$_$.m1;
  var _Constraints___get_maxHeight__impl__dt3e8z = kotlin_org_jetbrains_compose_ui_ui_unit.$_$.l2;
  var _Constraints___get_minWidth__impl__hi9lfi = kotlin_org_jetbrains_compose_ui_ui_unit.$_$.o2;
  var _Constraints___get_minHeight__impl__ev4bgx = kotlin_org_jetbrains_compose_ui_ui_unit.$_$.n2;
  var Node = kotlin_org_jetbrains_compose_ui_ui.$_$.b9;
  var Companion_getInstance_1 = kotlin_org_jetbrains_compose_ui_ui_unit.$_$.e4;
  ...
  var Companion_getInstance_2 = kotlin_org_jetbrains_compose_ui_ui.$_$.wa;
  ...
  var Constraints__copy$default_impl_f452rp = kotlin_org_jetbrains_compose_ui_ui_unit.$_$.b4;
  var fillArrayVal = kotlin_kotlin.$_$.ig;
  var Constraints = kotlin_org_jetbrains_compose_ui_ui_unit.$_$.a;
  var minIntrinsicWidth = kotlin_org_jetbrains_compose_ui_ui.$_$.m3;
  var minIntrinsicHeight = kotlin_org_jetbrains_compose_ui_ui.$_$.l3;
  var maxIntrinsicWidth = kotlin_org_jetbrains_compose_ui_ui.$_$.k3;
  var maxIntrinsicHeight = kotlin_org_jetbrains_compose_ui_ui.$_$.j3;
  var MeasurePolicy = kotlin_org_jetbrains_compose_ui_ui.$_$.n3;
  var ParentDataModifierNode = kotlin_org_jetbrains_compose_ui_ui.$_$.i5;
  ...
  var Companion_getInstance_4 = kotlin_org_jetbrains_compose_runtime_runtime.$_$.n2;
  var coerceAtMost = kotlin_kotlin.$_$.ti;
  var Annotation = kotlin_kotlin.$_$.bn;
  var minIntrinsicWidth_0 = kotlin_org_jetbrains_compose_ui_ui.$_$.e5;
  var minIntrinsicHeight_0 = kotlin_org_jetbrains_compose_ui_ui.$_$.d5;
  var maxIntrinsicWidth_0 = kotlin_org_jetbrains_compose_ui_ui.$_$.c5;
  var maxIntrinsicHeight_0 = kotlin_org_jetbrains_compose_ui_ui.$_$.b5;
  var _Dp___get_value__impl__geb1vb = kotlin_org_jetbrains_compose_ui_ui_unit.$_$.u2;
  var Companion_getInstance_5 = kotlin_org_jetbrains_compose_ui_ui_unit.$_$.f4;
  ...
  var Dp__compareTo_impl_tlg3dl = kotlin_org_jetbrains_compose_ui_ui_unit.$_$.r2;
  var FloatCompanionObject_getInstance = kotlin_kotlin.$_$.y5;
  var get_FirstBaseline = kotlin_org_jetbrains_compose_ui_ui.$_$.y2;
  ...
  var IllegalArgumentException_init_$Create$_0 = kotlin_kotlin.$_$.o2;
  var IllegalArgumentException = kotlin_kotlin.$_$.mn;
  var IllegalStateException_init_$Create$ = kotlin_kotlin.$_$.s2;
  var get_sign = kotlin_kotlin.$_$.li;
  var coerceIn = kotlin_kotlin.$_$.xi;
  ...
  var _Constraints___get_hasBoundedWidth__impl__7hd0wr = kotlin_org_jetbrains_compose_ui_ui_unit.$_$.g2;
  var _Constraints___get_hasBoundedHeight__impl__bsh4rw = kotlin_org_jetbrains_compose_ui_ui_unit.$_$.f2;
  var THROW_IAE = kotlin_kotlin.$_$.yn;
  var enumEntries = kotlin_kotlin.$_$.qf;
  var Enum = kotlin_kotlin.$_$.jn;
  var coerceAtMost_0 = kotlin_kotlin.$_$.ui;
  var constrain = kotlin_org_jetbrains_compose_ui_ui_unit.$_$.k1;
  var _Constraints___get_hasFixedWidth__impl__4p17wc = kotlin_org_jetbrains_compose_ui_ui_unit.$_$.i2;
  var _Constraints___get_hasFixedHeight__impl__y56fxx = kotlin_org_jetbrains_compose_ui_ui_unit.$_$.h2;
  ...
  var minIntrinsicWidth_1 = kotlin_org_jetbrains_compose_ui_ui.$_$.f3;
  var minIntrinsicHeight_1 = kotlin_org_jetbrains_compose_ui_ui.$_$.e3;
  var maxIntrinsicWidth_1 = kotlin_org_jetbrains_compose_ui_ui.$_$.d3;
  var maxIntrinsicHeight_1 = kotlin_org_jetbrains_compose_ui_ui.$_$.c3;
  ...
  var ModifierLocalConsumer = kotlin_org_jetbrains_compose_ui_ui.$_$.l4;
  var ModifierLocalProvider = kotlin_org_jetbrains_compose_ui_ui.$_$.q4;
  ...
  function findSize(_this__u8e3s4, $this) {
    if (!$this.matchHeightConstraintsFirst_1) {
      ...
      if (!equals(it, Companion_getInstance_0().get_Zero_9we0a6_k$()))
        return it;
      ...
      if (!equals(it_0, Companion_getInstance_0().get_Zero_9we0a6_k$()))
        return it_0;
      ...
      if (!equals(it_1, Companion_getInstance_0().get_Zero_9we0a6_k$()))
        return it_1;
      ...
      if (!equals(it_2, Companion_getInstance_0().get_Zero_9we0a6_k$()))
        return it_2;
      ...
      if (!equals(it_3, Companion_getInstance_0().get_Zero_9we0a6_k$()))
        return it_3;
      ...
      if (!equals(it_4, Companion_getInstance_0().get_Zero_9we0a6_k$()))
        return it_4;
      ...
      if (!equals(it_5, Companion_getInstance_0().get_Zero_9we0a6_k$()))
        return it_5;
      ...
      if (!equals(it_6, Companion_getInstance_0().get_Zero_9we0a6_k$()))
        return it_6;
      ...
      if (!equals(it_7, Companion_getInstance_0().get_Zero_9we0a6_k$()))
        return it_7;
      ...
      if (!equals(it_8, Companion_getInstance_0().get_Zero_9we0a6_k$()))
        return it_8;
      ...
      if (!equals(it_9, Companion_getInstance_0().get_Zero_9we0a6_k$()))
        return it_9;
      ...
      if (!equals(it_10, Companion_getInstance_0().get_Zero_9we0a6_k$()))
        return it_10;
      ...
      if (!equals(it_11, Companion_getInstance_0().get_Zero_9we0a6_k$()))
        return it_11;
      ...
      if (!equals(it_12, Companion_getInstance_0().get_Zero_9we0a6_k$()))
        return it_12;
      ...
      if (!equals(it_13, Companion_getInstance_0().get_Zero_9we0a6_k$()))
        return it_13;
      ...
      if (!equals(it_14, Companion_getInstance_0().get_Zero_9we0a6_k$()))
        return it_14;
      this_15.packedValue_1;
    }
    return Companion_getInstance_0().get_Zero_9we0a6_k$();
  }
  ...
  protoOf(AspectRatioNode).measure_z885gt_k$ = function (_this__u8e3s4, measurable, constraints) {
    ...
    var tmp;
    if (!equals(size, Companion_getInstance_0().get_Zero_9we0a6_k$())) {
      tmp = Companion_getInstance_1().fixed_rd8fwx_k$(_IntSize___get_width__impl__d9yl4o(size), _IntSize___get_height__impl__prv63b(size));
    } else {
      tmp = constraints;
    }
  ...
  protoOf(BoxMeasurePolicy).measure_xg9b01_k$ = function (_this__u8e3s4, measurables, constraints) {
    ...
    if (measurables.get_size_woubt6_k$() === 1) {
      ...
      if (!get_matchesParentSize(measurable)) {
        ...
        placeable = measurable.measure_4dmfk1_k$(Companion_getInstance_1().fixed_rd8fwx_k$(_Constraints___get_minWidth__impl__hi9lfi(constraints), _Constraints___get_minHeight__impl__ev4bgx(constraints)));
      }
  ...
  function columnMeasurePolicy(verticalArrangement, horizontalAlignment, $composer, $changed) {
    ...
    if (equals(verticalArrangement, Arrangement_getInstance().get_Top_18jj1w_k$()) && equals(horizontalAlignment, Companion_getInstance().get_Start_ih4i6x_k$())) {
      ...
      var tmp_0;
      if (invalid || it === Companion_getInstance_4().get_Empty_i9b85g_k$()) {
  ...
  function createColumnConstraints(isPrioritizing, mainAxisMin, crossAxisMin, mainAxisMax, crossAxisMax) {
    ...
    if (!isPrioritizing) {
      ...
      tmp = Companion_getInstance_1().fitPrioritizingHeight_cdcbfz_k$(crossAxisMin, crossAxisMax, mainAxisMin, mainAxisMax);
    }
    return tmp;
  }
  ...
  function PaddingElement(start, top, end, bottom, rtlAware, inspectorInfo) {
    ...
    // Inline function 'kotlin.require' call
    // Inline function 'kotlin.contracts.contract' call
    if (!((_Dp___get_value__impl__geb1vb(this.start_1) >= 0.0 || equals(this.start_1, Companion_getInstance_5().get_Unspecified_9b9rm3_k$())) && (_Dp___get_value__impl__geb1vb(this.top_1) >= 0.0 || equals(this.top_1, Companion_getInstance_5().get_Unspecified_9b9rm3_k$())) && (_Dp___get_value__impl__geb1vb(this.end_1) >= 0.0 || equals(this.end_1, Companion_getInstance_5().get_Unspecified_9b9rm3_k$())) && (_Dp___get_value__impl__geb1vb(this.bottom_1) >= 0.0 || equals(this.bottom_1, Companion_getInstance_5().get_Unspecified_9b9rm3_k$())))) {
  ...
  function createRowConstraints(isPrioritizing, mainAxisMin, crossAxisMin, mainAxisMax, crossAxisMax) {
    ...
    if (!isPrioritizing) {
      ...
      tmp = Companion_getInstance_1().fitPrioritizingWidth_o0ab04_k$(mainAxisMin, mainAxisMax, crossAxisMin, crossAxisMax);
    }
    return tmp;
  }
  ...
  function WrapContentElement$Companion$size$lambda($align) {
    return function (size, layoutDirection) {
      return new IntOffset_0($align.align_mb8mzc_k$(Companion_getInstance_0().get_Zero_9we0a6_k$(), size.packedValue_1, layoutDirection));
    };
  }
  ...
  function _get_targetConstraints__wn7g24(_this__u8e3s4, $this) {
    var tmp;
    if (!equals($this.maxWidth_1, Companion_getInstance_5().get_Unspecified_9b9rm3_k$())) {
    ...
    var maxWidth = tmp;
    var tmp_0;
    if (!equals($this.maxHeight_1, Companion_getInstance_5().get_Unspecified_9b9rm3_k$())) {
    ...
    var maxHeight = tmp_0;
    var tmp_1;
    if (!equals($this.minWidth_1, Companion_getInstance_5().get_Unspecified_9b9rm3_k$())) {
      // Inline function 'kotlin.let' call
      // Inline function 'kotlin.contracts.contract' call
    ...
    var minWidth = tmp_1;
    var tmp_2;
    if (!equals($this.minHeight_1, Companion_getInstance_5().get_Unspecified_9b9rm3_k$())) {
      // Inline function 'kotlin.let' call
      // Inline function 'kotlin.contracts.contract' call
      // Inline function 'androidx.compose.foundation.layout.SizeNode.<get-targetConstraints>.<anonymous>' call
  ...
  protoOf(UnspecifiedConstraintsNode).measure_z885gt_k$ = function (_this__u8e3s4, measurable, constraints) {
    var tmp;
    if (!equals(this.minWidth_1, Companion_getInstance_5().get_Unspecified_9b9rm3_k$()) && _Constraints___get_minWidth__impl__hi9lfi(constraints) === 0) {
    ...
    var tmp_1 = _Constraints___get_maxWidth__impl__uuyqc(constraints);
    var tmp_2;
    if (!equals(this.minHeight_1, Companion_getInstance_5().get_Unspecified_9b9rm3_k$()) && _Constraints___get_minHeight__impl__ev4bgx(constraints) === 0) {
  ...
  protoOf(UnspecifiedConstraintsNode).minIntrinsicWidth_nsvhwg_k$ = function (_this__u8e3s4, measurable, height) {
    return coerceAtLeast(measurable.minIntrinsicWidth_jyhjuj_k$(height), !equals(this.minWidth_1, Companion_getInstance_5().get_Unspecified_9b9rm3_k$()) ? _this__u8e3s4.roundToPx_yb7vg8_k$(this.minWidth_1) : 0);
  };
  protoOf(UnspecifiedConstraintsNode).maxIntrinsicWidth_epsb1u_k$ = function (_this__u8e3s4, measurable, height) {
    return coerceAtLeast(measurable.maxIntrinsicWidth_b8umbx_k$(height), !equals(this.minWidth_1, Companion_getInstance_5().get_Unspecified_9b9rm3_k$()) ? _this__u8e3s4.roundToPx_yb7vg8_k$(this.minWidth_1) : 0);
  };
  protoOf(UnspecifiedConstraintsNode).minIntrinsicHeight_xt6ly1_k$ = function (_this__u8e3s4, measurable, width) {
    return coerceAtLeast(measurable.minIntrinsicHeight_p2a4ou_k$(width), !equals(this.minHeight_1, Companion_getInstance_5().get_Unspecified_9b9rm3_k$()) ? _this__u8e3s4.roundToPx_yb7vg8_k$(this.minHeight_1) : 0);
  };
  protoOf(UnspecifiedConstraintsNode).maxIntrinsicHeight_nrifyt_k$ = function (_this__u8e3s4, measurable, width) {
    return coerceAtLeast(measurable.maxIntrinsicHeight_b0krtc_k$(width), !equals(this.minHeight_1, Companion_getInstance_5().get_Unspecified_9b9rm3_k$()) ? _this__u8e3s4.roundToPx_yb7vg8_k$(this.minHeight_1) : 0);
  };
  ...
  function wrapContentWidth(_this__u8e3s4, align, unbounded) {
    align = align === VOID ? Companion_getInstance().get_CenterHorizontally_97ab0v_k$() : align;
    unbounded = unbounded === VOID ? false : unbounded;
    _init_properties_Size_kt__jcru8v();
    var tmp;
    if (equals(align, Companion_getInstance().get_CenterHorizontally_97ab0v_k$()) && !unbounded) {
      tmp = get_WrapContentWidthCenter();
    } else if (equals(align, Companion_getInstance().get_Start_ih4i6x_k$()) && !unbounded) {
  ...
  _.$_$.u = offset_0;
  _.$_$.v = onConsumedWindowInsetsChanged;
  _.$_$.w = only;
  _.$_$.x = padding_2;
  _.$_$.y = padding_1;
  _.$_$.z = padding_0;
  _.$_$.a1 = padding;
  _.$_$.b1 = rowMeasurePolicy;
  _.$_$.c1 = sizeIn;
  _.$_$.d1 = size_0;
  _.$_$.e1 = size;
  _.$_$.f1 = get_statusBars;
  _.$_$.g1 = get_systemBars;
  _.$_$.h1 = width;
  _.$_$.i1 = windowInsetsPadding;
  _.$_$.j1 = wrapContentHeight;
  _.$_$.k1 = wrapContentWidth;
  _.$_$.l1 = WindowInsetsSides__plus_impl_9q9m59;
  _.$_$.m1 = Arrangement_getInstance;
  _.$_$.n1 = BoxScopeInstance_getInstance;
  _.$_$.o1 = ColumnScopeInstance_getInstance;
  _.$_$.p1 = RowScopeInstance_getInstance;
  _.$_$.q1 = Companion_getInstance_9;
