(function (factory) {
  ...
  var isSurrogate = kotlin_kotlin.$_$.nl;
  var Char__plus_impl_qi7pgj = kotlin_kotlin.$_$.f4;
  var Char__minus_impl_a2frrh = kotlin_kotlin.$_$.e4;
  ...
  var Char__minus_impl_a2frrh_0 = kotlin_kotlin.$_$.d4;
  var numberToChar = kotlin_kotlin.$_$.ei;
  var canRead = kotlin_io_ktor_ktor_io.$_$.w;
  var Char__rangeTo_impl_tkncvp = kotlin_kotlin.$_$.g4;
  var plus = kotlin_kotlin.$_$.mc;
  var plus_0 = kotlin_kotlin.$_$.nc;
  ...
  var equals_0 = kotlin_kotlin.$_$.cl;
  ...
  var IllegalArgumentException_init_$Create$ = kotlin_kotlin.$_$.q2;
  var caseInsensitiveMap = kotlin_io_ktor_ktor_utils.$_$.y;
  var asSequence = kotlin_kotlin.$_$.q8;
  ...
  var first = kotlin_kotlin.$_$.el;
  var last_0 = kotlin_kotlin.$_$.ql;
  var get_lastIndex_0 = kotlin_kotlin.$_$.pl;
  ...
  var contains_1 = kotlin_io_ktor_ktor_utils.$_$.p;
  ...
  var toDoubleOrNull = kotlin_kotlin.$_$.sm;
  var LazyThreadSafetyMode_NONE_getInstance = kotlin_kotlin.$_$.o;
  var lazy_0 = kotlin_kotlin.$_$.qp;
  ...
  var IllegalArgumentException_init_$Init$ = kotlin_kotlin.$_$.n2;
  ...
  var lineSequence = kotlin_kotlin.$_$.rl;
  var mapNotNull = kotlin_kotlin.$_$.ik;
  var toList = kotlin_kotlin.$_$.nk;
  var removePrefix = kotlin_kotlin.$_$.ul;
  ...
  var GlobalScope_getInstance = kotlin_org_jetbrains_kotlinx_kotlinx_coroutines_core.$_$.e1;
  ...
  initMetadataForInterface(ContentTypeMatcher, 'ContentTypeMatcher');
  ...
  function encodeURLPath(_this__u8e3s4, encodeSlash, encodeEncoded) {
    ...
    $l$loop_0: while (index < _this__u8e3s4.length) {
      ...
      if (!encodeEncoded && current === _Char___init__impl__6a9atx(37) && (index + 2 | 0) < _this__u8e3s4.length && get_HEX_ALPHABET().contains_aljjnj_k$(new Char(charSequenceGet(_this__u8e3s4, index + 1 | 0))) && get_HEX_ALPHABET().contains_aljjnj_k$(new Char(charSequenceGet(_this__u8e3s4, index + 2 | 0)))) {
        this_0.append_am5a4z_k$(current);
  ...
  protoOf(Companion).parse_pc1q8p_k$ = function (value) {
    ...
    if (slash === -1) {
      ...
      if (toString(trim(isCharSequence(parts) ? parts : THROW_CCE())) === '*')
        return Companion_getInstance_1().Any_1;
  ...
  protoOf(ContentType).match_m4pled_k$ = function (pattern) {
    return this.match_syvve3_k$(Companion_getInstance_1().parse_pc1q8p_k$(pattern));
  };
  ...
  function toContentType(_this__u8e3s4) {
    ...
    var tmp;
    try {
      tmp = Companion_getInstance_1().parse_pc1q8p_k$(_this__u8e3s4);
    } catch ($p) {
      var tmp_0;
  ...
  function allStatusCodes() {
    return listOf([Companion_getInstance_6().Continue_1, Companion_getInstance_6().SwitchingProtocols_1, Companion_getInstance_6().Processing_1, Companion_getInstance_6().OK_1, Companion_getInstance_6().Created_1, Companion_getInstance_6().Accepted_1, Companion_getInstance_6().NonAuthoritativeInformation_1, Companion_getInstance_6().NoContent_1, Companion_getInstance_6().ResetContent_1, Companion_getInstance_6().PartialContent_1, Companion_getInstance_6().MultiStatus_1, Companion_getInstance_6().MultipleChoices_1, Companion_getInstance_6().MovedPermanently_1, Companion_getInstance_6().Found_1, Companion_getInstance_6().SeeOther_1, Companion_getInstance_6().NotModified_1, Companion_getInstance_6().UseProxy_1, Companion_getInstance_6().SwitchProxy_1, Companion_getInstance_6().TemporaryRedirect_1, Companion_getInstance_6().PermanentRedirect_1, Companion_getInstance_6().BadRequest_1, Companion_getInstance_6().Unauthorized_1, Companion_getInstance_6().PaymentRequired_1, Companion_getInstance_6().Forbidden_1, Companion_getInstance_6().NotFound_1, Companion_getInstance_6().MethodNotAllowed_1, Companion_getInstance_6().NotAcceptable_1, Companion_getInstance_6().ProxyAuthenticationRequired_1, Companion_getInstance_6().RequestTimeout_1, Companion_getInstance_6().Conflict_1, Companion_getInstance_6().Gone_1, Companion_getInstance_6().LengthRequired_1, Companion_getInstance_6().PreconditionFailed_1, Companion_getInstance_6().PayloadTooLarge_1, Companion_getInstance_6().RequestURITooLong_1, Companion_getInstance_6().UnsupportedMediaType_1, Companion_getInstance_6().RequestedRangeNotSatisfiable_1, Companion_getInstance_6().ExpectationFailed_1, Companion_getInstance_6().UnprocessableEntity_1, Companion_getInstance_6().Locked_1, Companion_getInstance_6().FailedDependency_1, Companion_getInstance_6().TooEarly_1, Companion_getInstance_6().UpgradeRequired_1, Companion_getInstance_6().TooManyRequests_1, Companion_getInstance_6().RequestHeaderFieldTooLarge_1, Companion_getInstance_6().InternalServerError_1, Companion_getInstance_6().NotImplemented_1, Companion_getInstance_6().BadGateway_1, Companion_getInstance_6().ServiceUnavailable_1, Companion_getInstance_6().GatewayTimeout_1, Companion_getInstance_6().VersionNotSupported_1, Companion_getInstance_6().VariantAlsoNegotiates_1, Companion_getInstance_6().InsufficientStorage_1]);
  }
  ...
  function parseQueryString(query, startIndex, limit, decode) {
    ...
    if (startIndex > get_lastIndex_0(query)) {
      tmp = Companion_getInstance_7().get_Empty_i9b85g_k$();
    } else {
  ...
  function applyOrigin($this) {
    ...
    if (tmp)
      return Unit_getInstance();
    $this.host_1 = Companion_getInstance_8().originUrl_1.get_host_wonf8x_k$();
    if ($this.protocolOrNull_1 == null)
      $this.protocolOrNull_1 = Companion_getInstance_8().originUrl_1.get_protocolOrNull_xgbdu3_k$();
    if ($this.port_1 === 0) {
      $this.set_port_gcpocq_k$(Companion_getInstance_8().originUrl_1.get_specifiedPort_ldmo88_k$());
    }
  }
  ...
  function URLBuilder(protocol, host, port, user, password, pathSegments, parameters, fragment, trailingQuery) {
    ...
    parameters = parameters === VOID ? Companion_getInstance_7().get_Empty_i9b85g_k$() : parameters;
  ...
  function takeFromUnsafe(_this__u8e3s4, urlString) {
    ...
    if (schemeLength > 0) {
      ...
      _this__u8e3s4.set_protocol_fzc1gx_k$(Companion_getInstance_9().createOrDefault_lkipzc_k$(scheme));
    ...
    if (_this__u8e3s4.get_protocol_mv93kx_k$().get_name_woqyms_k$() === 'about') {
      ...
      // Inline function 'kotlin.js.asDynamic' call
      var tmp$ret$9 = urlString.substring(startIndex_1, endIndex);
      _this__u8e3s4.set_host_sqck4b_k$(tmp$ret$9);
      return _this__u8e3s4;
    }
    if (slashCount >= 2) {
      loop: while (true) {
        ...
        if (delimiter < endIndex && charSequenceGet(urlString, delimiter) === _Char___init__impl__6a9atx(64)) {
          ...
          if (!(passwordIndex === -1)) {
            ...
            // Inline function 'kotlin.js.asDynamic' call
            var tmp$ret$13 = urlString.substring(startIndex_2, passwordIndex);
            _this__u8e3s4.set_encodedUser_shwszf_k$(tmp$ret$13);
            // Inline function 'kotlin.text.substring' call
            var startIndex_3 = passwordIndex + 1 | 0;
            // Inline function 'kotlin.js.asDynamic' call
            var tmp$ret$15 = urlString.substring(startIndex_3, delimiter);
            _this__u8e3s4.set_encodedPassword_m1etez_k$(tmp$ret$15);
          } else {
            // Inline function 'kotlin.text.substring' call
            var startIndex_4 = startIndex;
            // Inline function 'kotlin.js.asDynamic' call
            var tmp$ret$17 = urlString.substring(startIndex_4, delimiter);
            _this__u8e3s4.set_encodedUser_shwszf_k$(tmp$ret$17);
          }
  ...
  protoOf(Companion_7).createOrDefault_lkipzc_k$ = function (name) {
    ...
    var tmp0_elvis_lhs = Companion_getInstance_9().byName_1.get_wei43m_k$(it);
  ...
  function takeFrom_0(_this__u8e3s4, url) {
    _this__u8e3s4.set_protocolOrNull_x8vslq_k$(url.get_protocolOrNull_xgbdu3_k$());
  ...
  function Url_0(protocol, host, specifiedPort, pathSegments, parameters, fragment, user, password, trailingQuery, urlString) {
    ...
    var tmp_0 = this;
    var tmp0_elvis_lhs = this.protocolOrNull_1;
    tmp_0.protocol_1 = tmp0_elvis_lhs == null ? Companion_getInstance_9().get_HTTP_wo2evl_k$() : tmp0_elvis_lhs;
    var tmp_1 = this;
  ...
  protoOf(Url_0).get_segments_ecat1z_k$ = function () {
    // Inline function 'kotlin.getValue' call
    var this_0 = this.segments$delegate_1;
    segments$factory();
    return this_0.get_value_j01efc_k$();
  };
  ...
  function segments$factory() {
    return getPropertyCallableRef('segments', 1, KProperty1, function (receiver) {
      return receiver.get_segments_ecat1z_k$();
    }, null);
  }
    ...
    $sm: do
      try {
        ...
        switch (tmp) {
          ...
          case 1:
            var tmp_0 = this;
            tmp_0.limit1__1 = this.$range_1.get_last_wopotb_k$().minus_mfbszm_k$(this.$range_1.get_first_irdx8n_k$()).plus_r93sks_k$(toLong_0(1));
  ...
  protoOf(ProtocolUpgrade).get_status_jnf6d7_k$ = function () {
    return Companion_getInstance_6().get_SwitchingProtocols_cb8qoa_k$();
  };
  ...
  function VersionCheckResult_initEntries() {
    ...
    VersionCheckResult_OK_instance = new VersionCheckResult('OK', 0, Companion_getInstance_6().get_OK_kntokb_k$());
    VersionCheckResult_NOT_MODIFIED_instance = new VersionCheckResult('NOT_MODIFIED', 1, Companion_getInstance_6().get_NotModified_wswedp_k$());
    VersionCheckResult_PRECONDITION_FAILED_instance = new VersionCheckResult('PRECONDITION_FAILED', 2, Companion_getInstance_6().get_PreconditionFailed_jg8bhe_k$());
  }
  var $ENTRIES_0;
  ...
  _.$_$.z = append;
  _.$_$.a1 = get_authority;
  _.$_$.b1 = get_authority_0;
  _.$_$.c1 = charset_0;
  _.$_$.d1 = charset;
  _.$_$.e1 = contentLength;
  _.$_$.f1 = contentType;
  _.$_$.g1 = contentType_0;
  _.$_$.h1 = contentType_1;
  _.$_$.i1 = isSecure;
  _.$_$.j1 = isWebsocket;
