(function (factory) {
  ...
  var charArray = kotlin_kotlin.$_$.lg;
  var concatToString = kotlin_kotlin.$_$.sk;
  var concatToString_0 = kotlin_kotlin.$_$.tk;
  var NumberFormatException_init_$Create$ = kotlin_kotlin.$_$.d3;
  var AssertionError_init_$Create$ = kotlin_kotlin.$_$.w1;
  var isArray = kotlin_kotlin.$_$.kh;
  var copyOfRange = kotlin_kotlin.$_$.q9;
  var contentHashCode = kotlin_kotlin.$_$.i9;
  var replace = kotlin_kotlin.$_$.yl;
  var toString_1 = kotlin_kotlin.$_$.i4;
  var Char__minus_impl_a2frrh = kotlin_kotlin.$_$.d4;
  var charArrayOf = kotlin_kotlin.$_$.kg;
  var sequence = kotlin_kotlin.$_$.lk;
  var ArrayDeque_init_$Create$ = kotlin_kotlin.$_$.s;
  var CoroutineImpl = kotlin_kotlin.$_$.uf;
  var SequenceScope = kotlin_kotlin.$_$.yj;
  ...
  var removeLastOrNull = kotlin_kotlin.$_$.vc;
  var last = kotlin_kotlin.$_$.sb;
  var AssertionError_init_$Create$_0 = kotlin_kotlin.$_$.v1;
  var toString_2 = kotlin_kotlin.$_$.dn;
  var copyOfRange_0 = kotlin_kotlin.$_$.p9;
  var fill = kotlin_kotlin.$_$.ka;
  var fill_0 = kotlin_kotlin.$_$.ha;
  var fill_1 = kotlin_kotlin.$_$.ia;
  var longArrayOf = kotlin_kotlin.$_$.ai;
  var longArray = kotlin_kotlin.$_$.bi;
  var Comparable = kotlin_kotlin.$_$.xn;
  var IndexOutOfBoundsException = kotlin_kotlin.$_$.eo;
  var IndexOutOfBoundsException_init_$Init$ = kotlin_kotlin.$_$.x2;
  ...
  initMetadataForInterface(Sink, 'Sink', VOID, VOID, [Closeable]);
  initMetadataForClass(FileHandleSink, 'FileHandleSink', VOID, VOID, [Sink]);
  initMetadataForInterface(Source, 'Source', VOID, VOID, [Closeable]);
  initMetadataForClass(FileHandleSource, 'FileHandleSource', VOID, VOID, [Source]);
  initMetadataForClass(FileHandle, 'FileHandle', VOID, VOID, [Closeable]);
  initMetadataForClass(FileMetadata, 'FileMetadata', FileMetadata);
  initMetadataForClass(FileSystem, 'FileSystem');
  initMetadataForClass(ForwardingFileSystem, 'ForwardingFileSystem', VOID, FileSystem);
  initMetadataForClass(BlackholeSink, 'BlackholeSink', BlackholeSink, VOID, [Sink]);
  initMetadataForCompanion(Companion);
  initMetadataForClass(Options, 'Options', VOID, AbstractList, [AbstractList, RandomAccess]);
  initMetadataForClass(PeekSource, 'PeekSource', VOID, VOID, [Source]);
  initMetadataForCompanion(Companion_0);
  initMetadataForClass(Segment, 'Segment', Segment_init_$Create$);
  initMetadataForCompanion(Companion_1);
  initMetadataForClass(TypedOptions, 'TypedOptions', VOID, AbstractList, [AbstractList, RandomAccess]);
  initMetadataForLambda(commonListRecursively$slambda, CoroutineImpl, [CoroutineImpl], [1]);
  initMetadataForLambda(commonDeleteRecursively$slambda, CoroutineImpl, [CoroutineImpl], [1]);
  initMetadataForCoroutine($collectRecursivelyCOROUTINE$0, CoroutineImpl);
  ...
  initMetadataForClass(Hmac, 'Hmac', VOID, VOID, [HashFunction]);
  initMetadataForCompanion(Companion_3);
  initMetadataForClass(Md5, 'Md5', Md5, VOID, [HashFunction]);
  initMetadataForClass(Sha1, 'Sha1', Sha1, VOID, [HashFunction]);
  initMetadataForCompanion(Companion_4);
  initMetadataForClass(Sha256, 'Sha256', Sha256, VOID, [HashFunction]);
  initMetadataForCompanion(Companion_5);
  initMetadataForClass(Sha512, 'Sha512', Sha512, VOID, [HashFunction]);
  ...
  initMetadataForClass(UnsafeCursor, 'UnsafeCursor', UnsafeCursor, VOID, [Closeable]);
  initMetadataForInterface(BufferedSource, 'BufferedSource', VOID, VOID, [Source]);
  initMetadataForInterface(BufferedSink, 'BufferedSink', VOID, VOID, [Sink]);
  initMetadataForClass(Buffer, 'Buffer', Buffer, VOID, [BufferedSource, BufferedSink]);
  ...
  initMetadataForClass(RealBufferedSink, 'RealBufferedSink', VOID, VOID, [BufferedSink]);
  initMetadataForClass(RealBufferedSource, 'RealBufferedSource', VOID, VOID, [BufferedSource]);
  initMetadataForObject(SegmentPool, 'SegmentPool');
  initMetadataForCompanion(Companion_10);
  initMetadataForClass(Timeout, 'Timeout', Timeout);
  //endregion
  function get_BASE64() {
  ...
  function decodeBase64ToArray(_this__u8e3s4) {
    ...
    $l$loop: while (limit > 0) {
      ...
      if (!(c === _Char___init__impl__6a9atx(61)) && !(c === _Char___init__impl__6a9atx(10)) && !(c === _Char___init__impl__6a9atx(13)) && !(c === _Char___init__impl__6a9atx(32)) && !(c === _Char___init__impl__6a9atx(9))) {
        break $l$loop;
      }
      limit = limit - 1 | 0;
    }
    ...
    if (inductionVariable < last)
      $l$loop_0: do {
        ...
        } else if (c_0 === _Char___init__impl__6a9atx(43) || c_0 === _Char___init__impl__6a9atx(45)) {
          bits = 62;
        } else if (c_0 === _Char___init__impl__6a9atx(47) || c_0 === _Char___init__impl__6a9atx(95)) {
          bits = 63;
        } else if (c_0 === _Char___init__impl__6a9atx(10) || c_0 === _Char___init__impl__6a9atx(13) || c_0 === _Char___init__impl__6a9atx(32) || c_0 === _Char___init__impl__6a9atx(9)) {
          continue $l$loop_0;
        } else {
          return null;
        }
  ...
  function _init_properties_Base64_kt__ymmsz3() {
    if (!properties_initialized_Base64_kt_5g824v) {
      ...
      BASE64 = Companion_getInstance_7().encodeUtf8_5n709n_k$('ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/').get_data_hjgcg5_k$();
      BASE64_URL_SAFE = Companion_getInstance_7().encodeUtf8_5n709n_k$('ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_').get_data_hjgcg5_k$();
    }
  }
  ...
  function readNoCloseCheck($this, fileOffset, sink, byteCount) {
    ...
    $l$loop: while (currentOffset.compareTo_9jj042_k$(targetOffset) < 0) {
      var tail = sink.writableSegment_voedtv_k$(1);
      ...
      var b = 8192 - tail.get_limit_iuokuq_k$() | 0;
      ...
      if (readByteCount === -1) {
        if (tail.get_pos_18iyad_k$() === tail.get_limit_iuokuq_k$()) {
          sink.set_head_csbq7o_k$(tail.pop_2dsh_k$());
      ...
      sink.set_size_nux7qg_k$(tmp$ret$4);
    }
  ...
  function writeNoCloseCheck($this, fileOffset, source, byteCount) {
    ...
    while (currentOffset.compareTo_9jj042_k$(targetOffset) < 0) {
      var head = ensureNotNull(source.get_head_pg0gr3_k$());
      // Inline function 'okio.minOf' call
      var a = targetOffset.minus_mfbszm_k$(currentOffset);
      ...
      source.set_size_nux7qg_k$(tmp$ret$3);
      if (head.get_pos_18iyad_k$() === head.get_limit_iuokuq_k$()) {
        source.set_head_csbq7o_k$(head.pop_2dsh_k$());
  ...
  protoOf(FileHandleSink).close_yn9xrc_k$ = function () {
    ...
    if (!(this.fileHandle_1.openStreamCount_1 === 0) || !this.fileHandle_1.closed_1)
      return Unit_getInstance();
  ...
  protoOf(ForwardingFileSystem).toString = function () {
    return '' + getKClassFromExpression(this).get_simpleName_r6f8py_k$() + '(' + toString(this.delegate_1) + ')';
  };
    ...
    if (!(from.get_c1px32_k$(byteStringOffset) === to.get_c1px32_k$(byteStringOffset))) {
      ...
      if (inductionVariable_1 < toIndex)
        do {
          ...
          if (i_1 === fromIndex_0 || !(rangeByte === byteStrings.get_c1px32_k$(i_1 - 1 | 0).get_c1px32_k$(byteStringOffset))) {
      ...
      while (rangeStart < toIndex) {
        ...
        if ((rangeStart + 1 | 0) === rangeEnd && (byteStringOffset + 1 | 0) === byteStrings.get_c1px32_k$(rangeStart).get_size_woubt6_k$()) {
    ...
    while (a < list.get_size_woubt6_k$()) {
      ...
      $l$loop: while (b < list.get_size_woubt6_k$()) {
        ...
        if (!!(byteString.get_size_woubt6_k$() === prefix.get_size_woubt6_k$())) {
          // Inline function 'okio.Companion.of.<anonymous>' call
          var message_0 = 'duplicate option: ' + byteString.toString();
          throw IllegalArgumentException_init_$Create$(toString(message_0));
        }
  ...
  protoOf(Options).get_byteStrings_s02knb_k$ = function () {
    return this.byteStrings_1;
  };
  protoOf(Options).get_trie_j62wdn_k$ = function () {
    return this.trie_1;
  };
  ...
  function PeekSource(upstream) {
    ...
    this.expectedSegment_1 = this.buffer_1.get_head_pg0gr3_k$();
    var tmp = this;
    var tmp0_safe_receiver = this.buffer_1.get_head_pg0gr3_k$();
  ...
  protoOf(PeekSource).read_a1wdbo_k$ = function (sink, byteCount) {
    ...
    // Inline function 'kotlin.check' call
    // Inline function 'kotlin.contracts.contract' call
    if (!(this.expectedSegment_1 == null || (this.expectedSegment_1 === this.buffer_1.get_head_pg0gr3_k$() && this.expectedPos_1 === ensureNotNull(this.buffer_1.get_head_pg0gr3_k$()).get_pos_18iyad_k$()))) {
      // Inline function 'okio.PeekSource.read.<anonymous>' call
    ...
    if (!this.upstream_1.request_mpoy7z_k$(tmp$ret$3))
      return new Long(-1, -1);
    if (this.expectedSegment_1 == null && !(this.buffer_1.get_head_pg0gr3_k$() == null)) {
      this.expectedSegment_1 = this.buffer_1.get_head_pg0gr3_k$();
      this.expectedPos_1 = ensureNotNull(this.buffer_1.get_head_pg0gr3_k$()).get_pos_18iyad_k$();
    }
    // Inline function 'kotlin.comparisons.minOf' call
  ...
  protoOf(TypedOptions).get_options_qkdnzx_k$ = function () {
    return this.options_1;
  };
  protoOf(TypedOptions).get_list_jh03kh_k$ = function () {
    return this.list_1;
  };
  ...
  function isIsoControl(codePoint) {
    return (0 <= codePoint ? codePoint <= 31 : false) || (127 <= codePoint ? codePoint <= 159 : false);
  }
  ...
  function processUtf8Bytes(_this__u8e3s4, beginIndex, endIndex, yield_0) {
    ...
    while (index < endIndex) {
      ...
      if (Char__compareTo_impl_ypi4mb(c, _Char___init__impl__6a9atx(128)) < 0) {
        ...
        index = index + 1 | 0;
        while (index < endIndex && Char__compareTo_impl_ypi4mb(charSequenceGet(_this__u8e3s4, index), _Char___init__impl__6a9atx(128)) < 0) {
          // Inline function 'kotlin.code' call
          var tmp1 = index;
          index = tmp1 + 1 | 0;
        ...
        var tmp;
        if (Char__compareTo_impl_ypi4mb(c, _Char___init__impl__6a9atx(56319)) > 0 || endIndex <= (index + 1 | 0)) {
          tmp = true;
        } else {
  ...
  function checkOffsetAndCount(size, offset, byteCount) {
    _init_properties_Util_kt__laey5a();
    if (offset.or_v7fvkl_k$(byteCount).compareTo_9jj042_k$(new Long(0, 0)) < 0 || offset.compareTo_9jj042_k$(size) > 0 || size.minus_mfbszm_k$(offset).compareTo_9jj042_k$(byteCount) < 0) {
  ...
  function commonCopyTo(_this__u8e3s4, out, offset, byteCount) {
    ...
    out.set_size_nux7qg_k$(out.get_size_woubt6_k$().plus_r93sks_k$(byteCount_0));
    var s = _this__u8e3s4.get_head_pg0gr3_k$();
    ...
    while (byteCount_0.compareTo_9jj042_k$(new Long(0, 0)) > 0) {
      ...
      if (out.get_head_pg0gr3_k$() == null) {
        copy.set_prev_ur3dkn_k$(copy);
        copy.set_next_tohs5l_k$(copy.get_prev_wosl18_k$());
        out.set_head_csbq7o_k$(copy.get_next_wor1vg_k$());
      } else {
        ensureNotNull(ensureNotNull(out.get_head_pg0gr3_k$()).get_prev_wosl18_k$()).push_wd62e0_k$(copy);
      }
  ...
  function commonGet(_this__u8e3s4, pos) {
    ...
    var tmp0_elvis_lhs = _this__u8e3s4.get_head_pg0gr3_k$();
    var tmp;
    if (tmp0_elvis_lhs == null) {
  ...
  function commonCompleteSegmentByteCount(_this__u8e3s4) {
    ...
    if (result.equals(new Long(0, 0)))
      return new Long(0, 0);
    var tail = ensureNotNull(ensureNotNull(_this__u8e3s4.get_head_pg0gr3_k$()).get_prev_wosl18_k$());
    if (tail.get_limit_iuokuq_k$() < 8192 && tail.get_owner_iwkx3e_k$()) {
  ...
  function commonReadByte(_this__u8e3s4) {
    ...
    var segment = ensureNotNull(_this__u8e3s4.get_head_pg0gr3_k$());
    ...
    pos = tmp0 + 1 | 0;
    var b = data[tmp0];
    _this__u8e3s4.set_size_nux7qg_k$(_this__u8e3s4.get_size_woubt6_k$().minus_mfbszm_k$(new Long(1, 0)));
    if (pos === limit) {
      _this__u8e3s4.set_head_csbq7o_k$(segment.pop_2dsh_k$());
  ...
  function commonReadShort(_this__u8e3s4) {
    ...
    _this__u8e3s4.set_size_nux7qg_k$(_this__u8e3s4.get_size_woubt6_k$().minus_mfbszm_k$(new Long(2, 0)));
    if (pos === limit) {
      _this__u8e3s4.set_head_csbq7o_k$(segment.pop_2dsh_k$());
      SegmentPool_getInstance().recycle_ipeoxr_k$(segment);
    } else {
  ...
  function commonReadInt(_this__u8e3s4) {
    ...
    _this__u8e3s4.set_size_nux7qg_k$(_this__u8e3s4.get_size_woubt6_k$().minus_mfbszm_k$(new Long(4, 0)));
    if (pos === limit) {
      _this__u8e3s4.set_head_csbq7o_k$(segment.pop_2dsh_k$());
      SegmentPool_getInstance().recycle_ipeoxr_k$(segment);
    } else {
  ...
  function commonReadLong(_this__u8e3s4) {
    ...
    _this__u8e3s4.set_size_nux7qg_k$(_this__u8e3s4.get_size_woubt6_k$().minus_mfbszm_k$(new Long(8, 0)));
    if (pos === limit) {
      _this__u8e3s4.set_head_csbq7o_k$(segment.pop_2dsh_k$());
      SegmentPool_getInstance().recycle_ipeoxr_k$(segment);
    } else {
  ...
  function commonReadDecimalLong(_this__u8e3s4) {
    ...
    do {
      ...
      $l$loop: while (pos < limit) {
        ...
        if (b >= 48 && b <= 57) {
          var digit = 48 - b;
          if (value.compareTo_9jj042_k$(new Long(858993460, -214748365)) < 0 || (value.equals(new Long(858993460, -214748365)) && toLong(digit).compareTo_9jj042_k$(overflowDigit) < 0)) {
     ...
     while (!done && !(_this__u8e3s4.get_head_pg0gr3_k$() == null));
    _this__u8e3s4.set_size_nux7qg_k$(_this__u8e3s4.get_size_woubt6_k$().minus_mfbszm_k$(toLong(seen)));
  ...
  function commonReadByteString_0(_this__u8e3s4, byteCount) {
    ...
    // Inline function 'kotlin.require' call
    // Inline function 'kotlin.contracts.contract' call
    if (!(byteCount.compareTo_9jj042_k$(new Long(0, 0)) >= 0 && byteCount.compareTo_9jj042_k$(new Long(2147483647, 0)) <= 0)) {
  ...
  function commonReadUtf8(_this__u8e3s4, byteCount) {
    ...
    if (byteCount.equals(new Long(0, 0)))
      return '';
    var s = ensureNotNull(_this__u8e3s4.get_head_pg0gr3_k$());
    ...
    _this__u8e3s4.set_size_nux7qg_k$(_this__u8e3s4.get_size_woubt6_k$().minus_mfbszm_k$(byteCount));
    if (s.get_pos_18iyad_k$() === s.get_limit_iuokuq_k$()) {
      _this__u8e3s4.set_head_csbq7o_k$(s.pop_2dsh_k$());
  ...
  function commonReadUtf8LineStrict(_this__u8e3s4, limit) {
    ...
    var scanLength = limit.equals(new Long(-1, 2147483647)) ? new Long(-1, 2147483647) : limit.plus_r93sks_k$(new Long(1, 0));
  ...
  function commonSelect(_this__u8e3s4, options) {
    ...
    if (index === -1)
      return -1;
    var selectedSize = options.get_byteStrings_s02knb_k$()[index].get_size_woubt6_k$();
  ...
  function commonRead_0(_this__u8e3s4, sink, offset, byteCount) {
    ...
    _this__u8e3s4.set_size_nux7qg_k$(_this__u8e3s4.get_size_woubt6_k$().minus_mfbszm_k$(toLong(toCopy)));
    if (s.get_pos_18iyad_k$() === s.get_limit_iuokuq_k$()) {
      _this__u8e3s4.set_head_csbq7o_k$(s.pop_2dsh_k$());
      SegmentPool_getInstance().recycle_ipeoxr_k$(s);
    }
  ...
  function commonSkip(_this__u8e3s4, byteCount) {
    ...
    while (byteCount_0.compareTo_9jj042_k$(new Long(0, 0)) > 0) {
      ...
      _this__u8e3s4.set_size_nux7qg_k$(_this__u8e3s4.get_size_woubt6_k$().minus_mfbszm_k$(toLong(toSkip)));
      byteCount_0 = byteCount_0.minus_mfbszm_k$(toLong(toSkip));
      head.set_pos_tfwdvz_k$(head.get_pos_18iyad_k$() + toSkip | 0);
      if (head.get_pos_18iyad_k$() === head.get_limit_iuokuq_k$()) {
        _this__u8e3s4.set_head_csbq7o_k$(head.pop_2dsh_k$());
        SegmentPool_getInstance().recycle_ipeoxr_k$(head);
      }
    }
  }
  function commonWrite(_this__u8e3s4, byteString, offset, byteCount) {
    ...
    _init_properties_Buffer_kt__ndcom8();
    byteString.write_ifrhr7_k$(_this__u8e3s4, offset, byteCount);
    return _this__u8e3s4;
  }
  function commonWritableSegment(_this__u8e3s4, minimumCapacity) {
    ...
    if (_this__u8e3s4.get_head_pg0gr3_k$() == null) {
      var result = SegmentPool_getInstance().take_2451j_k$();
      _this__u8e3s4.set_head_csbq7o_k$(result);
      result.set_prev_ur3dkn_k$(result);
      result.set_next_tohs5l_k$(result);
      return result;
    }
    var tail = ensureNotNull(_this__u8e3s4.get_head_pg0gr3_k$()).get_prev_wosl18_k$();
    if ((ensureNotNull(tail).get_limit_iuokuq_k$() + minimumCapacity | 0) > 8192 || !tail.get_owner_iwkx3e_k$()) {
  ...
  function commonWriteUtf8(_this__u8e3s4, string, beginIndex, endIndex) {
    ...
    while (i < endIndex) {
      ...
      if (c < 128) {
        var tail = _this__u8e3s4.writableSegment_voedtv_k$(1);
        ...
        _this__u8e3s4.set_size_nux7qg_k$(_this__u8e3s4.get_size_woubt6_k$().plus_r93sks_k$(toLong(runSize)));
      } else if (c < 2048) {
        var tail_0 = _this__u8e3s4.writableSegment_voedtv_k$(2);
        ...
        _this__u8e3s4.set_size_nux7qg_k$(_this__u8e3s4.get_size_woubt6_k$().plus_r93sks_k$(new Long(2, 0)));
        i = i + 1 | 0;
      } else if (c < 55296 || c > 57343) {
        var tail_1 = _this__u8e3s4.writableSegment_voedtv_k$(3);
        ...
        _this__u8e3s4.set_size_nux7qg_k$(_this__u8e3s4.get_size_woubt6_k$().plus_r93sks_k$(new Long(3, 0)));
        i = i + 1 | 0;
      } else {
        var tmp;
        if ((i + 1 | 0) < endIndex) {
        ...
        if (c > 56319 || !(56320 <= low ? low <= 57343 : false)) {
          ...
          var tail_2 = _this__u8e3s4.writableSegment_voedtv_k$(4);
          ...
          _this__u8e3s4.set_size_nux7qg_k$(_this__u8e3s4.get_size_woubt6_k$().plus_r93sks_k$(new Long(4, 0)));
          i = i + 2 | 0;
        }
      }
    }
  ...
  function commonWriteUtf8CodePoint(_this__u8e3s4, codePoint) {
    ...
    if (codePoint < 128) {
      ...
      var tail = _this__u8e3s4.writableSegment_voedtv_k$(2);
      ...
      var tail_0 = _this__u8e3s4.writableSegment_voedtv_k$(3);
      ...
      var tail_1 = _this__u8e3s4.writableSegment_voedtv_k$(4);
  ...
  function commonWrite_1(_this__u8e3s4, source, offset, byteCount) {
    ...
    _this__u8e3s4.set_size_nux7qg_k$(_this__u8e3s4.get_size_woubt6_k$().plus_r93sks_k$(toLong(byteCount)));
    return _this__u8e3s4;
  }
  function commonWriteAll(_this__u8e3s4, source) {
    ...
    $l$loop: while (true) {
      var readCount = source.read_a1wdbo_k$(_this__u8e3s4, new Long(8192, 0));
  ...
  function commonWriteByte(_this__u8e3s4, b) {
    ...
    tmp[tmp1] = toByte(b);
    _this__u8e3s4.set_size_nux7qg_k$(_this__u8e3s4.get_size_woubt6_k$().plus_r93sks_k$(new Long(1, 0)));
    return _this__u8e3s4;
  }
  ...
  function commonWriteInt(_this__u8e3s4, i) {
    _init_properties_Buffer_kt__ndcom8();
    var tail = _this__u8e3s4.writableSegment_voedtv_k$(4);
    var data = tail.get_data_wokkxf_k$();
    var limit = tail.get_limit_iuokuq_k$();
    var tmp0 = limit;
    limit = tmp0 + 1 | 0;
  ...
  function commonWriteLong(_this__u8e3s4, v) {
    _init_properties_Buffer_kt__ndcom8();
    var tail = _this__u8e3s4.writableSegment_voedtv_k$(8);
    var data = tail.get_data_wokkxf_k$();
    var limit = tail.get_limit_iuokuq_k$();
    var tmp0 = limit;
    limit = tmp0 + 1 | 0;
    ...
    tail.set_limit_mo5fx2_k$(limit);
    _this__u8e3s4.set_size_nux7qg_k$(_this__u8e3s4.get_size_woubt6_k$().plus_r93sks_k$(new Long(8, 0)));
    return _this__u8e3s4;
  }
  function commonWriteDecimalLong(_this__u8e3s4, v) {
    ...
    var tail = _this__u8e3s4.writableSegment_voedtv_k$(width);
    var data = tail.get_data_wokkxf_k$();
    ...
    _this__u8e3s4.set_size_nux7qg_k$(_this__u8e3s4.get_size_woubt6_k$().plus_r93sks_k$(toLong(width)));
    return _this__u8e3s4;
  }
  ...
  function commonWrite_3(_this__u8e3s4, source, byteCount) {
    ...
    while (byteCount_0.compareTo_9jj042_k$(new Long(0, 0)) > 0) {
      if (byteCount_0.compareTo_9jj042_k$(toLong(ensureNotNull(source.get_head_pg0gr3_k$()).get_limit_iuokuq_k$() - ensureNotNull(source.get_head_pg0gr3_k$()).get_pos_18iyad_k$() | 0)) < 0) {
        var tail = !(_this__u8e3s4.get_head_pg0gr3_k$() == null) ? ensureNotNull(_this__u8e3s4.get_head_pg0gr3_k$()).get_prev_wosl18_k$() : null;
        var tmp;
        if (!(tail == null) && tail.get_owner_iwkx3e_k$()) {
          // Inline function 'kotlin.Long.minus' call
          // Inline function 'kotlin.Long.plus' call
        ...
        if (tmp) {
          ensureNotNull(source.get_head_pg0gr3_k$()).writeTo_yxwz0w_k$(tail, byteCount_0.toInt_1tsl84_k$());
          source.set_size_nux7qg_k$(source.get_size_woubt6_k$().minus_mfbszm_k$(byteCount_0));
          _this__u8e3s4.set_size_nux7qg_k$(_this__u8e3s4.get_size_woubt6_k$().plus_r93sks_k$(byteCount_0));
          return Unit_getInstance();
        } else {
          source.set_head_csbq7o_k$(ensureNotNull(source.get_head_pg0gr3_k$()).split_cz4av2_k$(byteCount_0.toInt_1tsl84_k$()));
        }
      }
      var segmentToMove = source.get_head_pg0gr3_k$();
      var movedByteCount = toLong(ensureNotNull(segmentToMove).get_limit_iuokuq_k$() - segmentToMove.get_pos_18iyad_k$() | 0);
      source.set_head_csbq7o_k$(segmentToMove.pop_2dsh_k$());
      if (_this__u8e3s4.get_head_pg0gr3_k$() == null) {
        _this__u8e3s4.set_head_csbq7o_k$(segmentToMove);
        segmentToMove.set_prev_ur3dkn_k$(segmentToMove);
        segmentToMove.set_next_tohs5l_k$(segmentToMove.get_prev_wosl18_k$());
      } else {
        var tail_0 = ensureNotNull(_this__u8e3s4.get_head_pg0gr3_k$()).get_prev_wosl18_k$();
        tail_0 = ensureNotNull(tail_0).push_wd62e0_k$(segmentToMove);
        tail_0.compact_dawvql_k$();
      }
      source.set_size_nux7qg_k$(source.get_size_woubt6_k$().minus_mfbszm_k$(movedByteCount));
      _this__u8e3s4.set_size_nux7qg_k$(_this__u8e3s4.get_size_woubt6_k$().plus_r93sks_k$(movedByteCount));
  ...
  function commonRangeEquals(_this__u8e3s4, offset, bytes, bytesOffset, byteCount) {
    _init_properties_Buffer_kt__ndcom8();
    if (offset.compareTo_9jj042_k$(new Long(0, 0)) < 0 || bytesOffset < 0 || byteCount < 0 || _this__u8e3s4.get_size_woubt6_k$().minus_mfbszm_k$(offset).compareTo_9jj042_k$(toLong(byteCount)) < 0 || (bytes.get_size_woubt6_k$() - bytesOffset | 0) < byteCount) {
      return false;
    }
    var inductionVariable = 0;
    if (inductionVariable < byteCount)
  ...
  function commonEquals(_this__u8e3s4, other) {
    ...
    if (_this__u8e3s4.get_size_woubt6_k$().equals(new Long(0, 0)))
      return true;
    var sa = ensureNotNull(_this__u8e3s4.get_head_pg0gr3_k$());
    var sb = ensureNotNull(other.get_head_pg0gr3_k$());
  ...
  function commonHashCode(_this__u8e3s4) {
    ...
    do {
     ...
     while (!(s === _this__u8e3s4.get_head_pg0gr3_k$()));
    return result;
  }
  function commonCopy(_this__u8e3s4) {
    ...
    if (_this__u8e3s4.get_size_woubt6_k$().equals(new Long(0, 0)))
      return result;
    var head = ensureNotNull(_this__u8e3s4.get_head_pg0gr3_k$());
    var headCopy = head.sharedCopy_timhza_k$();
    result.set_head_csbq7o_k$(headCopy);
    headCopy.set_prev_ur3dkn_k$(result.get_head_pg0gr3_k$());
    ...
    result.set_size_nux7qg_k$(_this__u8e3s4.get_size_woubt6_k$());
    return result;
  }
  function commonSnapshot(_this__u8e3s4) {
    ...
    // Inline function 'kotlin.check' call
    // Inline function 'kotlin.contracts.contract' call
    if (!(_this__u8e3s4.get_size_woubt6_k$().compareTo_9jj042_k$(new Long(2147483647, 0)) <= 0)) {
  ...
  function commonSnapshot_0(_this__u8e3s4, byteCount) {
    ...
    offset = 0;
    segmentCount = 0;
    s = _this__u8e3s4.get_head_pg0gr3_k$();
    while (offset < byteCount) {
  ...
  function commonSeek(_this__u8e3s4, offset) {
    ...
    if (offset.compareTo_9jj042_k$(new Long(-1, -1)) < 0 || offset.compareTo_9jj042_k$(buffer.get_size_woubt6_k$()) > 0) {
      throw new ArrayIndexOutOfBoundsException('offset=' + offset.toString() + ' > size=' + buffer.get_size_woubt6_k$().toString());
    }
    if (offset.equals(new Long(-1, -1)) || offset.equals(buffer.get_size_woubt6_k$())) {
      _this__u8e3s4.set_segment_q3t00r_k$(null);
    ...
    var head = buffer.get_head_pg0gr3_k$();
    var tail = buffer.get_head_pg0gr3_k$();
    if (!(_this__u8e3s4.get_segment_v0lccy_k$() == null)) {
      // Inline function 'kotlin.Long.minus' call
      var this_0 = _this__u8e3s4.get_offset_hjmqak_k$();
      var other = _this__u8e3s4.get_start_iypx6h_k$() - ensureNotNull(_this__u8e3s4.get_segment_v0lccy_k$()).get_pos_18iyad_k$() | 0;
      var segmentOffset = this_0.minus_mfbszm_k$(toLong(other));
      if (segmentOffset.compareTo_9jj042_k$(offset) > 0) {
        max = segmentOffset;
        tail = _this__u8e3s4.get_segment_v0lccy_k$();
      } else {
        min = segmentOffset;
        head = _this__u8e3s4.get_segment_v0lccy_k$();
      }
    }
    var next;
    var nextOffset;
    ...
    if (_this__u8e3s4.get_readWrite_a0tpds_k$() && ensureNotNull(next).get_shared_jgtlda_k$()) {
      var unsharedNext = next.unsharedCopy_5kj8b7_k$();
      if (buffer.get_head_pg0gr3_k$() === next) {
        buffer.set_head_csbq7o_k$(unsharedNext);
      }
      next = next.push_wd62e0_k$(unsharedNext);
      ensureNotNull(next.get_prev_wosl18_k$()).pop_2dsh_k$();
    }
    _this__u8e3s4.set_segment_q3t00r_k$(next);
    _this__u8e3s4.set_offset_snb08i_k$(offset);
  ...
  function commonResizeBuffer(_this__u8e3s4, newSize) {
    ...
    if (newSize.compareTo_9jj042_k$(oldSize) <= 0) {
      ...
      $l$loop: while (bytesToSubtract.compareTo_9jj042_k$(new Long(0, 0)) > 0) {
        var tail = ensureNotNull(buffer.get_head_pg0gr3_k$()).get_prev_wosl18_k$();
        ...
        if (toLong(tailSize).compareTo_9jj042_k$(bytesToSubtract) <= 0) {
          buffer.set_head_csbq7o_k$(tail.pop_2dsh_k$());
          SegmentPool_getInstance().recycle_ipeoxr_k$(tail);
      ...
      while (bytesToAdd.compareTo_9jj042_k$(new Long(0, 0)) > 0) {
        var tail_0 = buffer.writableSegment_voedtv_k$(1);
        // Inline function 'okio.minOf' call
        var a = bytesToAdd;
        var b = 8192 - tail_0.get_limit_iuokuq_k$() | 0;
        // Inline function 'kotlin.comparisons.minOf' call
        var b_0 = toLong(b);
        ...
        if (needsToSeek) {
          _this__u8e3s4.set_segment_q3t00r_k$(tail_0);
    ...
    buffer.set_size_nux7qg_k$(newSize);
    return oldSize;
  }
  function commonExpandBuffer(_this__u8e3s4, minByteCount) {
    ...
    var oldSize = buffer.get_size_woubt6_k$();
    var tail = buffer.writableSegment_voedtv_k$(minByteCount);
    var result = 8192 - tail.get_limit_iuokuq_k$() | 0;
    tail.set_limit_mo5fx2_k$(8192);
    // Inline function 'kotlin.Long.plus' call
    var tmp$ret$5 = oldSize.plus_r93sks_k$(toLong(result));
    buffer.set_size_nux7qg_k$(tmp$ret$5);
    _this__u8e3s4.set_segment_q3t00r_k$(tail);
    _this__u8e3s4.set_offset_snb08i_k$(oldSize);
    _this__u8e3s4.set_data_zi6csw_k$(tail.get_data_wokkxf_k$());
    _this__u8e3s4.set_start_x5zd0j_k$(8192 - result | 0);
    _this__u8e3s4.set_end_2o0hu2_k$(8192);
  ...
  function selectPrefix(_this__u8e3s4, options, selectTruncated) {
    ...
    var trie = options.get_trie_j62wdn_k$();
    var triePos = 0;
    var prefixIndex = -1;
  ...
  function commonSelect_0(_this__u8e3s4, options) {
    var index = _this__u8e3s4.select_91a7t_k$(options.get_options_qkdnzx_k$());
  ...
  function commonUtf8(_this__u8e3s4) {
    _init_properties_ByteString_kt__sqjq7b();
    var result = _this__u8e3s4.get_utf8_lmuzsu_k$();
    if (result == null) {
      result = toUtf8String(_this__u8e3s4.internalArray_nlkee4_k$());
      _this__u8e3s4.set_utf8_1c2rfj_k$(result);
    }
    return result;
  }
  function commonBase64(_this__u8e3s4) {
    _init_properties_ByteString_kt__sqjq7b();
    return encodeBase64(_this__u8e3s4.get_data_hjgcg5_k$());
  }
  function commonBase64Url(_this__u8e3s4) {
    _init_properties_ByteString_kt__sqjq7b();
    return encodeBase64(_this__u8e3s4.get_data_hjgcg5_k$(), get_BASE64_URL_SAFE());
  }
  function commonHex(_this__u8e3s4) {
    _init_properties_ByteString_kt__sqjq7b();
    var result = charArray(imul(_this__u8e3s4.get_data_hjgcg5_k$().length, 2));
    var c = 0;
    var indexedObject = _this__u8e3s4.get_data_hjgcg5_k$();
    var inductionVariable = 0;
  ...
  function commonToAsciiLowercase(_this__u8e3s4) {
    _init_properties_ByteString_kt__sqjq7b();
    var i = 0;
    $l$loop: while (i < _this__u8e3s4.get_data_hjgcg5_k$().length) {
      var c = _this__u8e3s4.get_data_hjgcg5_k$()[i];
      if (c < 65 || c > 90) {
        i = i + 1 | 0;
        continue $l$loop;
      }
      // Inline function 'kotlin.collections.copyOf' call
      // Inline function 'kotlin.js.asDynamic' call
      var lowercase = _this__u8e3s4.get_data_hjgcg5_k$().slice();
      var tmp1 = i;
      i = tmp1 + 1 | 0;
  ...
  function commonSubstring(_this__u8e3s4, beginIndex, endIndex) {
    ...
    // Inline function 'kotlin.require' call
    // Inline function 'kotlin.contracts.contract' call
    if (!(endIndex_0 <= _this__u8e3s4.get_data_hjgcg5_k$().length)) {
      // Inline function 'okio.internal.commonSubstring.<anonymous>' call
      var message_0 = 'endIndex > length(' + _this__u8e3s4.get_data_hjgcg5_k$().length + ')';
      throw IllegalArgumentException_init_$Create$(toString(message_0));
    }
    ...
    if (beginIndex === 0 && endIndex_0 === _this__u8e3s4.get_data_hjgcg5_k$().length) {
      return _this__u8e3s4;
    }
    return new ByteString(copyOfRange(_this__u8e3s4.get_data_hjgcg5_k$(), beginIndex, endIndex_0));
  }
  function commonGetByte(_this__u8e3s4, pos) {
    _init_properties_ByteString_kt__sqjq7b();
    return _this__u8e3s4.get_data_hjgcg5_k$()[pos];
  }
  function commonGetSize(_this__u8e3s4) {
    _init_properties_ByteString_kt__sqjq7b();
    return _this__u8e3s4.get_data_hjgcg5_k$().length;
  }
  function commonToByteArray(_this__u8e3s4) {
    _init_properties_ByteString_kt__sqjq7b();
    // Inline function 'kotlin.collections.copyOf' call
    // Inline function 'kotlin.js.asDynamic' call
    return _this__u8e3s4.get_data_hjgcg5_k$().slice();
  }
  function commonInternalArray(_this__u8e3s4) {
    _init_properties_ByteString_kt__sqjq7b();
    return _this__u8e3s4.get_data_hjgcg5_k$();
  }
  function commonWrite_4(_this__u8e3s4, buffer, offset, byteCount) {
    _init_properties_ByteString_kt__sqjq7b();
    buffer.write_owzzlt_k$(_this__u8e3s4.get_data_hjgcg5_k$(), offset, byteCount);
  }
  function commonRangeEquals_0(_this__u8e3s4, offset, other, otherOffset, byteCount) {
    _init_properties_ByteString_kt__sqjq7b();
    return other.rangeEquals_4nzvj0_k$(otherOffset, _this__u8e3s4.get_data_hjgcg5_k$(), offset, byteCount);
  }
  function commonRangeEquals_1(_this__u8e3s4, offset, other, otherOffset, byteCount) {
    _init_properties_ByteString_kt__sqjq7b();
    return offset >= 0 && offset <= (_this__u8e3s4.get_data_hjgcg5_k$().length - byteCount | 0) && otherOffset >= 0 && otherOffset <= (other.length - byteCount | 0) && arrayRangeEquals(_this__u8e3s4.get_data_hjgcg5_k$(), offset, other, otherOffset, byteCount);
  }
  function commonCopyInto(_this__u8e3s4, offset, target, targetOffset, byteCount) {
    _init_properties_ByteString_kt__sqjq7b();
    // Inline function 'kotlin.collections.copyInto' call
    var this_0 = _this__u8e3s4.get_data_hjgcg5_k$();
  ...
  function commonIndexOf_1(_this__u8e3s4, other, fromIndex) {
    _init_properties_ByteString_kt__sqjq7b();
    var limit = _this__u8e3s4.get_data_hjgcg5_k$().length - other.length | 0;
    ...
    if (inductionVariable <= limit)
      do {
        var i = inductionVariable;
        inductionVariable = inductionVariable + 1 | 0;
        if (arrayRangeEquals(_this__u8e3s4.get_data_hjgcg5_k$(), i, other, 0, other.length)) {
          return i;
        }
      }
       while (!(i === limit));
  ...
  function commonLastIndexOf(_this__u8e3s4, other, fromIndex) {
    _init_properties_ByteString_kt__sqjq7b();
    return _this__u8e3s4.lastIndexOf_cmuddn_k$(other.internalArray_nlkee4_k$(), fromIndex);
  }
  ...
  function commonEquals_0(_this__u8e3s4, other) {
    ...
    if (other === _this__u8e3s4) {
      ...
      if (other instanceof ByteString) {
        tmp = (other.get_size_woubt6_k$() === _this__u8e3s4.get_data_hjgcg5_k$().length && other.rangeEquals_4nzvj0_k$(0, _this__u8e3s4.get_data_hjgcg5_k$(), 0, _this__u8e3s4.get_data_hjgcg5_k$().length));
      } else {
        tmp = false;
      }
    }
  ...
  function commonHashCode_0(_this__u8e3s4) {
    _init_properties_ByteString_kt__sqjq7b();
    var result = _this__u8e3s4.get_hashCode_jn37v8_k$();
    if (!(result === 0))
      return result;
    // Inline function 'kotlin.also' call
    var this_0 = contentHashCode(_this__u8e3s4.get_data_hjgcg5_k$());
    // Inline function 'kotlin.contracts.contract' call
    // Inline function 'okio.internal.commonHashCode.<anonymous>' call
    _this__u8e3s4.set_hashCode_j8f9eg_k$(this_0);
    return this_0;
  }
  ...
  function commonToString(_this__u8e3s4) {
    _init_properties_ByteString_kt__sqjq7b();
    // Inline function 'kotlin.collections.isEmpty' call
    if (_this__u8e3s4.get_data_hjgcg5_k$().length === 0)
      return '[size=0]';
    var i = codePointIndexToCharIndex$accessor$1yfvj6b(_this__u8e3s4.get_data_hjgcg5_k$(), 64);
    if (i === -1) {
      var tmp;
      if (_this__u8e3s4.get_data_hjgcg5_k$().length <= 64) {
        tmp = '[hex=' + _this__u8e3s4.hex_27mj_k$() + ']';
      } else {
        var tmp_0 = _this__u8e3s4.get_data_hjgcg5_k$().length;
        var tmp$ret$4;
        $l$block: {
          ...
          // Inline function 'kotlin.require' call
          // Inline function 'kotlin.contracts.contract' call
          if (!(endIndex <= _this__u8e3s4.get_data_hjgcg5_k$().length)) {
            // Inline function 'okio.internal.commonSubstring.<anonymous>' call
            var message_0 = 'endIndex > length(' + _this__u8e3s4.get_data_hjgcg5_k$().length + ')';
            throw IllegalArgumentException_init_$Create$(toString(message_0));
          }
          ...
          if (0 === 0 && endIndex === _this__u8e3s4.get_data_hjgcg5_k$().length) {
            tmp$ret$4 = _this__u8e3s4;
            break $l$block;
          }
          tmp$ret$4 = new ByteString(copyOfRange(_this__u8e3s4.get_data_hjgcg5_k$(), 0, endIndex));
        }
    ...
    var tmp_1;
    if (i < text.length) {
      tmp_1 = '[size=' + _this__u8e3s4.get_data_hjgcg5_k$().length + ' text=' + safeText + '\u2026]';
    } else {
      tmp_1 = '[text=' + safeText + ']';
    }
    return tmp_1;
  ...
  function commonCreateDirectories(_this__u8e3s4, dir, mustCreate) {
    ...
    var path = dir;
    while (!(path == null) && !_this__u8e3s4.exists_gjgzpn_k$(path)) {
      directories.addFirst_7io6zl_k$(path);
      path = path.get_parent_hy4reb_k$();
    }
    if (mustCreate && directories.isEmpty_y1axqb_k$())
      throw IOException_init_$Create$(dir.toString() + ' already exists.');
  ...
  function commonCopy_0(_this__u8e3s4, source, target) {
    ...
    try {
      ...
      try {
        ...
        tmp_0 = this_1.writeAll_goqmgy_k$(this_0);
      } catch ($p) {
        var tmp_1;
        if ($p instanceof Error) {
          var t = $p;
      ...
      if (!(thrown_0 == null))
        throw thrown_0;
      tmp = (result == null ? true : !(result == null)) ? result : THROW_CCE();
    } catch ($p) {
      var tmp_2;
      if ($p instanceof Error) {
        var t_1 = $p;
    ...
    if (!(thrown == null))
      throw thrown;
    (result_0 == null ? true : !(result_0 == null)) || THROW_CCE();
  }
  function commonDeleteRecursively(_this__u8e3s4, fileOrDirectory, mustExist) {
    ...
    while (iterator.hasNext_bitz1p_k$()) {
      ...
      _this__u8e3s4.delete_jmjgr3_k$(toDelete, mustExist && !iterator.hasNext_bitz1p_k$());
    }
  }
        ...
        switch (tmp) {
          ...
          case 2:
            ...
            if (!this.children0__1.isEmpty_y1axqb_k$()) {
              ...
              $l$loop: while (true) {
                if (this.followSymlinks_1 && this.stack_1.contains_aljjnj_k$(this.symlinkPath1__1))
                  throw IOException_init_$Create$('symlink cycle at ' + this.path_1.toString());
                var tmp_2 = this;
              ...
              if (this.followSymlinks_1 || this.symlinkCount2__1 === 0) {
  ...
  function commonRoot(_this__u8e3s4) {
    ...
    return rootLength === -1 ? null : new Path(_this__u8e3s4.get_bytes_c5stva_k$().substring_d7lab3_k$(0, rootLength));
  }
  function commonSegments(_this__u8e3s4) {
    ...
    if (segmentStart === -1) {
      segmentStart = 0;
    } else if (segmentStart < _this__u8e3s4.get_bytes_c5stva_k$().get_size_woubt6_k$() && _this__u8e3s4.get_bytes_c5stva_k$().get_c1px32_k$(segmentStart) === 92) {
      segmentStart = segmentStart + 1 | 0;
    }
    var inductionVariable = segmentStart;
    var last = _this__u8e3s4.get_bytes_c5stva_k$().get_size_woubt6_k$();
    if (inductionVariable < last)
      do {
        var i = inductionVariable;
        inductionVariable = inductionVariable + 1 | 0;
        if (_this__u8e3s4.get_bytes_c5stva_k$().get_c1px32_k$(i) === 47 || _this__u8e3s4.get_bytes_c5stva_k$().get_c1px32_k$(i) === 92) {
          // Inline function 'kotlin.collections.plusAssign' call
          var element = _this__u8e3s4.get_bytes_c5stva_k$().substring_d7lab3_k$(segmentStart, i);
          result.add_utx5q5_k$(element);
          segmentStart = i + 1 | 0;
        }
      }
       while (inductionVariable < last);
    if (segmentStart < _this__u8e3s4.get_bytes_c5stva_k$().get_size_woubt6_k$()) {
      // Inline function 'kotlin.collections.plusAssign' call
      var element_0 = _this__u8e3s4.get_bytes_c5stva_k$().substring_d7lab3_k$(segmentStart, _this__u8e3s4.get_bytes_c5stva_k$().get_size_woubt6_k$());
  ...
  function commonVolumeLetter(_this__u8e3s4) {
    _init_properties_Path_kt__cy3pvf();
    if (!(_this__u8e3s4.get_bytes_c5stva_k$().indexOf$default_hu8ijm_k$(_get_SLASH_$accessor$1r83mlj_21oo1q_0()) === -1))
      return null;
    if (_this__u8e3s4.get_bytes_c5stva_k$().get_size_woubt6_k$() < 2)
      return null;
    if (!(_this__u8e3s4.get_bytes_c5stva_k$().get_c1px32_k$(1) === 58))
      return null;
    var c = numberToChar(_this__u8e3s4.get_bytes_c5stva_k$().get_c1px32_k$(0));
  ...
  function commonNameBytes(_this__u8e3s4) {
    ...
    var tmp;
    if (!(lastSlash === -1)) {
      tmp = _this__u8e3s4.get_bytes_c5stva_k$().substring$default_eaicy4_k$(lastSlash + 1 | 0);
    } else {
      var tmp_0;
      var tmp_1 = _this__u8e3s4.get_volumeLetter_8ydwfo_k$();
      if (!((tmp_1 == null ? null : new Char(tmp_1)) == null)) {
        tmp_0 = _this__u8e3s4.get_bytes_c5stva_k$().get_size_woubt6_k$() === 2;
      } else {
        tmp_0 = false;
      }
      if (tmp_0) {
        ...
        tmp = _this__u8e3s4.get_bytes_c5stva_k$();
      }
    }
    return tmp;
  }
  ...
  function commonParent(_this__u8e3s4) {
    _init_properties_Path_kt__cy3pvf();
    if (_this__u8e3s4.get_bytes_c5stva_k$().equals(_get_DOT_$accessor$1r83mlj_23eb7y_1()) || _this__u8e3s4.get_bytes_c5stva_k$().equals(_get_SLASH_$accessor$1r83mlj_21oo1q_0()) || _this__u8e3s4.get_bytes_c5stva_k$().equals(_get_BACKSLASH_$accessor$1r83mlj_9mc3r9_0()) || lastSegmentIsDotDot$accessor$1r83mlj(_this__u8e3s4)) {
      return null;
    }
    var lastSlash = _get_indexOfLastSlash_$accessor$1r83mlj_ivcd2h_0(_this__u8e3s4);
    var tmp;
    ...
    if (tmp) {
      if (_this__u8e3s4.get_bytes_c5stva_k$().get_size_woubt6_k$() === 3)
        return null;
      return new Path(_this__u8e3s4.get_bytes_c5stva_k$().substring$default_eaicy4_k$(VOID, 3));
    } else {
      if (lastSlash === 1 && _this__u8e3s4.get_bytes_c5stva_k$().startsWith_w7onu6_k$(_get_BACKSLASH_$accessor$1r83mlj_9mc3r9_0())) {
        return null;
      } else {
        var tmp_1;
        if (lastSlash === -1) {
        ...
        if (tmp_1) {
          if (_this__u8e3s4.get_bytes_c5stva_k$().get_size_woubt6_k$() === 2)
            return null;
          return new Path(_this__u8e3s4.get_bytes_c5stva_k$().substring$default_eaicy4_k$(VOID, 2));
        } else {
          if (lastSlash === -1) {
            return new Path(_get_DOT_$accessor$1r83mlj_23eb7y_1());
          } else {
            if (lastSlash === 0) {
              return new Path(_this__u8e3s4.get_bytes_c5stva_k$().substring$default_eaicy4_k$(VOID, 1));
            } else {
              return new Path(_this__u8e3s4.get_bytes_c5stva_k$().substring$default_eaicy4_k$(VOID, lastSlash));
            }
          }
        }
      }
  ...
  function commonIsRoot(_this__u8e3s4) {
    _init_properties_Path_kt__cy3pvf();
    return rootLength$accessor$1r83mlj_3(_this__u8e3s4) === _this__u8e3s4.get_bytes_c5stva_k$().get_size_woubt6_k$();
  }
  ...
  function commonResolve_1(_this__u8e3s4, child, normalize) {
    ...
    buffer.write_f9cjbq_k$(_this__u8e3s4.get_bytes_c5stva_k$());
    if (buffer.get_size_woubt6_k$().compareTo_9jj042_k$(new Long(0, 0)) > 0) {
      buffer.write_f9cjbq_k$(slash);
    }
    buffer.write_f9cjbq_k$(child.get_bytes_c5stva_k$());
  ...
  function commonRelativeTo(_this__u8e3s4, other) {
    ...
    if (!equals(_this__u8e3s4.get_root_wott0r_k$(), other.get_root_wott0r_k$())) {
      ...
      var message = 'Paths of different roots cannot be relative to each other: ' + _this__u8e3s4.toString() + ' and ' + other.toString();
      throw IllegalArgumentException_init_$Create$(toString(message));
    }
    ...
    while (firstNewSegmentIndex < minSegmentsSize && thisSegments.get_c1px32_k$(firstNewSegmentIndex).equals(otherSegments.get_c1px32_k$(firstNewSegmentIndex))) {
      firstNewSegmentIndex = firstNewSegmentIndex + 1 | 0;
    }
    if (firstNewSegmentIndex === minSegmentsSize && _this__u8e3s4.get_bytes_c5stva_k$().get_size_woubt6_k$() === other.get_bytes_c5stva_k$().get_size_woubt6_k$()) {
    ...
    if (!(otherSegments.subList_xle3r2_k$(firstNewSegmentIndex, otherSegments.get_size_woubt6_k$()).indexOf_si1fv9_k$(_get_DOT_DOT_$accessor$1r83mlj_3dr2dk_0()) === -1)) {
      // Inline function 'okio.internal.commonRelativeTo.<anonymous>' call
      var message_0 = 'Impossible relative path to resolve: ' + _this__u8e3s4.toString() + ' and ' + other.toString();
      throw IllegalArgumentException_init_$Create$(toString(message_0));
    }
    if (other.get_bytes_c5stva_k$().equals(_get_DOT_$accessor$1r83mlj_23eb7y_1())) {
      return _this__u8e3s4;
    }
    var buffer = new Buffer();
  ...
  function commonCompareTo_0(_this__u8e3s4, other) {
    _init_properties_Path_kt__cy3pvf();
    return _this__u8e3s4.get_bytes_c5stva_k$().compareTo_u95g6h_k$(other.get_bytes_c5stva_k$());
  }
  function commonEquals_1(_this__u8e3s4, other) {
    _init_properties_Path_kt__cy3pvf();
    var tmp;
    if (other instanceof Path) {
      tmp = other.get_bytes_c5stva_k$().equals(_this__u8e3s4.get_bytes_c5stva_k$());
    } else {
      tmp = false;
    }
    return tmp;
  ...
  function commonHashCode_1(_this__u8e3s4) {
    _init_properties_Path_kt__cy3pvf();
    return _this__u8e3s4.get_bytes_c5stva_k$().hashCode();
  }
  function commonToString_0(_this__u8e3s4) {
    _init_properties_Path_kt__cy3pvf();
    return _this__u8e3s4.get_bytes_c5stva_k$().utf8_255yp_k$();
  }
  ...
  function rootLength(_this__u8e3s4) {
    _init_properties_Path_kt__cy3pvf();
    if (_this__u8e3s4.get_bytes_c5stva_k$().get_size_woubt6_k$() === 0)
      return -1;
    if (_this__u8e3s4.get_bytes_c5stva_k$().get_c1px32_k$(0) === 47)
      return 1;
    if (_this__u8e3s4.get_bytes_c5stva_k$().get_c1px32_k$(0) === 92) {
      if (_this__u8e3s4.get_bytes_c5stva_k$().get_size_woubt6_k$() > 2 && _this__u8e3s4.get_bytes_c5stva_k$().get_c1px32_k$(1) === 92) {
        var uncRootEnd = _this__u8e3s4.get_bytes_c5stva_k$().indexOf_kkf4fc_k$(_get_BACKSLASH_$accessor$1r83mlj_9mc3r9_0(), 2);
        if (uncRootEnd === -1)
          uncRootEnd = _this__u8e3s4.get_bytes_c5stva_k$().get_size_woubt6_k$();
        return uncRootEnd;
      }
      return 1;
    }
    if (_this__u8e3s4.get_bytes_c5stva_k$().get_size_woubt6_k$() > 2 && _this__u8e3s4.get_bytes_c5stva_k$().get_c1px32_k$(1) === 58 && _this__u8e3s4.get_bytes_c5stva_k$().get_c1px32_k$(2) === 92) {
      var c = numberToChar(_this__u8e3s4.get_bytes_c5stva_k$().get_c1px32_k$(0));
      if (!(_Char___init__impl__6a9atx(97) <= c ? c <= _Char___init__impl__6a9atx(122) : false) && !(_Char___init__impl__6a9atx(65) <= c ? c <= _Char___init__impl__6a9atx(90) : false))
        return -1;
      return 3;
  ...
  function get_indexOfLastSlash(_this__u8e3s4) {
    _init_properties_Path_kt__cy3pvf();
    var lastSlash = _this__u8e3s4.get_bytes_c5stva_k$().lastIndexOf$default_47y2vs_k$(_get_SLASH_$accessor$1r83mlj_21oo1q_0());
    if (!(lastSlash === -1))
      return lastSlash;
    return _this__u8e3s4.get_bytes_c5stva_k$().lastIndexOf$default_47y2vs_k$(_get_BACKSLASH_$accessor$1r83mlj_9mc3r9_0());
  }
  function lastSegmentIsDotDot(_this__u8e3s4) {
    _init_properties_Path_kt__cy3pvf();
    if (_this__u8e3s4.get_bytes_c5stva_k$().endsWith_gb36t1_k$(_get_DOT_DOT_$accessor$1r83mlj_3dr2dk_0())) {
      if (_this__u8e3s4.get_bytes_c5stva_k$().get_size_woubt6_k$() === 2)
        return true;
      if (_this__u8e3s4.get_bytes_c5stva_k$().rangeEquals_b8izl9_k$(_this__u8e3s4.get_bytes_c5stva_k$().get_size_woubt6_k$() - 3 | 0, _get_SLASH_$accessor$1r83mlj_21oo1q_0(), 0, 1))
        return true;
      if (_this__u8e3s4.get_bytes_c5stva_k$().rangeEquals_b8izl9_k$(_this__u8e3s4.get_bytes_c5stva_k$().get_size_woubt6_k$() - 3 | 0, _get_BACKSLASH_$accessor$1r83mlj_9mc3r9_0(), 0, 1))
        return true;
    }
    return false;
  }
  ...
  function get_slash(_this__u8e3s4) {
    _init_properties_Path_kt__cy3pvf();
    return !(_this__u8e3s4.get_bytes_c5stva_k$().indexOf$default_hu8ijm_k$(_get_SLASH_$accessor$1r83mlj_21oo1q_0()) === -1) ? _get_SLASH_$accessor$1r83mlj_21oo1q_0() : !(_this__u8e3s4.get_bytes_c5stva_k$().indexOf$default_hu8ijm_k$(_get_BACKSLASH_$accessor$1r83mlj_9mc3r9_0()) === -1) ? _get_BACKSLASH_$accessor$1r83mlj_9mc3r9_0() : null;
  }
  ...
  function toPath(_this__u8e3s4, normalize) {
    ...
    while (_this__u8e3s4.rangeEquals_pk4yqx_k$(new Long(0, 0), _get_SLASH_$accessor$1r83mlj_21oo1q_0()) || _this__u8e3s4.rangeEquals_pk4yqx_k$(new Long(0, 0), _get_BACKSLASH_$accessor$1r83mlj_9mc3r9_0())) {
    ...
    var windowsUncPath = leadingSlashCount >= 2 && equals(slash, _get_BACKSLASH_$accessor$1r83mlj_9mc3r9_0());
    if (windowsUncPath) {
    ...
    while (!_this__u8e3s4.exhausted_p1jt55_k$()) {
      ...
      if (part.equals(_get_DOT_DOT_$accessor$1r83mlj_3dr2dk_0())) {
        if (!absolute || !canonicalParts.isEmpty_y1axqb_k$())
          if (!normalize || (!absolute && (canonicalParts.isEmpty_y1axqb_k$() || last(canonicalParts).equals(_get_DOT_DOT_$accessor$1r83mlj_3dr2dk_0())))) {
            canonicalParts.add_utx5q5_k$(part);
          } else if (!windowsUncPath || canonicalParts.get_size_woubt6_k$() !== 1) {
            removeLastOrNull(canonicalParts);
          }
      } else if (!part.equals(_get_DOT_$accessor$1r83mlj_23eb7y_1()) && !part.equals(Companion_getInstance_7().get_EMPTY_i8q41w_k$())) {
        canonicalParts.add_utx5q5_k$(part);
      }
    }
    var inductionVariable = 0;
    ...
    if (result.get_size_woubt6_k$().equals(new Long(0, 0))) {
      result.write_f9cjbq_k$(_get_DOT_$accessor$1r83mlj_23eb7y_1());
    }
  ...
  function _get_DOT_$accessor$1r83mlj_23eb7y_1() {
    _init_properties_Path_kt__cy3pvf();
    return get_DOT();
  }
  ...
  function commonWriteAll_0(_this__u8e3s4, source) {
    var totalBytesRead = new Long(0, 0);
    $l$loop: while (true) {
      var readCount = source.read_a1wdbo_k$(_this__u8e3s4.get_buffer_bmaafd_k$(), new Long(8192, 0));
      if (readCount.equals(new Long(-1, -1)))
        break $l$loop;
      totalBytesRead = totalBytesRead.plus_r93sks_k$(readCount);
      _this__u8e3s4.emitCompleteSegments_5yum7g_k$();
  ...
  function commonToString_1(_this__u8e3s4) {
    return 'buffer(' + toString(_this__u8e3s4.get_sink_woubj0_k$()) + ')';
  }
  function commonRead_2(_this__u8e3s4, sink, byteCount) {
    ...
    if (_this__u8e3s4.get_buffer_bmaafd_k$().get_size_woubt6_k$().equals(new Long(0, 0))) {
      if (byteCount.equals(new Long(0, 0)))
        return new Long(0, 0);
      var read = _this__u8e3s4.get_source_jl0x7o_k$().read_a1wdbo_k$(_this__u8e3s4.get_buffer_bmaafd_k$(), new Long(8192, 0));
      if (read.equals(new Long(-1, -1)))
        return new Long(-1, -1);
    }
    // Inline function 'kotlin.comparisons.minOf' call
  ...
  function commonExhausted(_this__u8e3s4) {
    ...
    return _this__u8e3s4.get_buffer_bmaafd_k$().exhausted_p1jt55_k$() && _this__u8e3s4.get_source_jl0x7o_k$().read_a1wdbo_k$(_this__u8e3s4.get_buffer_bmaafd_k$(), new Long(8192, 0)).equals(new Long(-1, -1));
  }
  ...
  function commonRequest(_this__u8e3s4, byteCount) {
    ...
    while (_this__u8e3s4.get_buffer_bmaafd_k$().get_size_woubt6_k$().compareTo_9jj042_k$(byteCount) < 0) {
      if (_this__u8e3s4.get_source_jl0x7o_k$().read_a1wdbo_k$(_this__u8e3s4.get_buffer_bmaafd_k$(), new Long(8192, 0)).equals(new Long(-1, -1)))
        return false;
    }
    return true;
  }
  ...
  function commonReadAll_0(_this__u8e3s4, sink) {
    ...
    while (!_this__u8e3s4.get_source_jl0x7o_k$().read_a1wdbo_k$(_this__u8e3s4.get_buffer_bmaafd_k$(), new Long(8192, 0)).equals(new Long(-1, -1))) {
  ...
  function commonReadUtf8LineStrict_0(_this__u8e3s4, limit) {
    ...
    var tmp_1;
    var tmp_2;
    if (scanLength.compareTo_9jj042_k$(new Long(-1, 2147483647)) < 0 && _this__u8e3s4.request_mpoy7z_k$(scanLength)) {
  ...
  function commonReadDecimalLong_0(_this__u8e3s4) {
    ...
    $l$loop_0: while (true) {
      ...
      if ((b < 48 || b > 57) && (!pos.equals(new Long(0, 0)) || !(b === 45))) {
  ...
  function commonSkip_0(_this__u8e3s4, byteCount) {
    ...
    while (byteCount_0.compareTo_9jj042_k$(new Long(0, 0)) > 0) {
      if (_this__u8e3s4.get_buffer_bmaafd_k$().get_size_woubt6_k$().equals(new Long(0, 0)) && _this__u8e3s4.get_source_jl0x7o_k$().read_a1wdbo_k$(_this__u8e3s4.get_buffer_bmaafd_k$(), new Long(8192, 0)).equals(new Long(-1, -1))) {
        throw EOFException_init_$Create$();
      }
      // Inline function 'kotlin.comparisons.minOf' call
      var a = byteCount_0;
  ...
  function commonIndexOf_2(_this__u8e3s4, b, fromIndex, toIndex) {
    ...
    while (fromIndex_0.compareTo_9jj042_k$(toIndex) < 0) {
      ...
      if (lastBufferSize.compareTo_9jj042_k$(toIndex) >= 0 || _this__u8e3s4.get_source_jl0x7o_k$().read_a1wdbo_k$(_this__u8e3s4.get_buffer_bmaafd_k$(), new Long(8192, 0)).equals(new Long(-1, -1)))
        return new Long(-1, -1);
      // Inline function 'kotlin.comparisons.maxOf' call
      var a = fromIndex_0;
  ...
  function commonRangeEquals_2(_this__u8e3s4, offset, bytes, bytesOffset, byteCount) {
    ...
    if (offset.compareTo_9jj042_k$(new Long(0, 0)) < 0 || bytesOffset < 0 || byteCount < 0 || (bytes.get_size_woubt6_k$() - bytesOffset | 0) < byteCount) {
      return false;
    }
    var inductionVariable = 0;
    if (inductionVariable < byteCount)
  ...
  function commonToString_2(_this__u8e3s4) {
    return 'buffer(' + toString(_this__u8e3s4.get_source_jl0x7o_k$()) + ')';
  }
  function commonSubstring_0(_this__u8e3s4, beginIndex, endIndex) {
    ...
    if (beginIndex === 0 && endIndex_0 === _this__u8e3s4.get_size_woubt6_k$())
      return _this__u8e3s4;
    ...
    var newSegments = copyOfRange_0(_this__u8e3s4.get_segments_g0c50x_k$(), beginSegment, endSegment + 1 | 0);
    ...
    if (inductionVariable <= endSegment)
      do {
        ...
        var tmp = index;
        // Inline function 'kotlin.comparisons.minOf' call
        var a = _this__u8e3s4.get_directory_rb0pf8_k$()[s] - beginIndex | 0;
        newDirectory[tmp] = Math.min(a, subLen);
        var tmp1 = index;
        index = tmp1 + 1 | 0;
        newDirectory[tmp1 + newSegments.length | 0] = _this__u8e3s4.get_directory_rb0pf8_k$()[s + _this__u8e3s4.get_segments_g0c50x_k$().length | 0];
      }
       while (!(s === endSegment));
    var segmentOffset = beginSegment === 0 ? 0 : _this__u8e3s4.get_directory_rb0pf8_k$()[beginSegment - 1 | 0];
  ...
  function commonInternalGet(_this__u8e3s4, pos) {
    checkOffsetAndCount(toLong(_this__u8e3s4.get_directory_rb0pf8_k$()[_this__u8e3s4.get_segments_g0c50x_k$().length - 1 | 0]), toLong(pos), new Long(1, 0));
    var segment_0 = segment(_this__u8e3s4, pos);
    var segmentOffset = segment_0 === 0 ? 0 : _this__u8e3s4.get_directory_rb0pf8_k$()[segment_0 - 1 | 0];
    var segmentPos = _this__u8e3s4.get_directory_rb0pf8_k$()[segment_0 + _this__u8e3s4.get_segments_g0c50x_k$().length | 0];
    return _this__u8e3s4.get_segments_g0c50x_k$()[segment_0][(pos - segmentOffset | 0) + segmentPos | 0];
  }
  function commonGetSize_0(_this__u8e3s4) {
    return _this__u8e3s4.get_directory_rb0pf8_k$()[_this__u8e3s4.get_segments_g0c50x_k$().length - 1 | 0];
  }
  function commonToByteArray_0(_this__u8e3s4) {
    ...
    var segmentCount = _this__u8e3s4.get_segments_g0c50x_k$().length;
    var s = 0;
    var pos = 0;
    while (s < segmentCount) {
      var segmentPos = _this__u8e3s4.get_directory_rb0pf8_k$()[segmentCount + s | 0];
      var nextSegmentOffset = _this__u8e3s4.get_directory_rb0pf8_k$()[s];
      // Inline function 'okio.internal.commonToByteArray.<anonymous>' call
      var byteCount = nextSegmentOffset - pos | 0;
      // Inline function 'kotlin.collections.copyInto' call
      var this_0 = _this__u8e3s4.get_segments_g0c50x_k$()[s];
  ...
  function commonWrite_11(_this__u8e3s4, buffer, offset, byteCount) {
    ...
    var pos = offset;
    while (pos < endIndex) {
      var segmentOffset = s === 0 ? 0 : _this__u8e3s4.get_directory_rb0pf8_k$()[s - 1 | 0];
      var segmentSize = _this__u8e3s4.get_directory_rb0pf8_k$()[s] - segmentOffset | 0;
      var segmentPos = _this__u8e3s4.get_directory_rb0pf8_k$()[_this__u8e3s4.get_segments_g0c50x_k$().length + s | 0];
      // Inline function 'kotlin.comparisons.minOf' call
      var b = segmentOffset + segmentSize | 0;
      var byteCount_0 = Math.min(endIndex, b) - pos | 0;
      var offset_0 = segmentPos + (pos - segmentOffset | 0) | 0;
      // Inline function 'okio.internal.commonWrite.<anonymous>' call
      var data = _this__u8e3s4.get_segments_g0c50x_k$()[s];
      var segment_0 = Segment_init_$Create$_0(data, offset_0, offset_0 + byteCount_0 | 0, true, false);
      if (buffer.get_head_pg0gr3_k$() == null) {
        segment_0.set_prev_ur3dkn_k$(segment_0);
        segment_0.set_next_tohs5l_k$(segment_0.get_prev_wosl18_k$());
        buffer.set_head_csbq7o_k$(segment_0.get_next_wor1vg_k$());
      } else {
        ensureNotNull(ensureNotNull(buffer.get_head_pg0gr3_k$()).get_prev_wosl18_k$()).push_wd62e0_k$(segment_0);
      }
    ...
    buffer.set_size_nux7qg_k$(tmp$ret$1);
  }
  function commonRangeEquals_3(_this__u8e3s4, offset, other, otherOffset, byteCount) {
    if (offset < 0 || offset > (_this__u8e3s4.get_size_woubt6_k$() - byteCount | 0))
      return false;
  ...
  function commonRangeEquals_4(_this__u8e3s4, offset, other, otherOffset, byteCount) {
    if (offset < 0 || offset > (_this__u8e3s4.get_size_woubt6_k$() - byteCount | 0) || otherOffset < 0 || otherOffset > (other.length - byteCount | 0)) {
      return false;
    }
    var otherOffset_0 = otherOffset;
    // Inline function 'okio.internal.forEachSegment' call
  ...
  function forEachSegment(_this__u8e3s4, action) {
    ...
    while (s < segmentCount) {
      var segmentPos = _this__u8e3s4.get_directory_rb0pf8_k$()[segmentCount + s | 0];
      var nextSegmentOffset = _this__u8e3s4.get_directory_rb0pf8_k$()[s];
      action(_this__u8e3s4.get_segments_g0c50x_k$()[s], segmentPos, nextSegmentOffset - pos | 0);
      pos = nextSegmentOffset;
      s = s + 1 | 0;
    }
  }
  function commonEquals_2(_this__u8e3s4, other) {
    ...
    if (other === _this__u8e3s4) {
      ...
      if (other instanceof ByteString) {
        tmp = (other.get_size_woubt6_k$() === _this__u8e3s4.get_size_woubt6_k$() && _this__u8e3s4.rangeEquals_b8izl9_k$(0, other, 0, _this__u8e3s4.get_size_woubt6_k$()));
      } else {
        tmp = false;
      }
    }
  ...
  function commonHashCode_2(_this__u8e3s4) {
    ...
    _this__u8e3s4.set_hashCode_j8f9eg_k$(result);
    return result;
  }
  function segment(_this__u8e3s4, pos) {
    var i = binarySearch_0(_this__u8e3s4.get_directory_rb0pf8_k$(), pos + 1 | 0, 0, _this__u8e3s4.get_segments_g0c50x_k$().length);
    return i >= 0 ? i : ~i;
  }
  function forEachSegment_0(_this__u8e3s4, beginIndex, endIndex, action) {
    ...
    while (pos < endIndex) {
      ...
      action(_this__u8e3s4.get_segments_g0c50x_k$()[s], offset, byteCount);
      pos = pos + byteCount | 0;
      s = s + 1 | 0;
    }
  }
  ...
  function create($this, key, hashFunction, blockLength) {
    ...
    if (keySize === 0) {
      ...
      tmp = key.get_data_hjgcg5_k$();
    } else if (keySize < blockLength) {
      tmp = copyOf(key.get_data_hjgcg5_k$(), blockLength);
    } else {
      // Inline function 'kotlin.apply' call
      // Inline function 'kotlin.contracts.contract' call
      // Inline function 'okio.internal.Companion.create.<anonymous>' call
      hashFunction.update$default_mhmryi_k$(key.get_data_hjgcg5_k$());
  ...
  protoOf(Companion_6).get_SYSTEM_TEMPORARY_DIRECTORY_j2u020_k$ = function () {
  ...
  protoOf(Companion_7).of_j7zv7t_k$ = function (data) {
  ...
  protoOf(Companion_7).toByteString_je42ki_k$ = function (_this__u8e3s4, offset, byteCount) {
    // Inline function 'okio.internal.commonToByteString' call
    var byteCount_0 = resolveDefaultParameter_0(_this__u8e3s4, byteCount);
    checkOffsetAndCount(toLong(_this__u8e3s4.length), toLong(offset), toLong(byteCount_0));
    return new ByteString(copyOfRange(_this__u8e3s4, offset, offset + byteCount_0 | 0));
  };
  protoOf(Companion_7).toByteString$default_8fw6ae_k$ = function (_this__u8e3s4, offset, byteCount, $super) {
    offset = offset === VOID ? 0 : offset;
  ...
  protoOf(Companion_7).encodeUtf8_5n709n_k$ = function (_this__u8e3s4) {
    // Inline function 'okio.internal.commonEncodeUtf8' call
    var byteString = new ByteString(asUtf8ToByteArray(_this__u8e3s4));
    byteString.set_utf8_1c2rfj_k$(_this__u8e3s4);
    return byteString;
  };
  protoOf(Companion_7).decodeBase64_urud1t_k$ = function (_this__u8e3s4) {
    // Inline function 'okio.internal.commonDecodeBase64' call
    var decoded = decodeBase64ToArray(_this__u8e3s4);
    return !(decoded == null) ? new ByteString(decoded) : null;
  };
  protoOf(Companion_7).decodeHex_xvw83l_k$ = function (_this__u8e3s4) {
  ...
  protoOf(ByteString).get_data_hjgcg5_k$ = function () {
    return this.data_1;
  };
  protoOf(ByteString).set_hashCode_j8f9eg_k$ = function (value) {
  };
  protoOf(ByteString).get_hashCode_jn37v8_k$ = function () {
    return this.hashCode_2;
  };
  protoOf(ByteString).set_utf8_1c2rfj_k$ = function (value) {
  };
  protoOf(ByteString).get_utf8_lmuzsu_k$ = function () {
    return this.utf8__1;
  };
  ...
  protoOf(ByteString).md5_2b9a_k$ = function () {
    return this.digest_on6hol_k$(new Md5());
  };
  protoOf(ByteString).sha1_23myt_k$ = function () {
    return this.digest_on6hol_k$(new Sha1());
  };
  protoOf(ByteString).sha256_exzwt5_k$ = function () {
    return this.digest_on6hol_k$(new Sha256());
  };
  protoOf(ByteString).sha512_exzuom_k$ = function () {
    return this.digest_on6hol_k$(new Sha512());
  };
  protoOf(ByteString).hmacSha1_crnr8j_k$ = function (key) {
    return this.digest_on6hol_k$(Companion_getInstance_2().sha1_yksf2c_k$(key));
  };
  protoOf(ByteString).hmacSha256_ynvjgl_k$ = function (key) {
    return this.digest_on6hol_k$(Companion_getInstance_2().sha256_4vtk9u_k$(key));
  };
  protoOf(ByteString).hmacSha512_7grw14_k$ = function (key) {
    return this.digest_on6hol_k$(Companion_getInstance_2().sha512_w2x7pb_k$(key));
  };
  protoOf(ByteString).digest_on6hol_k$ = function (hashFunction) {
  ...
  protoOf(ByteString).substring_d7lab3_k$ = function (beginIndex, endIndex) {
    ...
    $l$block: {
      ...
      if (beginIndex === 0 && endIndex_0 === this.data_1.length) {
        tmp$ret$3 = this;
        break $l$block;
      }
  ...
  protoOf(ByteString).write_ifrhr7_k$ = function (buffer, offset, byteCount) {
  ...
  protoOf(ByteString).indexOf_kkf4fc_k$ = function (other, fromIndex) {
    return this.indexOf_ivmdf5_k$(other.internalArray_nlkee4_k$(), fromIndex);
  };
  ...
  protoOf(ByteString).lastIndexOf_jcxov2_k$ = function (other, fromIndex) {
    ...
    return this.lastIndexOf_cmuddn_k$(other.internalArray_nlkee4_k$(), fromIndex);
  };
      ...
      if (i === -1) {
        ...
        if (this.data_1.length <= 64) {
          ...
          $l$block_0: {
            ...
            if (0 === 0 && endIndex === this.data_1.length) {
              tmp$ret$5 = this;
              break $l$block_0;
            }
  ...
  function SegmentedByteString(segments, directory) {
    ByteString.call(this, Companion_getInstance_7().get_EMPTY_i8q41w_k$().get_data_hjgcg5_k$());
    this.segments_1 = segments;
    this.directory_1 = directory;
  }
  protoOf(SegmentedByteString).get_segments_g0c50x_k$ = function () {
    return this.segments_1;
  };
  protoOf(SegmentedByteString).get_directory_rb0pf8_k$ = function () {
  ...
  protoOf(SegmentedByteString).substring_d7lab3_k$ = function (beginIndex, endIndex) {
    ...
    $l$block_0: {
      ...
      if (beginIndex === 0 && endIndex_0 === this.get_size_woubt6_k$()) {
        tmp$ret$3 = this;
        break $l$block_0;
      } else if (beginIndex === endIndex_0) {
  ...
  protoOf(SegmentedByteString).write_ifrhr7_k$ = function (buffer, offset, byteCount) {
    // Inline function 'okio.internal.forEachSegment' call
    var endIndex = offset + byteCount | 0;
  ...
  protoOf(SegmentedByteString).digest_on6hol_k$ = function (hashFunction) {
    // Inline function 'okio.internal.forEachSegment' call
    var segmentCount = this.segments_1.length;
    var s = 0;
    var pos = 0;
  ...
  protoOf(SegmentedByteString).equals = function (other) {
    ...
    if (other === this) {
      ...
      if (other instanceof ByteString) {
        tmp = (other.get_size_woubt6_k$() === this.get_size_woubt6_k$() && this.rangeEquals_b8izl9_k$(0, other, 0, this.get_size_woubt6_k$()));
      } else {
        tmp = false;
      }
    }
  ...
  protoOf(SegmentedByteString).hashCode = function () {
    ...
    $l$block: {
      // Inline function 'okio.internal.commonHashCode' call
      var result = this.get_hashCode_jn37v8_k$();
      if (!(result === 0)) {
        tmp$ret$0 = result;
        break $l$block;
      }
  ...
  protoOf(UnsafeCursor).set_segment_q3t00r_k$ = function (_set____db54di) {
    this.segment_1 = _set____db54di;
  };
  protoOf(UnsafeCursor).get_segment_v0lccy_k$ = function () {
  ...
  protoOf(UnsafeCursor).seek_de9ugm_k$ = function (offset) {
    ...
    $l$block_0: {
      ...
      var buffer = tmp$ret$1;
      if (offset.compareTo_9jj042_k$(new Long(-1, -1)) < 0 || offset.compareTo_9jj042_k$(buffer.size_1) > 0) {
        throw new ArrayIndexOutOfBoundsException('offset=' + offset.toString() + ' > size=' + buffer.size_1.toString());
      }
      if (offset.equals(new Long(-1, -1)) || offset.equals(buffer.size_1)) {
        this.segment_1 = null;
      ...
      if (this.readWrite_1 && ensureNotNull(next).get_shared_jgtlda_k$()) {
        var unsharedNext = next.unsharedCopy_5kj8b7_k$();
  ...
  protoOf(Buffer).set_head_csbq7o_k$ = function (_set____db54di) {
    this.head_1 = _set____db54di;
  };
  protoOf(Buffer).get_head_pg0gr3_k$ = function () {
    return this.head_1;
  };
  protoOf(Buffer).set_size_nux7qg_k$ = function (_set____db54di) {
  ...
  protoOf(Buffer).readUtf8LineStrict_40ilic_k$ = function () {
    return this.readUtf8LineStrict_6h4kc6_k$(new Long(-1, 2147483647));
  };
  ...
  protoOf(Buffer).select_4klarg_k$ = function (options) {
    // Inline function 'okio.internal.commonSelect' call
    var index = this.select_91a7t_k$(options.get_options_qkdnzx_k$());
    return index === -1 ? null : options.get_c1px32_k$(index);
  };
  ...
  protoOf(Buffer).write_f9cjbq_k$ = function (byteString) {
    ...
    byteString.write_ifrhr7_k$(this, 0, byteCount);
    return this;
  };
  protoOf(Buffer).write_1oosdm_k$ = function (byteString, offset, byteCount) {
    // Inline function 'okio.internal.commonWrite' call
    byteString.write_ifrhr7_k$(this, offset, byteCount);
    return this;
  };
  ...
  protoOf(Buffer).writeUtf8_sgs1di_k$ = function (string, beginIndex, endIndex) {
    ...
    while (i < endIndex) {
      ...
      if (c < 128) {
        ...
        var tail_1 = this.writableSegment_voedtv_k$(3);
        tail_1.get_data_wokkxf_k$()[tail_1.get_limit_iuokuq_k$()] = toByte(c >> 12 | 224);
        tail_1.get_data_wokkxf_k$()[tail_1.get_limit_iuokuq_k$() + 1 | 0] = toByte(c >> 6 & 63 | 128);
        tail_1.get_data_wokkxf_k$()[tail_1.get_limit_iuokuq_k$() + 2 | 0] = toByte(c & 63 | 128);
        tail_1.set_limit_mo5fx2_k$(tail_1.get_limit_iuokuq_k$() + 3 | 0);
        ...
        if (c > 56319 || !(56320 <= low ? low <= 57343 : false)) {
          ...
          var codePoint = 65536 + ((c & 1023) << 10 | low & 1023) | 0;
          var tail_2 = this.writableSegment_voedtv_k$(4);
          tail_2.get_data_wokkxf_k$()[tail_2.get_limit_iuokuq_k$()] = toByte(codePoint >> 18 | 240);
          tail_2.get_data_wokkxf_k$()[tail_2.get_limit_iuokuq_k$() + 1 | 0] = toByte(codePoint >> 12 & 63 | 128);
          tail_2.get_data_wokkxf_k$()[tail_2.get_limit_iuokuq_k$() + 2 | 0] = toByte(codePoint >> 6 & 63 | 128);
          tail_2.get_data_wokkxf_k$()[tail_2.get_limit_iuokuq_k$() + 3 | 0] = toByte(codePoint & 63 | 128);
  ...
  protoOf(Buffer).writeUtf8CodePoint_4mbg4l_k$ = function (codePoint) {
    ...
    if (codePoint < 128) {
      ...
      var tail = this.writableSegment_voedtv_k$(2);
      tail.get_data_wokkxf_k$()[tail.get_limit_iuokuq_k$()] = toByte(codePoint >> 6 | 192);
      tail.get_data_wokkxf_k$()[tail.get_limit_iuokuq_k$() + 1 | 0] = toByte(codePoint & 63 | 128);
      tail.set_limit_mo5fx2_k$(tail.get_limit_iuokuq_k$() + 2 | 0);
      this.size_1 = this.size_1.plus_r93sks_k$(new Long(2, 0));
      ...
      var tail_0 = this.writableSegment_voedtv_k$(3);
      tail_0.get_data_wokkxf_k$()[tail_0.get_limit_iuokuq_k$()] = toByte(codePoint >> 12 | 224);
      tail_0.get_data_wokkxf_k$()[tail_0.get_limit_iuokuq_k$() + 1 | 0] = toByte(codePoint >> 6 & 63 | 128);
      tail_0.get_data_wokkxf_k$()[tail_0.get_limit_iuokuq_k$() + 2 | 0] = toByte(codePoint & 63 | 128);
      tail_0.set_limit_mo5fx2_k$(tail_0.get_limit_iuokuq_k$() + 3 | 0);
  ...
  protoOf(Buffer).writeAll_goqmgy_k$ = function (source) {
    ...
    var totalBytesRead = new Long(0, 0);
    $l$loop: while (true) {
      var readCount = source.read_a1wdbo_k$(this, new Long(8192, 0));
      if (readCount.equals(new Long(-1, -1)))
        break $l$loop;
      totalBytesRead = totalBytesRead.plus_r93sks_k$(readCount);
    }
  ...
  protoOf(Buffer).writeInt_nsyxiw_k$ = function (i) {
    ...
    var tail = this.writableSegment_voedtv_k$(4);
    var data = tail.get_data_wokkxf_k$();
    var limit = tail.get_limit_iuokuq_k$();
    var tmp0 = limit;
    limit = tmp0 + 1 | 0;
  ...
  protoOf(Buffer).writeLong_4zwjf7_k$ = function (v) {
    ...
    var tail = this.writableSegment_voedtv_k$(8);
    var data = tail.get_data_wokkxf_k$();
    var limit = tail.get_limit_iuokuq_k$();
    var tmp0 = limit;
    limit = tmp0 + 1 | 0;
  ...
  protoOf(Buffer).writeDecimalLong_3t8cww_k$ = function (v) {
    ...
    $l$block_0: {
      ...
      var tail = this.writableSegment_voedtv_k$(width);
      var data = tail.get_data_wokkxf_k$();
      var pos = tail.get_limit_iuokuq_k$() + width | 0;
      while (!v_0.equals(new Long(0, 0))) {
        // Inline function 'kotlin.Long.rem' call
  ...
  protoOf(Buffer).indexOf_ji4kj3_k$ = function (b) {
    return this.indexOf_nnf9xt_k$(b, new Long(0, 0), new Long(-1, 2147483647));
  };
  protoOf(Buffer).indexOf_hx61un_k$ = function (b, fromIndex) {
    return this.indexOf_nnf9xt_k$(b, fromIndex, new Long(-1, 2147483647));
  };
  ...
  protoOf(Buffer).rangeEquals_yttejb_k$ = function (offset, bytes, bytesOffset, byteCount) {
    ...
    $l$block_0: {
      // Inline function 'okio.internal.commonRangeEquals' call
      if (offset.compareTo_9jj042_k$(new Long(0, 0)) < 0 || bytesOffset < 0 || byteCount < 0 || this.size_1.minus_mfbszm_k$(offset).compareTo_9jj042_k$(toLong(byteCount)) < 0 || (bytes.get_size_woubt6_k$() - bytesOffset | 0) < byteCount) {
        tmp$ret$0 = false;
        break $l$block_0;
      }
      var inductionVariable = 0;
  ...
  protoOf(Buffer).snapshot_4plubo_k$ = function () {
    ...
    // Inline function 'kotlin.check' call
    // Inline function 'kotlin.contracts.contract' call
    if (!(this.size_1.compareTo_9jj042_k$(new Long(2147483647, 0)) <= 0)) {
      // Inline function 'okio.internal.commonSnapshot.<anonymous>' call
  ...
  protoOf(Companion_8).get_instance_mmff6q_k$ = function () {
  ...
  protoOf(Companion_9).get_DIRECTORY_SEPARATOR_5d74ru_k$ = function () {
    return this.DIRECTORY_SEPARATOR_1;
  };
  protoOf(Companion_9).toPath_oj8tzb_k$ = function (_this__u8e3s4, normalize) {
    return commonToPath(_this__u8e3s4, normalize);
  };
  protoOf(Companion_9).toPath$default_vs59ry_k$ = function (_this__u8e3s4, normalize, $super) {
  ...
  protoOf(Path).get_bytes_c5stva_k$ = function () {
    return this.bytes_1;
  };
  ...
  protoOf(Path).get_segments_ecat1z_k$ = function () {
    ...
    if (segmentStart === -1) {
      segmentStart = 0;
    } else if (segmentStart < this.bytes_1.get_size_woubt6_k$() && this.bytes_1.get_c1px32_k$(segmentStart) === 92) {
      segmentStart = segmentStart + 1 | 0;
    }
    var inductionVariable = segmentStart;
    ...
    if (inductionVariable < last)
      do {
        var i = inductionVariable;
        inductionVariable = inductionVariable + 1 | 0;
        if (this.bytes_1.get_c1px32_k$(i) === 47 || this.bytes_1.get_c1px32_k$(i) === 92) {
          // Inline function 'kotlin.collections.plusAssign' call
  ...
  protoOf(Path).get_parent_hy4reb_k$ = function () {
    ...
    $l$block_7: {
      ...
      if (this.bytes_1.equals(_get_DOT_$accessor$1r83mlj_23eb7y_0()) || this.bytes_1.equals(_get_SLASH_$accessor$1r83mlj_21oo1q()) || this.bytes_1.equals(_get_BACKSLASH_$accessor$1r83mlj_9mc3r9()) || lastSegmentIsDotDot$accessor$1r83mlj(this)) {
        tmp$ret$0 = null;
        break $l$block_7;
      }
      var lastSlash = _get_indexOfLastSlash_$accessor$1r83mlj_ivcd2h(this);
      ...
      if (tmp) {
        ...
        if (lastSlash === 1 && this.bytes_1.startsWith_w7onu6_k$(_get_BACKSLASH_$accessor$1r83mlj_9mc3r9())) {
          tmp$ret$0 = null;
          break $l$block_7;
        } else {
          var tmp_1;
          ...
          if (tmp_1) {
            ...
            if (lastSlash === -1) {
              tmp$ret$0 = new Path(_get_DOT_$accessor$1r83mlj_23eb7y_0());
              break $l$block_7;
            } else {
              if (lastSlash === 0) {
  ...
  protoOf(Path).relativeTo_9inemi_k$ = function (other) {
    ...
    $l$block_0: {
      ...
      if (!equals(this.get_root_wott0r_k$(), other.get_root_wott0r_k$())) {
        // Inline function 'okio.internal.commonRelativeTo.<anonymous>' call
        var message = 'Paths of different roots cannot be relative to each other: ' + this.toString() + ' and ' + other.toString();
        throw IllegalArgumentException_init_$Create$(toString(message));
      }
      ...
      if (firstNewSegmentIndex === minSegmentsSize && this.bytes_1.get_size_woubt6_k$() === other.bytes_1.get_size_woubt6_k$()) {
      ...
      if (!(otherSegments.subList_xle3r2_k$(firstNewSegmentIndex, otherSegments.get_size_woubt6_k$()).indexOf_si1fv9_k$(_get_DOT_DOT_$accessor$1r83mlj_3dr2dk()) === -1)) {
        // Inline function 'okio.internal.commonRelativeTo.<anonymous>' call
        var message_0 = 'Impossible relative path to resolve: ' + this.toString() + ' and ' + other.toString();
        throw IllegalArgumentException_init_$Create$(toString(message_0));
      }
      if (other.bytes_1.equals(_get_DOT_$accessor$1r83mlj_23eb7y_0())) {
        tmp$ret$2 = this;
        break $l$block_0;
      }
      var buffer = new Buffer();
  ...
  protoOf(RealBufferedSink).writeAll_goqmgy_k$ = function (source) {
    ...
    var totalBytesRead = new Long(0, 0);
    $l$loop: while (true) {
      var readCount = source.read_a1wdbo_k$(this.buffer_1, new Long(8192, 0));
      if (readCount.equals(new Long(-1, -1)))
        break $l$loop;
      totalBytesRead = totalBytesRead.plus_r93sks_k$(readCount);
      this.emitCompleteSegments_5yum7g_k$();
  ...
  protoOf(RealBufferedSource).read_a1wdbo_k$ = function (sink, byteCount) {
    ...
    $l$block_0: {
      ...
      if (this.buffer_1.get_size_woubt6_k$().equals(new Long(0, 0))) {
        ...
        var read = this.source_1.read_a1wdbo_k$(this.buffer_1, new Long(8192, 0));
        if (read.equals(new Long(-1, -1))) {
          tmp$ret$2 = new Long(-1, -1);
          break $l$block_0;
        }
  ...
  protoOf(RealBufferedSource).exhausted_p1jt55_k$ = function () {
    ...
    return this.buffer_1.exhausted_p1jt55_k$() && this.source_1.read_a1wdbo_k$(this.buffer_1, new Long(8192, 0)).equals(new Long(-1, -1));
  };
  ...
  protoOf(RealBufferedSource).request_mpoy7z_k$ = function (byteCount) {
    ...
    $l$block: {
      ...
      while (this.buffer_1.get_size_woubt6_k$().compareTo_9jj042_k$(byteCount) < 0) {
        if (this.source_1.read_a1wdbo_k$(this.buffer_1, new Long(8192, 0)).equals(new Long(-1, -1))) {
          tmp$ret$2 = false;
          break $l$block;
        }
      }
  ...
  protoOf(RealBufferedSource).readAll_mirvr1_k$ = function (sink) {
    // Inline function 'okio.internal.commonReadAll' call
    var totalBytesWritten = new Long(0, 0);
    while (!this.source_1.read_a1wdbo_k$(this.buffer_1, new Long(8192, 0)).equals(new Long(-1, -1))) {
  ...
  protoOf(RealBufferedSource).readUtf8LineStrict_6h4kc6_k$ = function (limit) {
    ...
    $l$block_0: {
      ...
      var tmp_1;
      var tmp_2;
      if (scanLength.compareTo_9jj042_k$(new Long(-1, 2147483647)) < 0 && this.request_mpoy7z_k$(scanLength)) {
        // Inline function 'kotlin.Long.minus' call
  ...
  protoOf(RealBufferedSource).skip_bgd4sf_k$ = function (byteCount) {
    ...
    while (byteCount_0.compareTo_9jj042_k$(new Long(0, 0)) > 0) {
      if (this.buffer_1.get_size_woubt6_k$().equals(new Long(0, 0)) && this.source_1.read_a1wdbo_k$(this.buffer_1, new Long(8192, 0)).equals(new Long(-1, -1))) {
        throw EOFException_init_$Create$();
      }
      // Inline function 'kotlin.comparisons.minOf' call
      var a = byteCount_0;
  ...
  protoOf(RealBufferedSource).indexOf_nnf9xt_k$ = function (b, fromIndex, toIndex) {
    ...
    $l$block_0: {
      ...
      while (fromIndex_0.compareTo_9jj042_k$(toIndex) < 0) {
        ...
        if (lastBufferSize.compareTo_9jj042_k$(toIndex) >= 0 || this.source_1.read_a1wdbo_k$(this.buffer_1, new Long(8192, 0)).equals(new Long(-1, -1))) {
          tmp$ret$2 = new Long(-1, -1);
          break $l$block_0;
        }
        // Inline function 'kotlin.comparisons.maxOf' call
  ...
  _.$_$.e = Buffer;
  _.$_$.f = EOFException;
  _.$_$.g = FileNotFoundException;
  _.$_$.h = FileSystem;
  _.$_$.i = ForwardingFileSystem;
  _.$_$.j = IOException;
  _.$_$.k = Path;
  _.$_$.l = Sink;
  _.$_$.m = blackholeSink;
