(function (factory) {
  ...
  var startCoroutineCancellable = kotlin_org_jetbrains_kotlinx_kotlinx_coroutines_core.$_$.c2;
  ...
  var cancel = kotlin_org_jetbrains_kotlinx_kotlinx_coroutines_core.$_$.c3;
  var initMetadataForLambda = kotlin_kotlin.$_$.vg;
  var KSuspendFunction0 = kotlin_kotlin.$_$.ij;
  ...
  var encodeToByteArray = kotlin_kotlin.$_$.lk;
  ...
  var replace = kotlin_kotlin.$_$.ml;
  ...
  protoOf($readRemainingCOROUTINE$11).doResume_5yljmg_k$ = function () {
    var suspendResult = this.get_result_iyg5d2_k$();
    $sm: do
      try {
        var tmp = this.get_state_iypx7s_k$();
