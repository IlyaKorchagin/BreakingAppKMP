(function (factory) {
  ...
  function fastMapTo(_this__u8e3s4, destination, transform) {
    // Inline function 'kotlin.contracts.contract' call
    // Inline function 'androidx.compose.ui.util.fastForEach' call
    // Inline function 'kotlin.contracts.contract' call
    var inductionVariable = 0;
    ...
    if (inductionVariable <= last)
      do {
        ...
        inductionVariable = inductionVariable + 1 | 0;
        var item = _this__u8e3s4.get_c1px32_k$(index);
        // Inline function 'androidx.compose.ui.util.fastMapTo.<anonymous>' call
  ...
  function fastMapIndexedNotNull(_this__u8e3s4, transform) {
    ...
    if (inductionVariable <= last)
      do {
        ...
        inductionVariable = inductionVariable + 1 | 0;
        var item = _this__u8e3s4.get_c1px32_k$(index);
        // Inline function 'androidx.compose.ui.util.fastMapIndexedNotNull.<anonymous>' call
