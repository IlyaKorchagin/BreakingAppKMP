(function (factory) {
  ...
  var isSupported = kotlin_io_ktor_ktor_io.$_$.r;
  ...
  var asFlow = kotlin_org_jetbrains_kotlinx_kotlinx_coroutines_core.$_$.r1;
  var firstOrNull = kotlin_org_jetbrains_kotlinx_kotlinx_coroutines_core.$_$.h;
      ...
      try {
        ...
        switch (tmp) {
          ...
          case 1:
            ...
            suspendResult = this.$this$transform0__1.emit_t92u1f_k$(this.ARGUMENT3__1, this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
