...
fun setElementColor(elementTitle: String): Color {
    return when (elementTitle) {
        ...
        TURTLE, HEAD_HOLLOWBACK, SWIPES, MUCHMILL, WEB, WOLF, CRICKET, FLARE, NINETYNINE, HALO, HANDSTAND, FINGERS, ANGLE, HAND_WALK, HAND_TOUCH_LEGS, TOMBSTONE, DOUBLE, SUPERMAN  -> AppColors.colors().medium
        AIRBABY, CHAIR, ONE_HAND, INVERT, GRABMILL, WINDMILL_TO_HANDSTAND,  HOLLOWBACK, ELBOW, ELBOW_AIRFLARE, AIRFLARE, JACKHAMMER, UFO, HORIZONT, PRESS_TO_HANDSTAND, TURTLE_TO_HANDSTAND, HAND_JUMP  -> AppColors.colors().hard
        else -> Color.Black
    }
}