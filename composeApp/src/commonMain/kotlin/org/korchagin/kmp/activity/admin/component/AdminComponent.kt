package org.korchagin.kmp.activity.admin.component
...
import org.korchagin.kmp.activity.admin.component.fragment.AdminFragment
...
object AdminComponent : Component(
    route = "admin_component",
    label = Res.string.app_name,
    icon = { selected ->
        SimpleNavIcon(selected, Res.drawable.compose_multiplatform)
    },
    fragments = listOf(AdminFragment)
)