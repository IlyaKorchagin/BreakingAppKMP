package org.korchagin.kmp.activity.main.frafments.ratings.screen
...
@Composable
fun RatingsScreen(componentNavigator: ComponentNavigator) {
    val mainViewModel = koinViewModel<MainViewModel>()
     val users by mainViewModel.pupils.collectAsState(emptyList())
    LazyColumn {
