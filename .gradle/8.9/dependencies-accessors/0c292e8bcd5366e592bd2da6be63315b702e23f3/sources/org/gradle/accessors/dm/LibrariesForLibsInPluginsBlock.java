...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    public static class AndroidLibraryAccessors extends SubDependencyFactory {
        private final AndroidFirebaseLibraryAccessors laccForAndroidFirebaseLibraryAccessors = new AndroidFirebaseLibraryAccessors(owner);

        public AndroidLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>android.firebase</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public AndroidFirebaseLibraryAccessors getFirebase() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForAndroidFirebaseLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class AndroidFirebaseLibraryAccessors extends SubDependencyFactory {

        public AndroidFirebaseLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
        ...
        public Provider<MinimalExternalModuleDependency> getBom() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("android.firebase.bom");
        }
    ...
    public static class FirebaseLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>database</b> with <b>dev.gitlive:firebase-database</b> coordinates and
         * with version reference <b>firebaseDatabase</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
    ...
    public static class HtmlLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>htmlCore</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
    ...
    public static class MaterialLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>extension</b> with <b>team.multi-platforma:material_extension</b> coordinates and
         * with version reference <b>material.extension</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
        ...
        public Provider<MinimalExternalModuleDependency> getExtension() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("material.extension");
        }
    ...
    public static class NavigationLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Group of libraries at <b>navigation.compose</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
    ...
    public static class NavigationComposeLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        /**
         * Dependency provider for <b>extra</b> with <b>team.multi-platforma:navigation-compose-extra</b> coordinates and
         * with version reference <b>navigationComposeExtra</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
        ...
        public Provider<MinimalExternalModuleDependency> getExtra() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("navigation.compose.extra");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>agp</b> with value <b>8.3.0-alpha18</b>
         * <p>
        ...
        /**
         * Version alias <b>firebaseDatabase</b> with value <b>2.1.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>htmlCore</b> with value <b>1.8.0-alpha01</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getHtmlCore() { return getVersion("htmlCore"); }
        ...
        /**
         * Version alias <b>koin</b> with value <b>3.6.0-Beta4</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>koinComposeMultiplatform</b> with value <b>1.2.0-Beta4</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>navigationCompose</b> with value <b>2.8.0-alpha12</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>navigationComposeExtra</b> with value <b>1.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getNavigationComposeExtra() { return getVersion("navigationComposeExtra"); }

        /**
         * Version alias <b>serialization</b> with value <b>1.6.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class FirebaseVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>firebase.bom</b> with value <b>33.4.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class MaterialVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>material.extension</b> with value <b>0.0.8-alpha35</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getExtension() { return getVersion("material.extension"); }
