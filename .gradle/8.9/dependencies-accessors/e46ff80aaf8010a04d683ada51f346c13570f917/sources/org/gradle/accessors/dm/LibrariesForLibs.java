...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class MultiLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>image</b> with <b>team.multi-platforma:multi_image</b> coordinates and
         * with version reference <b>multi.image</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getImage() {
            return create("multi.image");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        private final MultiVersionAccessors vaccForMultiVersionAccessors = new MultiVersionAccessors(providers, config);
        ...
        /**
         * Version alias <b>navigationComposeExtra</b> with value <b>1.0.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Group of versions at <b>versions.multi</b>
         */
        public MultiVersionAccessors getMulti() {
            return vaccForMultiVersionAccessors;
        }
    ...
    public static class MaterialVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>material.extension</b> with value <b>0.0.8-alpha54</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class MultiVersionAccessors extends VersionFactory  {

        public MultiVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Version alias <b>multi.image</b> with value <b>0.0.1-beta7</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getImage() { return getVersion("multi.image"); }
